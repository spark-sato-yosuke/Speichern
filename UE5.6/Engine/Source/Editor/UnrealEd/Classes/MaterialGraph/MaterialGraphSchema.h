...
struct FMaterialGraphSchemaAction_NewNode : public FEdGraphSchemaAction
{
	...
	/** Delegate to be run immediately after expression of class 'MaterialExpressionClass' is created */
	TDelegate<void(UMaterialExpression*)> PostCreationDelegate;
	...
	UNREALED_API virtual UEdGraphNode* PerformAction(class UEdGraph* ParentGraph, UEdGraphPin* FromPin, const FVector2f& Location, bool bSelectNewNode = true) override;
...
struct FMaterialGraphSchemaAction_NewComposite : public FEdGraphSchemaAction
{
	...
	static UNREALED_API UEdGraphNode* SpawnNode(class UEdGraph* ParentGraph, const UE::Slate::FDeprecateVector2DParameter& Location);
};
...
class UMaterialGraphSchema : public UEdGraphSchema
{
	...
	UNREALED_API void GetPaletteActions(FGraphActionMenuBuilder& ActionMenuBuilder, const FString& CategoryName, const UObject* MaterialOrFunction) const;
