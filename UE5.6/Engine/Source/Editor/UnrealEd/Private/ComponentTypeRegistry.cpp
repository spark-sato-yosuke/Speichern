...
void FComponentTypeRegistryData::ForceRefreshComponentList()
{
	...
	// Add unloaded component classes
	{
		...
		{
			constexpr bool bGenerateClassPathIfMissing = true;
			FTopLevelAssetPath ClassPath(FEditorClassUtils::GetClassPathNameFromAsset(BPAsset, bGenerateClassPathIfMissing));
