...
void UMaterialGraphNode_Root::UpdateInputUseConstant(UEdGraphPin* Pin, bool bUseConstant)
{
	...
	case MP_WorldPositionOffset:EditorOnlyData->WorldPositionOffset.UseConstant = false; break;
	case MP_Displacement:		EditorOnlyData->Displacement.UseConstant = false; break;
	default:
...
EMaterialValueType UMaterialGraphNode_Root::GetPinMaterialValueType(const UEdGraphPin* Pin) const
{
	...
	EMaterialValueType MaterialType{};
