...
namespace Cook
{
	...
	struct FPlatformData
	{
		...
		*/
		...
		/** Whether BeginCookSandbox specified a full, non-incremental build for this platform. */
		bool bFullBuild = false;
		/**
		 * Whether BeginCookSandBox specied non-full, and is in an incremental mode that allows using previous results.
		...
		/**
		 * If true we are cooking with legacyiterative, from results in a shared build (e.g. from buildfarm) rather
		 * than from our previous cook.
		 */
