...
const FSoftObjectPath UActorFactoryBasicShape::BasicCube(FTopLevelAssetPath("/Engine/BasicShapes/Cube", "Cube"));
const FSoftObjectPath UActorFactoryBasicShape::BasicSphere(FTopLevelAssetPath("/Engine/BasicShapes/Sphere", "Sphere"));
const FSoftObjectPath UActorFactoryBasicShape::BasicCylinder(FTopLevelAssetPath("/Engine/BasicShapes/Cylinder", "Cylinder"));
const FSoftObjectPath UActorFactoryBasicShape::BasicCone(FTopLevelAssetPath("/Engine/BasicShapes/Cone", "Cone"));
const FSoftObjectPath UActorFactoryBasicShape::BasicPlane(FTopLevelAssetPath("/Engine/BasicShapes/Plane", "Plane"));
