...
void FEditorViewportCommands::RegisterCommands()
{
	...
	UI_COMMAND( VisualizeVirtualTextureMode, "Virtual Texture Visualization View Mode", "Visualizes various rendering aspects of virtual textures", EUserInterfaceActionType::RadioButton, FInputChord());
	...
	UI_COMMAND(SelectMode, "Select Mode", "Select objects", EUserInterfaceActionType::RadioButton, FInputChord(EKeys::Q));
	UI_COMMAND( TranslateMode, "Translate Mode", "Select and translate objects", EUserInterfaceActionType::RadioButton, FInputChord(EKeys::W) );
	UI_COMMAND( RotateMode, "Rotate Mode", "Select and rotate objects", EUserInterfaceActionType::RadioButton, FInputChord(EKeys::E) );
	UI_COMMAND( ScaleMode, "Scale Mode", "Select and scale objects", EUserInterfaceActionType::RadioButton, FInputChord(EKeys::R) );
	UI_COMMAND( TranslateRotateMode, "Combined Translate and Rotate Mode", "Select and translate or rotate objects", EUserInterfaceActionType::RadioButton, FInputChord() );
	UI_COMMAND( TranslateRotate2DMode, "2D Mode", "Select and translate or rotate objects in 2D", EUserInterfaceActionType::RadioButton, FInputChord());
	...
	UI_COMMAND(
		RelativeCoordinateSystem_Parent,
		"Parent Space",
		"Move and rotate objects relative to the parent's axes",
		EUserInterfaceActionType::RadioButton,
		FInputChord()
	);
	UI_COMMAND(
		RelativeCoordinateSystem_Explicit,
		"Explicit Space",
		"Move objects relative to the parent's axes and rotate them using gimbal axes",
		EUserInterfaceActionType::RadioButton,
		FInputChord()
	);
	...
	UI_COMMAND( LocationGridSnap, "Grid Snap", "Toggle whether objects snap to a grid when you move them.\nUse the submenu to choose the grid size.", EUserInterfaceActionType::ToggleButton, FInputChord() );
	UI_COMMAND( RotationGridSnap, "Rotation Snap", "Toggle whether objects snap to preset angles when you rotate them.\nUse the submenu to choose the angle increment.", EUserInterfaceActionType::ToggleButton, FInputChord() );
	...
	UI_COMMAND( ScaleGridSnap, "Scale Snap", "Toggle whether objects resize by a preset ratio when you scale them.\nUse the submenu to choose the scaling increment.", EUserInterfaceActionType::ToggleButton, FInputChord() );
	UI_COMMAND( SurfaceSnapping, "Surface Snapping", "Toggle whether objects snap to surfaces when you drag them.\nUse the submenu to set up the snapping behavior.", EUserInterfaceActionType::ToggleButton, FInputChord() );
	...
	UI_COMMAND(ToggleDistanceBasedCameraSpeed, "Distance Based Camera Speed", "If enabled, scale the perspective camera speed based on the distance between the camera and its look-at position.", EUserInterfaceActionType::ToggleButton, FInputChord());
}
