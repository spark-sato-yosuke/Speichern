...
public:
	...
	/**
	 * List of deprecated UProperties/UFunctions to suppress warning messages for - useful for source changes
	 ...
	 */
	UPROPERTY(EditAnywhere, config, Category = Blueprints, DisplayName = "Deprecated Symbols to Suppress")
