...
public:
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Static Mesh Utilities")
	int32 GetLodCount(const UStaticMesh* StaticMesh);
	...
	TArray<float> GetLodScreenSizes(const UStaticMesh* StaticMesh);
...
public:
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Editor Scripting | StaticMesh")
	bool ImportNaniteHiResMesh(UStaticMesh* StaticMesh, const FString& SourceFilename, bool bShowDialogWhenFileMissing);
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "Editor Scripting | StaticMesh")
	bool UpdateNaniteSourceFilename(UStaticMesh* StaticMesh, const FString& NewSourceFilename);
...
public:
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Static Mesh Utilities")
	int32 GetSimpleCollisionCount(const UStaticMesh* StaticMesh);
	 ...
	 */
	UFUNCTION(BlueprintPure, Category = "Static Mesh Utilities")
	TEnumAsByte<ECollisionTraceFlag> GetCollisionComplexity(const UStaticMesh* StaticMesh);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Static Mesh Utilities")
	int32 GetConvexCollisionCount(const UStaticMesh* StaticMesh);
...
private:
	...
	*/
	static bool CanModifyStaticMeshSection(const UStaticMesh* StaticMesh, int32 LODIndex, int32 SectionIndex, const FString& LogFunctionName);
...
public:
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Static Mesh Utilities")
	bool IsSectionCastShadowEnabled(const UStaticMesh* StaticMesh, int32 LODIndex, int32 SectionIndex);
	 ...
	 */
	UFUNCTION(BlueprintPure, Category = "Static Mesh Utilities")
	bool IsSectionCollisionEnabled(const UStaticMesh* StaticMesh, int32 LODIndex, int32 SectionIndex);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Static Mesh Utilities")
	void EnableSectionVisibleInRayTracing(UStaticMesh* StaticMesh, bool bVisibleInRayTracing, int32 LODIndex, int32 SectionIndex);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Static Mesh Utilities")
	bool IsSectionVisibleInRayTracingEnabled(const UStaticMesh* StaticMesh, int32 LODIndex, int32 SectionIndex);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Static Mesh Utilities")
	void EnableSectionAffectDistanceFieldLighting(UStaticMesh* StaticMesh, bool bAffectDistanceFieldLighting, int32 LODIndex, int32 SectionIndex);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Static Mesh Utilities")
	bool IsSectionAffectDistanceFieldLightingEnabled(const UStaticMesh* StaticMesh, int32 LODIndex, int32 SectionIndex);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Static Mesh Utilities")
	void EnableSectionForceOpaque(UStaticMesh* StaticMesh, bool bForceOpaque, int32 LODIndex, int32 SectionIndex);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Static Mesh Utilities")
	bool IsSectionForceOpaqueEnabled(const UStaticMesh* StaticMesh, int32 LODIndex, int32 SectionIndex);
...
public:
	...
	*/
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Static Mesh Utilities")
	int32 GetLODMaterialSlot(const UStaticMesh* StaticMesh, int32 LODIndex, int32 SectionIndex);
	...
	UFUNCTION(BlueprintPure, Category = "Static Mesh Utilities")
	int32 GetNumberVerts(const UStaticMesh* StaticMesh, int32 LODIndex);

	/** Get number of Materials for a StaticMesh */
	UFUNCTION(BlueprintPure, Category = "Static Mesh Utilities")
	int32 GetNumberMaterials(const UStaticMesh* StaticMesh);
...
public:
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Static Mesh Utilities")
	int32 GetNumUVChannels(const UStaticMesh* StaticMesh, int32 LODIndex);
