 ...
 */
class SStaticMeshEditorViewport : public SAssetEditorViewport, public FGCObject, public ICommonEditorViewportToolbarInfoProvider, public IPreviewLODController
{
public:
	...
	virtual ~SStaticMeshEditorViewport() override;
...
private:
	...
	void ToggleShowRayTracingFallback();

	bool IsShowRayTracingFallbackChecked() const;

	bool IsShowRayTracingFallbackVisible() const;

	void SetFloorAndEnvironmentVisibility(bool bVisible);
