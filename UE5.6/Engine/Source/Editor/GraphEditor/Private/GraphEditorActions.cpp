...
void FGraphEditorCommandsImpl::RegisterCommands()
{
	...
	UI_COMMAND( ConvertFunctionToEvent, "Convert Function to Event", "Converts selected function to an event and removes the function definition.", EUserInterfaceActionType::Button, FInputChord() )
	...
	UI_COMMAND( StackNodesHorizontally, "Stack Horizontally", "Stacks the selected nodes horizontally", EUserInterfaceActionType::Button, FInputChord() )
	UI_COMMAND( StackNodesVertically, "Stack Vertically", "Stacks the selected nodes vertically", EUserInterfaceActionType::Button, FInputChord() )
	...
	UI_COMMAND( GoToDefinition, "Goto Definition", "Jumps to the definition of the selected node if available, e.g., C++ code for a native function or the graph for a Blueprint function.", EUserInterfaceActionType::Button, FInputChord(EKeys::G, EModifierKey::Alt) )
