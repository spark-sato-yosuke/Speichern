...
UE_SEQUENCER_DEFINE_VIEW_MODEL_TYPE_ID(IDeactivatableExtension);
...
UE_SEQUENCER_DEFINE_VIEW_MODEL_TYPE_ID(ITrackAreaViewSpaceProviderExtension);
UE_SEQUENCER_DEFINE_VIEW_MODEL_TYPE_ID(IViewSpaceClientExtension);
UE_SEQUENCER_DEFINE_VIEW_MODEL_TYPE_ID(FViewSpaceClientExtensionShim);
UE_SEQUENCER_DEFINE_VIEW_MODEL_TYPE_ID(IObjectModelExtension);
...
UE_SEQUENCER_DEFINE_VIEW_MODEL_TYPE_ID(FDeactiveStateCacheExtension);
...
UE_SEQUENCER_DEFINE_CASTABLE(FTrackAreaViewSpace);
