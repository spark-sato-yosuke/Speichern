...
public:
	...
	*/
	...
	/**
	 * Returns true if the Explicit mode is enabled;
	 */
...
protected:
	...
	UPROPERTY()
	TOptional<FGizmosParameters> DefaultGizmoParameters;
...
private:
	...
	void OnEditorModeChanged(const FName& InModeID, bool bInIsEnteringMode);
};
