...
/** Called to check if a class should be filtered out by external code. Return true to exclude the class from the view. */
DECLARE_DELEGATE_RetVal_OneParam(bool, FOnShouldFilterClass, const UClass* /*Class*/);
