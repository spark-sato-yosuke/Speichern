...
public:
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = DataLayers)
	void SetDataLayerInitialRuntimeState(UDataLayerInstance* DataLayer, EDataLayerRuntimeState InitialRuntimeState);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = DataLayers)
	void SetDataLayerIsInitiallyVisible(UDataLayerInstance* DataLayer, bool bIsInitiallyVisible);
	...
	*/
	 ...
	 */
	bool ApplyActorEditorContextDataLayersToActors(const TArray<AActor*>& InActors);
...
private:
	...
	void ApplyContext(AActor* InActor, bool bInForceTryApply = false, AActor* InReplacedActor = nullptr);
	...
	bool MoveActorToDataLayers(AActor* InActor, const TArray<UDataLayerInstance*>& InDataLayerInstances);
	void MoveActorToExternalDataLayer(AActor* InActor, const UExternalDataLayerInstance* InExternalDataLayerInstance, bool bInNotifyFailureReason = true);
	bool ShouldHandleActor(AActor* InActor) const;
