...
public:
	...
	FObjectBaseAddress(UObject* InObject, uint8* InStructAddress, uint8* InBaseAddress, bool bInIsStruct)
		: Object(InObject)
	...
	/** Object associated with the value, or owner object when editing a struct. */
...
public:
	...
	/**
	 * Sets a delegate to call when the property value of a child changes
	 */
	...
	/**
	 * Sets a delegate to call when the property value of a child is about to change
	 */
