 ...
 */
class IDetailsView : public SCompoundWidget, public IScrollableWidget
{
public:
	...
	/** Gets the minimum width of the detail panel's right column. */
	virtual float GetRightColumnMinWidth() const = 0;
	...
	*/
	...
	virtual TSharedRef<SWidget> GetScrollWidget() = 0;
