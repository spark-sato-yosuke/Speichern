...
#define LOCTEXT_NAMESPACE "EulerTransformPropertyTrackEditor"
...
FText FEulerTransformPropertyTrackEditor::GetDisplayName() const
{
	return LOCTEXT("EulerTransformPropertyTrackEditor_DisplayName", "Euler Transform Property");
}
...
void FEulerTransformPropertyTrackEditor::ProcessKeyOperation(FFrameNumber InKeyTime, const UE::Sequencer::FKeyOperation& Operation, ISequencer& InSequencer, TArray<UE::Sequencer::FAddKeyResult>* OutResults)
{
...
void FEulerTransformPropertyTrackEditor::ProcessKeyOperation(UObject* ObjectToKey, TArrayView<const UE::Sequencer::FKeySectionOperation> SectionsToKey, ISequencer& InSequencer, FFrameNumber KeyTime, TArray<UE::Sequencer::FAddKeyResult>* OutResults)
{
	using namespace UE::MovieScene;
	using namespace UE::Sequencer;

	TArray<FAddKeyResult> Results;
