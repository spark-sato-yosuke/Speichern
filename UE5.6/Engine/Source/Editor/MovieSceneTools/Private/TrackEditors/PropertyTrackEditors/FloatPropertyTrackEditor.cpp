...
#define LOCTEXT_NAMESPACE "FloatPropertyTrackEditor"
...
FText FFloatPropertyTrackEditor::GetDisplayName() const
{
	return LOCTEXT("FloatPropertyTrackEditor_DisplayName", "Float Property");
}
