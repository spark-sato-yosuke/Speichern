...
#define LOCTEXT_NAMESPACE "IntegerPropertyTrackEditor"
...
FText FIntegerPropertyTrackEditor::GetDisplayName() const
{
	return LOCTEXT("IntegerPropertyTrackEditor_DisplayName", "Integer Property");
}
