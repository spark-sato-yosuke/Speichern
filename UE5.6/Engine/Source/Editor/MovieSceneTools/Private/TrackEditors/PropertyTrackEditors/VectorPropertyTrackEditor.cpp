...
#define LOCTEXT_NAMESPACE "FloatVectorPropertyTrackEditor"
...
FText FFloatVectorPropertyTrackEditor::GetDisplayName() const
{
	return LOCTEXT("FloatVectorPropertyTrackEditor_DisplayName", "Float Vector Property");
}
...
FText FDoubleVectorPropertyTrackEditor::GetDisplayName() const
{
	return LOCTEXT("DoubleVectorPropertyTrackEditor_DisplayName", "Double Vector Property");
}
