...
#define LOCTEXT_NAMESPACE "ColorPropertyTrackEditor"
...
FText FColorPropertyTrackEditor::GetDisplayName() const
{
	return LOCTEXT("ColorPropertyTrackEditor_DisplayName", "Color Property");
}
