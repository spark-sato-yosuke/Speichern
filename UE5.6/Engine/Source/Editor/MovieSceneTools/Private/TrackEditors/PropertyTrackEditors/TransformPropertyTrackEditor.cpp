...
#define LOCTEXT_NAMESPACE "TransformPropertyTrackEditor"
...
FText FTransformPropertyTrackEditor::GetDisplayName() const
{
	return LOCTEXT("TransformPropertyTrackEditor_DisplayName", "Transform Property");
}
