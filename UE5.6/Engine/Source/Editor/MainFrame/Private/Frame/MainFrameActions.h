...
public:
	...
	/** Opens a dialog to view the past snapshots */
	static void ViewSnapshotHistory();

	/** Determines whether we can show the past snapshots view */
	static bool CanViewSnapshotHistory();

	/** Opens a dialog to check out any assets which have been modified */
	static void CheckOutModifiedFiles();

	/** Determines whether we can show the dialog to check out any assets which have been modified */
	static bool CanCheckOutModifiedFiles();
