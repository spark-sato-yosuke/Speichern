...
public:
	...
	void OnVariableAdded(const FName& VariableName);
	void OnVariableRenamed(const FName& OldName, const FName& NewName);
	void OnVariableRemoved(const FName& VariableName);
#endif
...
private:
	...
	void FixupLegacySequencePlayerCalls();
