 ...
 */
struct CURVEEDITOR_API FKeyDrawInfo
{
	FKeyDrawInfo()
		: ScreenSize(0.f, 0.f)
		, Brush(nullptr)
 ...
 */
struct CURVEEDITOR_API FCurvePointInfo
{
	...
	/** If false, the key will not be painted. */
	bool bDraw = true;
};
 ...
 */
struct CURVEEDITOR_API FCurveDrawParams
{
	...
	/** If false, the interpolating points will not be painted. */
	uint8 bDrawInterpolatingPoints : 1 = true;
