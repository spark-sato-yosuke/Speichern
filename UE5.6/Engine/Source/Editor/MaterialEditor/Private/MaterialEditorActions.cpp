...
void FMaterialEditorCommands::RegisterCommands()
{
	...
	UI_COMMAND( SetCylinderPreview, "Cylinder", "Sets the preview mesh to a cylinder primitive.", EUserInterfaceActionType::RadioButton, FInputChord() );
	UI_COMMAND( SetSpherePreview, "Sphere", "Sets the preview mesh to a sphere primitive.", EUserInterfaceActionType::RadioButton, FInputChord() );
	UI_COMMAND( SetPlanePreview, "Plane", "Sets the preview mesh to a plane primitive.", EUserInterfaceActionType::RadioButton, FInputChord() );
	UI_COMMAND( SetCubePreview, "Cube", "Sets the preview mesh to a cube primitive.", EUserInterfaceActionType::RadioButton, FInputChord() );
	UI_COMMAND( SetPreviewMeshFromSelection, "Mesh", "Sets the preview mesh based on the current content browser selection.", EUserInterfaceActionType::RadioButton, FInputChord() );
	...
	UI_COMMAND( CreateRerouteUsageFromDeclaration, "Create Reroute Usage", "Create Reroute Usage From Declaration.", EUserInterfaceActionType::Button, FInputChord() );
	...
	UI_COMMAND(PreviewHoveredNode, "Preview Hovered Node", "Previews the currently-hovered node", EUserInterfaceActionType::Button, FInputChord(EModifierKey::Shift, EKeys::SpaceBar) );
	...
	UI_COMMAND(DeletePin, "Delete Pin", "Delete Selected Pin", EUserInterfaceActionType::Button, FInputChord());
	...
	UI_COMMAND( CreateSelectNode, "Create Select Node", "Create a Select Node linked to the pin", EUserInterfaceActionType::Button, FInputChord());
