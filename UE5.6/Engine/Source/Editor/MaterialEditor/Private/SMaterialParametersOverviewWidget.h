...
#include "MaterialEditorDelegates.h"
...
public:
	...
	SLATE_EVENT(FSelectMaterialNode, SelectMaterialNode)
	SLATE_END_ARGS()
	void Refresh();
...
public:
	...
	virtual bool Private_OnItemDoubleClicked(TSharedPtr<FSortedParamData> TheItem) override;
...
private:
	...
	/** Called when a node should be selected in the material editor. */
	FSelectMaterialNode SelectMaterialNodeDelegate;
};
