...
public:
	...
	UE_DEPRECATED(5.6, "Please use the ActionButtonArgs instead")
	/** Button widget displayed in the center when hovering the thumbnail */
	TSharedPtr<SWidget> ActionButtonWidget;

	/** Button Args used to construct the Action Button */
	SButton::FArguments ActionButtonArgs;
};
...
public:
	...
	virtual bool ShouldFindEditorForAsset() const
	{ 
		return true;
	}
