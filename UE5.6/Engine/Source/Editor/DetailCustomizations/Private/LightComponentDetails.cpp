...
void FLightComponentDetails::AddLocalLightIntensityWithUnit(IDetailLayoutBuilder& DetailBuilder, ULocalLightComponent* Component)
{
	...
	else if (Component->IntensityUnits == ELightUnits::Nits)
	{
		LightIntensityProperty->SetInstanceMetaData("Units", TEXT("nt"));
		LightIntensityProperty->SetToolTipText(LOCTEXT("LightIntensityInNitsToolTipText", "Luminance in nits"));
	}
