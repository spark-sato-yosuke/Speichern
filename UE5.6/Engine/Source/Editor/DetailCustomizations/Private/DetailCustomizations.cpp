...
void FDetailCustomizationsModule::RegisterSectionMappings()
{
	...
	// Actor
	{
		...
		{
			TSharedRef<FPropertySection> Section = PropertyModule.FindOrCreateSection("Actor", "Audio", LOCTEXT("Audio", "Audio"));
			Section->AddCategory("Audio");
			Section->AddCategory("Sound");
			Section->AddCategory("Sounds");
			Section->AddCategory("MetaSound");
			Section->AddCategory("MetaSounds");
			Section->AddCategory("SFX");
			Section->AddCategory("Music");
			Section->AddCategory("VO");
		}
	}
	...
	// ActorComponent
	{
		...
		{
			TSharedRef<FPropertySection> Section = PropertyModule.FindOrCreateSection("ActorComponent", "Audio", LOCTEXT("Audio", "Audio"));
			Section->AddCategory("Audio");
			Section->AddCategory("Sound");
			Section->AddCategory("Sounds");
			Section->AddCategory("MetaSound");
	...
	// Post Process Volume
	{
		...
		{
			TSharedRef<FPropertySection> Section = PropertyModule.FindOrCreateSection("PostProcessVolume", "Rendering", LOCTEXT("Rendering", "Rendering"));
			Section->AddCategory("Rendering Features");
			Section->RemoveCategory("Path Tracing");
		}
		{
			TSharedRef<FPropertySection> Section = PropertyModule.FindOrCreateSection("PostProcessVolume", "ColorGrading", LOCTEXT("ColorGrading", "Color Grading"));
			Section->AddCategory("Color Grading");
		}
		{
			TSharedRef<FPropertySection> Section = PropertyModule.FindOrCreateSection("PostProcessVolume", "Film", LOCTEXT("Film", "Film"));
			Section->AddCategory("Film");
			Section->AddCategory("Film Grain");
		}
		{
			TSharedRef<FPropertySection> Section = PropertyModule.FindOrCreateSection("PostProcessVolume", "GlobalIllumination", LOCTEXT("GlobalIllumination", "Global Illumination"));
			Section->AddCategory("Global Illumination");
		}
		{
			TSharedRef<FPropertySection> Section = PropertyModule.FindOrCreateSection("PostProcessVolume", "Lens", LOCTEXT("Lens", "Lens"));
			Section->AddCategory("Lens");
		}
		{
			TSharedRef<FPropertySection> Section = PropertyModule.FindOrCreateSection("PostProcessVolume", "PathTracing", LOCTEXT("PathTracing", "Path Tracing"));
			Section->AddCategory("Path Tracing");
		}
		{
			TSharedRef<FPropertySection> Section = PropertyModule.FindOrCreateSection("PostProcessVolume", "Reflections", LOCTEXT("Reflections", "Reflections"));
			Section->AddCategory("Reflections");
		}
	}
	...
	{
		{
			TSharedRef<FPropertySection> Section = PropertyModule.FindOrCreateSection("CameraComponent", "CameraOptions", LOCTEXT("CameraOptions", "Camera Options"));
			Section->AddCategory("Camera Options");
		}
		{
			TSharedRef<FPropertySection> Section = PropertyModule.FindOrCreateSection("CameraComponent", "Camera", LOCTEXT("Camera", "Camera"));
			Section->AddCategory("Camera Settings");
			Section->AddCategory("Camera");
		}
		{
			TSharedRef<FPropertySection> Section = PropertyModule.FindOrCreateSection("CameraComponent", "PostProcess", LOCTEXT("PostProcess", "Post Process"));
			Section->AddCategory("Post Process");
		}
	}
	...
	{
		{
			TSharedRef<FPropertySection> Section = PropertyModule.FindOrCreateSection("CineCameraActor", "CurrentCameraSettings", LOCTEXT("CurrentCameraSettings", "Current Camera Settings"));
			Section->AddCategory("Current Camera Settings");
		}
		{
			TSharedRef<FPropertySection> Section = PropertyModule.FindOrCreateSection("CineCameraComponent", "CurrentCameraSettings", LOCTEXT("CurrentCameraSettings", "Current Camera Settings"));
			Section->AddCategory("Current Camera Settings");
		}
	}
}
