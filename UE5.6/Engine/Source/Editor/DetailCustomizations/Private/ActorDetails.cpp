...
void FActorDetails::CustomizeDetails( IDetailLayoutBuilder& DetailLayout )
{
	...
	if (TSharedPtr<IDetailsView> DetailsView = DetailLayout.GetDetailsViewSharedPtr(); !DetailLayout.HasClassDefaultObject() && DetailsView && DetailsView->GetSelectedActorInfo().NumSelected > 0)
	{
