...
void UViewportWorldInteraction::InitColors()
{
	Colors.SetNumZeroed((int32)EColors::TotalCount);
	{
		...
		Colors[(int32)EColors::Forward] = AxisDisplayInfo::GetAxisColor(EAxisList::X);
		Colors[(int32)EColors::Right] = AxisDisplayInfo::GetAxisColor(EAxisList::Y);
		Colors[(int32)EColors::Up] = AxisDisplayInfo::GetAxisColor(EAxisList::Z);
