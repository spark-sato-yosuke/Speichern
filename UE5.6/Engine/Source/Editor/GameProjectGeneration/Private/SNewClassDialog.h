...
public:
	SLATE_BEGIN_ARGS( SNewClassDialog )
		: _ClassDomain(EClassDomain::Native)
		, _Class(NULL)
		, _SyncContentBrowserToNewClass(true)
	{}
	...
	/** Whether we should sync the content browser to focus on the newly created asset */
	SLATE_ARGUMENT(bool, SyncContentBrowserToNewClass)
