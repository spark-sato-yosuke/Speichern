...
public:
	...
	*/
	...
	static bool IsEngineStarterContentAvailable() { return false; }

	/** Returns true if the given project is referencing engine starter content pack. */
	UE_DEPRECATED(5.6, "Ability to add Starter Content has been removed")
	static bool IsUsingEngineStarterContent(const FProjectInformation& ProjectInfo) { return false; }

	/** Returns true if there are any starter content packs are available for given project. */
	UE_DEPRECATED(5.6, "Ability to add Starter Content has been removed")
	static bool IsStarterContentAvailableForProject(const FProjectInformation& ProjectInfo) { return false; }
...
private:
	...
	UE_DEPRECATED(5.6, "Ability to add Starter Content has been removed")
	static FString GetStarterContentName(const FProjectInformation& InProjectInfo) { return FString{}; }
