...
namespace uba
{
	...
	public:
		...
		virtual bool KeepInMemory(const StringView& fileName, const tchar* systemTemp, bool isRunningRemote, bool isWrite) const
		{
		...
		// Is used by uba scheduler to decide if application can be cached. (This is not used by UBT)
