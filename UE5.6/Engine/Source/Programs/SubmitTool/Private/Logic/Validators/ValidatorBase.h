...
{
	const FString BranchStateValidator = TEXT("BranchStateValidator");
	const FString ContentValidator = TEXT("ContentValidator");
...
public:
	...
	{
		return State == EValidationStates::Valid || State == EValidationStates::Skipped || State == EValidationStates::Not_Applicable;
	}
