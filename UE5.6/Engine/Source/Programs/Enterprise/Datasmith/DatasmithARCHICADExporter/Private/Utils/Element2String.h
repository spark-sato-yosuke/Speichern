...
#if AC_VERSION > 27
	static GS::UniString GetValueTypePostfix(const GS::UniString& InValueType);

	static GS::UniString PropertyValueToString(const IFCAPI::v1::Value& InValue);

	static GS::UniString Concatenate(const GS::Array<GS::UniString>& InStrings, const GS::UniString& InSeparator);

	static GS::UniString ConcatenatePropertyValues(const std::vector<IFCAPI::Value>& InValues, const GS::UniString& InSeparator);

	static GS::UniString PropertyBoundedValueToString(const IFCAPI::v1::PropertyBoundedValue& InBoundedValue);

	static GS::UniString PropertyTableValueToString(const IFCAPI::PropertyTableValue& InTableValue);
#endif //AC_VERSION > 27
