...
namespace EpicGames.Localization
{
	...
	public class CommonSettingsParams
	{
		...
		public bool bValidateRichTextTags { get; set; } = false;
		...
		public static CommonSettingsParams CreateDefault(string localizationTargetName, string localizationTargetRootDirectory)
		{
			...
			commonSettings.bValidateRichTextTags = true;
	...
	public class GatherTextFromAssetsParams
	{
		...
		public List<string> WorldCollectionFilters { get; set; } = new List<string>();
		...
		public static GatherTextFromAssetsParams CreateDefault(string localizationTargetName, string localizationTargetRootDirectory)
		{
			...
			// @TODOLocalization: Decide whether or not to relax the errors when gathering assets as right now allowing this as a collection will cause
			// Engine plugins that rely on default auto plugin localization to fail 
			//gatherTextFromAssets.WorldCollectionFilters = new List<string>() { "Audit_InCook" };
