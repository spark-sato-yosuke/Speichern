...
namespace HordeServer.Perforce
{
	...
	public class PerforceController : ControllerBase
	{
		...
		/// Constructor
		/// </summary>
		public PerforceController(PerforceLoadBalancer perforceLoadBalancer, IOptionsSnapshot<BuildConfig> buildConfig)
		{
		...
		public ActionResult<List<PerforceCluster>> GetPerforceSettings()
		{
			...
			if (!buildConfig.Authorize(AdminAclAction.AdminRead, User))
			{
				return Forbid();
			}

			return buildConfig.PerforceClusters;
		}
	}
