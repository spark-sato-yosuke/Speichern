...
namespace HordeServer.Devices
{
	...
	public interface IDevice
	{
		...
		/// <summary>
		/// Whether the device requires a clean
		/// </summary>
		public bool? CleanRequired { get; }

		/// <summary>
		/// The time device the device cleaning started
		/// </summary>
		public DateTime? CleanStartTimeUtc { get; }

		/// <summary>
		/// The time the device cleaning finished
		/// </summary>
		public DateTime? CleanFinishTimeUtc { get; }
