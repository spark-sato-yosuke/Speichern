...
export type GetDashboardArtifactTypeResponse = {
	type: string;
	keepDays?: number;
}
...
export type GetDashboardConfigResponse = {
	...
	/** Artifact type information */
	artifactTypeInfo: GetDashboardArtifactTypeResponse[];
...
export enum ArtifactBrowserType {
	Directory,
	File,
	NavigateUp
}

export type ArtifactBrowserItem = {
	key: string;
	text: string;
	icon?: string;
	size?: number;
	type: ArtifactBrowserType;
...
export type ArtifactSelection = {
	...
	directoriesSelected: number;
	size: number;
	items: ArtifactBrowserItem[];
}
...
export type GetTemplateRefResponse = GetTemplateResponseBase & {
	...
	/** Whether the current user can run the template or not */
	canRun?: boolean;
...
export type GetDeviceResponse = {
	...
	/** The time the cleaning started */
	cleanStartTime?: Date | string;

	/** The time the cleaning finished */
	cleanFinishTime?: Date | string;

	/** Whether the device requires cleaning */
	cleanRequird?: boolean;
