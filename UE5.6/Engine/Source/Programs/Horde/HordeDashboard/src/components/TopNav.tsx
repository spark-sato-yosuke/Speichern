...
const ToolsButton: React.FunctionComponent<IButtonProps> = (props) => {
   return <MenuButton props={props} link="/tools"/>
}
            ...
            <Stack horizontal verticalAlign='center' styles={{ root: { height: "60px" } }} >
               ...
               <Stack horizontal verticalAlign="center" tokens={{ childrenGap: 0 }}>
                  ...
                  <Stack style={{ width: "32px" }} onMouseEnter={() => setShowMenu(true)}
                     ...
                     <div ref={divRef}>
                        <Link to={"/dashboard"}>
                           <Persona styles={{ root: { selectors: { ".ms-Persona-initials": { fontWeight: "unset", fontFamily: "Horde Open Sans SemiBold", cursor: "pointer" } } } }} 
                              imageShouldFadeIn={false} imageInitials={initials} imageUrl={dashboard.userImage32} size={PersonaSize.size32} />
                        </Link>
                     </div>
                     <ContextualMenu
                        items={menuItems}
