...
import userInactivity from "horde/backend/UserInactivity";
...
export const JobDetailViewV2: React.FC = () => {
   ...
   useEffect(() => {
      ...
      function reloadPage() {
         ...
         // If haven't touched page in 10 minutes reload it
         if (userInactivity.getSecondsSinceLastActivity() > 600) {
            location.reload();
         }

      }

      // reload the page once every 8 hours of inactivity
      const interval = setInterval(() => reloadPage(), 3600000 * 8);
