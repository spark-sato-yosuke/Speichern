      ...
      <Stack className={hordeClasses.raised}>
         <Stack tokens={{ childrenGap: 18 }}>
            ...
            <Stack >
               ...
               {!!parentJobUrl && <Stack style={{ paddingTop: 8}}><Markdown>{`This step was spawned by a [parent job](${parentJobUrl}).`}</Markdown></Stack>}
               {!!spawnedJobUrl && <Stack style={{ paddingTop: 8 }}><Markdown>{`This step spawned a [new job](${spawnedJobUrl}).`}</Markdown></Stack>}
