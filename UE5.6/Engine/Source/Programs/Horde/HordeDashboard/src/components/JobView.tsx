...
import { GetJobsTabLabelColumnResponse, GetJobsTabParameterColumnResponse, GetLabelStateResponse, JobData, JobsTabColumnType, JobsTabData, JobState, LabelOutcome, LabelState, StreamData } from '../backend/Api';
      ...
      return <Stack>
         <div id={target}>
            <Link to={url}><Stack className={hordeClasses.badgeNoIcon}>
               <DefaultButton key={label.dashboardName} style={{ backgroundColor: color.primaryColor }} text={label.dashboardName}
                  onMouseOver={(ev) => {
                     ev.stopPropagation();
