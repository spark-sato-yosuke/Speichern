...
namespace EpicGames.UHT.Types
{
	...
	public class UhtTextProperty : UhtProperty
	{
		...
		private static UhtProperty? TextProperty(UhtPropertyResolveArgs args)
		{
			return new UhtTextProperty(args.PropertySettings);
		}
		...
		[SuppressMessage("CodeQuality", "IDE0051:Remove unused private members", Justification = "Attribute accessed method")]
		[SuppressMessage("Style", "IDE0060:Remove unused parameter", Justification = "Attribute accessed method")]
		private static UhtProperty? MissingPrefixTextProperty(UhtPropertyResolveArgs args)
		{
			throw new UhtException(args.TokenReader, "'Text' is missing a prefix, expecting 'FText'");
		}
