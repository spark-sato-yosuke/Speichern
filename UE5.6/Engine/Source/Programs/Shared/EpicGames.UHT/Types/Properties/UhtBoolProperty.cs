...
namespace EpicGames.UHT.Types
{
	...
	public class UhtBoolProperty : UhtProperty
	{
		...
		/// </summary>
		[JsonIgnore]
		public override string StrippedEngineName => EngineName.StartsWith('b') ? EngineName[1..] : EngineName;
		...
		private static UhtProperty? BoolProperty(UhtPropertyResolveArgs args)
		{
