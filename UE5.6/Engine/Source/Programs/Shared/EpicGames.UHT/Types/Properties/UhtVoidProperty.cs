...
namespace EpicGames.UHT.Types
{
	...
	public class UhtVoidProperty : UhtProperty
	{
		...
		private static UhtProperty? VoidProperty(UhtPropertyResolveArgs args)
		{
			if (args.PropertySettings.PropertyCategory != UhtPropertyCategory.Return)
			{
				args.TokenReader.LogError("void type is only valid as a return type");
				return null;
			}
