...
namespace EpicGames.UHT.Types
{
	...
	public class UhtEnumProperty : UhtProperty
	{
		...
		public static StringBuilder AppendEnumText(StringBuilder builder, UhtProperty property, UhtEnum enumObj, UhtPropertyTextType textType, bool isTemplateArgument)
		{
			switch (textType)
			{
				...
				case UhtPropertyTextType.VerseMangledType:
					builder.AppendVersePath(enumObj, UhtVerseFullNameMode.Default);
					break;
		...
		private static UhtProperty? EnumProperty(UhtPropertyResolveArgs args)
		{
			...
			args.TokenReader
				...
				.Require('>');
			return enumObj != null ? new UhtByteProperty(args.PropertySettings, enumObj) : null;
		}
		#endregion
	}
}
