...
namespace EpicGames.UHT.Utils
{
	...
	public static class UhtNames
	{
		...
		public const string StateStreamStaticState = "StateStreamStaticState";
		public const string StateStreamDynamicState = "StateStreamDynamicState";
		public const string StateStreamHandle = "StateStreamHandle";
		...
		// Verse names
		public const string VerseProxySuffix = "__Proxy";

		// Compiler directives
		public const string WithHotReload = "WITH_HOT_RELOAD";
		public const string WithEditor = "WITH_EDITOR";
		public const string WithEditorOnlyData = "WITH_EDITORONLY_DATA";
		public const string WithEngine = "WITH_ENGINE";
		public const string WithCoreUObject = "WITH_COREUOBJECT";
		public const string WithVerseVM = "WITH_VERSE_VM";
		public const string WithTests = "WITH_TESTS";
	}
}
