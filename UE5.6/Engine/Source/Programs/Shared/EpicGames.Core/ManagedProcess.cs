...
#pragma warning restore IDE0049 // Naming Styles
		...
		/// </summary>
		internal static bool SupportsJobObjects => OperatingSystem.IsWindows();
		...
		public TimeSpan TotalProcessorTime
		{
			get
			{
				if (SupportsJobObjects)
				{
					...
					if (QueryInformationJobObject(JobHandle!, JobObjectBasicAccountingInformation, ref accountingInformation, Marshal.SizeOf(typeof(JOBOBJECT_BASIC_ACCOUNTING_INFORMATION))))
					{
...
#pragma warning restore CA2213
		...
		{
			Dictionary<string, string> newEnvironment = [];
