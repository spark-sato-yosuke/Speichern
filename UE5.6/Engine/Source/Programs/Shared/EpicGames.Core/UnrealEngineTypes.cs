...
namespace EpicGames.Core
{
	...
	public enum EClassFlags : uint
	{
		...
		/// </summary>
		Inherit = Transient | Optional | DefaultConfig | Config | PerObjectConfig | ConfigDoNotCheckDefaults | MigratingAsset | NotPlaceable | Const | HasInstancedReference |
		...
		/// </summary>
		SaveInCompiledInClasses = Abstract | DefaultConfig | GlobalUserConfig | ProjectUserConfig | PerPlatformConfig | Config | Transient | Optional | Native | MigratingAsset | NotPlaceable | PerObjectConfig |
	...
	public enum EClassCastFlags : ulong
	{
		...
		FVerseStringProperty = 0x0800000000000000,
	...
	public enum EInternalObjectFlags : int
	{
		...
		/// <summary>
		/// Object is no longer owned by this process
		/// </summary>
		Remote = 1 << 17,

		/// <summary>
		/// Object referenced by remote process
		/// </summary>
		RemoteReference = 1 << 18,
		...
		/// </summary>
		AsyncLoadingPhase1 = 1 << 21,

		/// <summary>
		/// External reference to object in cluster exists
		/// </summary>
		ReachableInCluster = 1 << 22,
		...
		/// </summary>
		PendingConstruction = 1 << 30,

		/// <summary>
		/// Object was constructed in an AutoRTFM transaction that has been aborted
		/// </summary>
		AutoRTFMConstructionAborted = 1 << 31,
	...
	public enum EPackageFlags : ulong
	{
		...
		/// </summary>
		AccessSpecifierEpicInternal = 0x00001000,
	...
	public enum EPropertyFlags : ulong
	{
		...
		/// <summary>
		/// Flags to keep in the inner type when propagating container flags 
		/// </summary>
		PropagateKeepInInner = NonNullable,
