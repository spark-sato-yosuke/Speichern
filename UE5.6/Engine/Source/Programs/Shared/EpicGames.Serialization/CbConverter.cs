...
namespace EpicGames.Serialization
{
	...
	public static class CbConverterMethods
	{
		...
		static readonly Dictionary<PropertyInfo, ICbConverterMethods> s_propertyToMethods = [];
		static readonly Dictionary<Type, ICbConverterMethods> s_typeToMethods = [];
	...
	public partial class CbConverter
	{
		...
		/// </summary>
		static readonly Dictionary<PropertyInfo, CbConverter> s_propertyToConverter = [];
		...
		/// </summary>
		public static List<CbConverterFactory> ConverterFactories { get; } =
		[
		...
		class CbConverterCache<T>
		{
			...
			/// </summary>
			class CbConverterWrapper(CbConverter inner) : CbConverter<T>
			{
				/// <inheritdoc/>
