...
protected:
	...
	ENGINE_API FBasedMovementInfo& GetReplicatedBasedMovement_Mutable();
...
public:
	...
	FORCEINLINE float GetReplayLastTransformUpdateTimeStamp() const { return ReplayLastTransformUpdateTimeStamp; }
	...
	FORCEINLINE uint8 GetReplicatedMovementMode() const { return ReplicatedMovementMode; }
...
public:
	...
	*/
	...
	FORCEINLINE bool GetProxyIsJumpForceApplied() const { return bProxyIsJumpForceApplied; }
...
public:
	...
	FORCEINLINE const FRepRootMotionMontage& GetRepRootMotion() const { return RepRootMotion; }

	/** Replicated Root Motion montage. Returns non-const RepRootMotion*/
	ENGINE_API FRepRootMotionMontage& GetRepRootMotion_Mutable();
