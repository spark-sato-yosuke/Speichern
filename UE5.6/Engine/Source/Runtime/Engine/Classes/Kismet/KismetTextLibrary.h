...
class UKismetTextLibrary : public UBlueprintFunctionLibrary
{
	 ...
	 * @param bEmitChangeNotify	True to emit a pre/post edit change notify (in the editor). You should set this to false if editing text within a construction script.
	 * 
	...
	static ENGINE_API bool EditTextSourceString(UObject* TextOwner, UPARAM(ref) FText& Text, const FString& SourceString, const bool bEmitChangeNotify = true);
	 ...
	 * 
	 * @param TextOwner			The object that owns the given Text to be edited.
	 * @param PropertyName		The name of the text property to edit. This must be a property that exists on TextOwner.
	 * @param SourceString		The source string that the edited text property should use.
	 * @param bEmitChangeNotify	True to emit a pre/post edit change notify (in the editor). You should set this to false if editing text within a construction script.
	 * 
	 * @return True if edit was possible, or false if not.
	...
	static ENGINE_API bool EditTextPropertySourceString(UObject* TextOwner, const FName PropertyName, const FString& SourceString, const bool bEmitChangeNotify = true);
	static bool Generic_EditTextPropertySourceString(UObject* TextOwner, const FTextProperty* TextProperty, const FString& SourceString, const bool bEmitChangeNotify);
