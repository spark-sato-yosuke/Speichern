...
public:
	...
	UFUNCTION()
	UPrimitiveComponent* GetChildClusteredComponent() const { return ChildClusteredComponent.Get(); }
	...
	UFUNCTION()
	const TArray<int32>& GetParticleBoneIds() const { return ParticleBoneIds; }
	...
	const TArray<FTransform>& GetParticleChildToParents() { return ParticleChildToParents; }
