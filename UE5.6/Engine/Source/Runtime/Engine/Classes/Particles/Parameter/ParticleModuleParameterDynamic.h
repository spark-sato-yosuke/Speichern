...
class UParticleModuleParameterDynamic : public UParticleModuleParameterBase
{
	 ...
	 */
	void SpawnEx(const FSpawnContext& Context, struct FRandomStream* InRandomStream);
	 ...
	 */
	FORCEINLINE float GetParameterValue(const FContext& Context, FEmitterDynamicParameter& InDynParams, FBaseParticle& Particle, FParticleEmitterInstance* Owner, struct FRandomStream* InRandomStream)
	{
		...
		if ((InDynParams.bScaleVelocityByParamValue == true) || (InDynParams.ValueMethod == EDPV_UserSet))
		{
			...
			DistributionValue = InDynParams.ParamValue.GetValue(TimeValue, Context.GetDistributionData(), InRandomStream);
		}
	 ...
	 *	@return	float			The value for the parameter.
	 */
	FORCEINLINE float GetParameterValue_UserSet(const FContext& Context, FEmitterDynamicParameter& InDynParams, FBaseParticle& Particle, FParticleEmitterInstance* Owner, struct FRandomStream* InRandomStream)
	{
		return InDynParams.ParamValue.GetValue(InDynParams.bUseEmitterTime ? Owner->EmitterTime : Particle.RelativeTime, Context.GetDistributionData(), InRandomStream);
	}
