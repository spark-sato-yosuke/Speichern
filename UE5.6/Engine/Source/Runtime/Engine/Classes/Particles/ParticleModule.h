...
class UParticleModule : public UObject
{
	...
	*/
	...
	ENGINE_API virtual void	Spawn(const FSpawnContext& Context);
	...
	ENGINE_API virtual void	Update(const FUpdateContext& Context);
	/**
	 ...
	 *	@param	DeltaTime	The time since the last update.
	 */
	ENGINE_API virtual void	FinalUpdate(const FUpdateContext& Context);
	 ...
	 */
	ENGINE_API FRandomStream& GetRandomStream(const FContext& Context);
