...
class UParticleModuleLocationSkelVertSurface : public UParticleModuleLocationBase
{
	 ...
	 *
	 */
	ENGINE_API void GetSkeletalMeshComponentSource(const FContext& Context, FModuleLocationVertSurfaceInstancePayload* InstancePayload);
	 ...
	 */
	ENGINE_API bool GetParticleLocation(const FContext& Context, FModuleLocationVertSurfaceInstancePayload* InstPayload, USkeletalMeshComponent* InSkelMeshComponent, int32 InPrimaryVertexIndex, FVector& OutPosition, FQuat& OutRotation, bool bSpawning = false);
