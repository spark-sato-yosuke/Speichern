...
public:
	...
	/** Owner for particle emitter instances. Reroutes calls to this component. (This is used to abstract away dependency on UParticleSystemComponent) */
	class FInstanceOwner;
	TUniquePtr<FInstanceOwner> InstanceOwner;
...
private:
	...
	FParticleSystemHandle ParticleSystemHandle;
#endif
