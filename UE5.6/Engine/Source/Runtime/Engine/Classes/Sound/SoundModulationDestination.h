...
struct FSoundModulationDefaultSettings
{
	...
	FSoundModulationDestinationSettings GetSettingsForDestination(EModulationDestination Destination) const;
...
struct FSoundModulationDefaultRoutingSettings : public FSoundModulationDefaultSettings
{
	...
	EModulationRouting GetRoutingForDestination(EModulationDestination Destination) const;
};
...
namespace Audio
{
	...
	private:
			...
			{
				FDeviceId DeviceId = FDeviceId(INDEX_NONE);
