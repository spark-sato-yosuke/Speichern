...
#include "StateStream/StaticMeshStateStreamHandle.h"
...
protected:
	...
	/** Whether PrecachedPSOs was called. */
	uint8 bPrecachedPSOs : 1;
...
public:
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Mesh Painting", meta=(InlineEditConditionToggle))
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, AdvancedDisplay, Category = "Mesh Painting", meta=(UIMin = "0", UIMax = "3", editcondition = "bOverrideMeshPaintTextureCoordinateIndex"))
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, AdvancedDisplay, Category = "Mesh Painting", meta = (UIMin = "0", UIMax = "4096", ClampMax = "4096", editcondition = "bOverrideMeshPaintTextureResolution"))
	...
	TObjectPtr<UTexture> MaterialCacheTexture;
...
protected: 
	...
	ENGINE_API virtual bool ShouldIncrementalPreRegister(UWorld* WorldContext) const override;
...
public:
	...
	ENGINE_API virtual bool AllowsAsyncPhysicsStateCreation() const override;
	ENGINE_API virtual bool AllowsAsyncPhysicsStateDestruction() const override;
...
//~ End UPrimitiveComponent Interface.
	...
	UE_DEPRECATED(5.6, "Use UPrimitiveComponent::IsFirstPersonRelevant() instead.")
	bool IsStaticMeshFirstPersonRelevant() const { return FirstPersonPrimitiveType != EFirstPersonPrimitiveType::None; }
	...
	*/
	...
	FORCEINLINE bool GetOverrideMinLOD() const { return bOverrideMinLOD; }
	FORCEINLINE int32 GetMinLOD() const { return MinLOD; }
	FORCEINLINE bool GetForceNaniteForMasked() const { return bForceNaniteForMasked; }

#if WITH_EDITORONLY_DATA
	bool IsDisplayNaniteFallbackMesh() const { return bDisplayNaniteFallbackMesh; }
#endif
