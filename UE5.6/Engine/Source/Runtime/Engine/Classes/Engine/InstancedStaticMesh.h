...
public:
	...
	ENGINE_API virtual void UpdateInstances_RenderThread(FRHICommandListBase& RHICmdList, const FBoxSphereBounds& InBounds, const FBoxSphereBounds& InLocalBounds) override;
	...
	{
		// TODO: support static ray tracing instances when not using WPO
		return false;
	}
...
#if RHI_RAYTRACING
	ENGINE_API void SetupRayTracingDynamicInstances(FRHICommandListBase& RHICmdList, int32 NumDynamicInstances, int32 LODIndex);
