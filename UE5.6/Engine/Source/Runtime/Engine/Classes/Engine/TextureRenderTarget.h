...
class UTextureRenderTarget : public UTexture
{
	...
	ENGINE_API static float GetDefaultDisplayGamma();
	...
	constexpr static auto OnTextureChangingDefault = [](UTexture*){};
	ENGINE_API bool UpdateTexture(UTexture* InTexture, EConstructTextureFlags InFlags = CTF_Default, const TArray<uint8>* InAlphaOverride = nullptr, FOnTextureChangingDelegate InOnTextureChangingDelegate = OnTextureChangingDefault, FText* OutErrorMessage = nullptr);
