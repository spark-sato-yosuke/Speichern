...
class UTextureRenderTarget2D : public UTextureRenderTarget
{
	...
	ENGINE_API virtual bool CanConvertToTexture(ETextureSourceFormat& OutTextureSourceFormat, EPixelFormat& OutPixelFormat, FText* OutErrorMessage) const override;
	ENGINE_API virtual TSubclassOf<UTexture> GetTextureUClass() const override;
	ENGINE_API virtual EPixelFormat GetFormat() const override;
	ENGINE_API virtual bool IsSRGB() const override;
