...
public:
	...
	/** Returns the local player who the given input device is assigned to. Null if not found */
	ENGINE_API ULocalPlayer* FindLocalPlayerFromDeviceId(const FInputDeviceId DeviceID) const;
