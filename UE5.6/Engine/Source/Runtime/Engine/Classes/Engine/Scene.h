...
{
	Unitless UMETA(DisplayName = "Unitless"), 
	Candelas UMETA(DisplayName = "Candelas - Luminous Intensity, Normalized"),
	Lumens   UMETA(DisplayName = "Lumens - Luminous Flux, Normalized"),
	EV       UMETA(DisplayName = "EV - Exposure Value, Normalized"),
	Nits     UMETA(DisplayName = "Nits - Luminance, Non-Normalized")
};
...
{
	Raster = 0		 UMETA(DisplayName = "Raster"),
	RayTraced_Deprecated UE_DEPRECATED(5.6, "Use RayTraced instead") = 1 UMETA(DisplayName = "Legacy Ray Tracing (Deprecated)", ToolTip = "The legacy Ray Tracing Translucency Method is deprecated, use Ray Traced instead"),
	RayTracing UE_DEPRECATED(5.6, "Use RayTraced instead") = 1 UMETA(Hidden),
	RayTraced = 2 UMETA(DisplayName = "Ray Traced")
};
...
struct FMatteBoxFlag
{
	...
	UPROPERTY(interp, BlueprintReadWrite, Category=FMatteBoxFlag, meta=(ClampMin = "-90.0", ClampMax = "90.0"))
	float Pitch;

	/** Rotation of the panel around the lens barrel */
	UPROPERTY(interp, BlueprintReadWrite, Category=FMatteBoxFlag, meta=(ClampMin = "0.0", ClampMax = "360.0"))
	float Roll;

	/** How long is the panel */
	UPROPERTY(interp, BlueprintReadWrite, Category=FMatteBoxFlag, meta=(ClampMin = "0.0", UIMax = "100.0"))
	float Length;
...
struct FPostProcessSettings
{
	...
	*/
	...
	UPROPERTY(interp, BlueprintReadWrite, Category="Global Illumination|Lumen Global Illumination", AdvancedDisplay, meta=(editcondition = "bOverride_LumenSkylightLeakingTint", DisplayName = "Skylight Leaking Tint", HideAlphaChannel))
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category="Lens|Camera", meta=(ClampMin = "0.01", ClampMax = "8000.0", editcondition = "bOverride_CameraShutterSpeed", DisplayName = "Shutter Speed (1/s)"))
	...
	*/
	UPROPERTY(interp, BlueprintReadWrite, Category="Lens|Local Exposure", AdvancedDisplay, meta=(UIMin = "0.0", UIMax = "1.0", editcondition = "bOverride_LocalExposureHighlightThresholdStrength", DisplayName = "Highlight Threshold Strength"))
	float LocalExposureHighlightThresholdStrength;

	/**
	 * Strength of the shadow threshold.
	*/
	UPROPERTY(interp, BlueprintReadWrite, Category="Lens|Local Exposure", AdvancedDisplay, meta=(UIMin = "0.0", UIMax = "1.0", editcondition = "bOverride_LocalExposureShadowThresholdStrength", DisplayName = "Shadow Threshold Strength"))
	 ...
	 * 0: no adjustment, -1:2x darker, -2:4x darker, 1:2x brighter, 2:4x brighter, ...
	 */
	UPROPERTY(interp, BlueprintReadWrite, Category = "Lens|Local Exposure", AdvancedDisplay, meta = (UIMin = "-15.0", UIMax = "15.0", editcondition = "bOverride_LocalExposureMiddleGreyBias", DisplayName = "Middle Grey Bias"))
	...
	UPROPERTY(interp, EditAnywhere, BlueprintReadWrite, Category = "Lens|Depth of Field", meta = (ClampMin = "-10.0", ClampMax = "10.0", editcondition = "bOverride_DepthOfFieldPetzvalBokeh", DisplayName = "Petzval Bokeh"))
	float DepthOfFieldPetzvalBokeh;

	/** How quickly does the Petzval bokeh effect increase towards the edge of the image */
	UPROPERTY(interp, EditAnywhere, BlueprintReadWrite, Category="Lens|Depth of Field", meta=(ClampMin = "0.0", UIMax = "10.0", editcondition = "bOverride_DepthOfFieldPetzvalBokehFalloff", DisplayName = "Petzval Bokeh Falloff"))
	float DepthOfFieldPetzvalBokehFalloff;

	/** Box, centered on screen, around which the Petzval effect is applied. */
	UPROPERTY(interp, EditAnywhere, BlueprintReadWrite, Category="Lens|Depth of Field", meta=(ClampMin = "0.0", ClampMax = "1.0", editcondition = "bOverride_DepthOfFieldPetzvalExclusionBoxExtents", DisplayName = "Petzval Bokeh Exclusion Box"))
	FVector2f DepthOfFieldPetzvalExclusionBoxExtents;

	/** Corner radius */
	UPROPERTY(interp, EditAnywhere, BlueprintReadWrite, Category="Lens|Depth of Field", meta=(ClampMin = "0.0", ClampMax = "1.0", editcondition = "bOverride_DepthOfFieldPetzvalExclusionBoxRadius", DisplayName = "Petzval Bokeh Exclusion Box Radius"))
	...
	UPROPERTY(Interp, BlueprintReadWrite, Category="Lens|Depth of Field", meta=(ClampMin = "0.0", editcondition = "bOverride_DepthOfFieldAspectRatioScalar", DisplayName = "Aspect Ratio Scalar"))
	float DepthOfFieldAspectRatioScalar;
		
	/** The lens barrel creates vignetting and occludes bokeh, i.e. cat's eye bokeh */
	UPROPERTY(interp, EditAnywhere, BlueprintReadWrite, Category="Lens|Depth of Field", meta=(ClampMin = "0.0", UIMax = "100.0", editcondition = "bOverride_DepthOfFieldBarrelRadius", DisplayName = "Barrel Radius"))
	float DepthOfFieldBarrelRadius;

	/** The lens barrel creates vignetting and occludes bokeh, i.e. cat's eye bokeh */
	UPROPERTY(interp, EditAnywhere, BlueprintReadWrite, Category="Lens|Depth of Field", meta=(ClampMin = "0.0", UIMax = "150.0", editcondition = "bOverride_DepthOfFieldBarrelLength", DisplayName = "Barrel Length"))
	float DepthOfFieldBarrelLength;

	/** Panels around the front of the lens barrel that occlude bokeh */
	UPROPERTY(EditAnywhere, Category="Lens|Depth of Field", meta=(editcondition = "bOverride_DepthOfFieldMatteBoxFlags", DisplayName = "Matte Box Flags"))
	...
	*/
	...
	UPROPERTY(interp, EditAnywhere, BlueprintReadWrite, Category = "Rendering Features|Translucency", meta = (editcondition = "bOverride_TranslucencyType", DisplayName = "Translucency Method"))
	...
	UPROPERTY(interp, BlueprintReadWrite, Category = "Rendering Features|Translucency", meta = (ClampMin = "0.01", ClampMax = "1.0", editcondition = "bOverride_RayTracingTranslucencyMaxRoughness", DisplayName = "Max Roughness", TranslucencyType = "RayTraced_Deprecated"))
	float RayTracingTranslucencyMaxRoughness;

	/** Sets the maximum number of ray tracing refraction rays. */
	UPROPERTY(interp, EditAnywhere, BlueprintReadWrite, Category = "Rendering Features|Translucency", meta = (ClampMin = "0", ClampMax = "50", editcondition = "bOverride_RayTracingTranslucencyRefractionRays", DisplayName = "Max. Refraction Rays", TranslucencyType = "RayTraced_Deprecated"))
	int32 RayTracingTranslucencyRefractionRays;

	/** Sets the samples per pixel for ray traced translucency. */
	UPROPERTY(interp, EditAnywhere, BlueprintReadWrite, Category = "Rendering Features|Translucency", meta = (ClampMin = "1", ClampMax = "65536", editcondition = "bOverride_RayTracingTranslucencySamplesPerPixel", DisplayName = "Samples Per Pixel", TranslucencyType = "RayTraced_Deprecated"))
	int32 RayTracingTranslucencySamplesPerPixel;

	/** Maximum number of hit events allowed on primary ray paths */
	UPROPERTY(interp, EditAnywhere, BlueprintReadWrite, Category = "Rendering Features|Translucency", meta = (ClampMin = "1", ClampMax = "64", editcondition = "bOverride_RayTracingTranslucencyMaxPrimaryHitEvents", DisplayName = "Max. Primary Hit Events", TranslucencyType = "RayTraced"))
	int32 RayTracingTranslucencyMaxPrimaryHitEvents;

	/** Maximum number of hit events allowed on secondary ray paths */
	UPROPERTY(interp, EditAnywhere, BlueprintReadWrite, Category = "Rendering Features|Translucency", meta = (ClampMin = "0", ClampMax = "64", editcondition = "bOverride_RayTracingTranslucencyMaxSecondaryHitEvents", DisplayName = "Max. Secondary Hit Events", TranslucencyType = "RayTraced"))
	int32 RayTracingTranslucencyMaxSecondaryHitEvents;

	/** Sets the translucency shadows type. */
	UPROPERTY(interp, EditAnywhere, BlueprintReadWrite, Category = "Rendering Features|Translucency", meta = (editcondition = "bOverride_RayTracingTranslucencyShadows", DisplayName = "Shadows", TranslucencyType = "RayTraced_Deprecated"))
	...
	UPROPERTY(interp, EditAnywhere, BlueprintReadWrite, Category = "Rendering Features|Translucency", meta = (editcondition = "bOverride_RayTracingTranslucencyRefraction", DisplayName = "Refraction", TranslucencyType = "RayTraced_Deprecated"))
	...
	UPROPERTY(interp, EditAnywhere, BlueprintReadWrite, Category = "Rendering Features|Translucency", meta = (editcondition = "bOverride_RayTracingTranslucencyUseRayTracedRefraction", DisplayName = "Use Ray Traced Refraction", TranslucencyType = "RayTraced"))
...
PRAGMA_ENABLE_DEPRECATION_WARNINGS
	...
	// Get the default post-process settings
