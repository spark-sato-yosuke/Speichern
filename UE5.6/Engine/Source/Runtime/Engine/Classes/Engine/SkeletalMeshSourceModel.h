...
struct FSkeletalMeshSourceModel
{
	...
	*/ 
	...
	/** Get the vertex color GUID as an optional value. If the mesh has no vertex colors defined, then
...
private:
	...
	UPROPERTY()
	TOptional<bool> CachedHasVertexColors;

	UPROPERTY()
	FGuid CachedVertexColorGuid;
