...
private:
	TOptional<int32> StreamingPriorityOverrideBackup;
...
private:
	...
	ENGINE_API void UpdateStreamingState(bool& bOutUpdateAgain, bool& bOutRedetermineTarget, const TOptional<const UE::FTimeout>& InExternalTimeout);
...
private:
	...
	/** Update the load process of the streaming level. Out parameters instruct calling code how to proceed. */
	static void UpdateStreamingState(ULevelStreaming* StreamingLevel, bool& bOutUpdateAgain, bool& bOutRedetermineTarget, const TOptional<const UE::FTimeout>& InExternalTimeout) { StreamingLevel->UpdateStreamingState(bOutUpdateAgain, bOutRedetermineTarget, InExternalTimeout); }
