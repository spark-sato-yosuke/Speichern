...
public:
	...
	ENGINE_API virtual ~FLocalVertexFactory();
...
{
	DECLARE_EXPORTED_TYPE_LAYOUT(FLocalVertexFactoryShaderParametersBase, ENGINE_API, NonVirtual);
public:
	ENGINE_API void Bind(const FShaderParameterMap& ParameterMap);

	ENGINE_API void GetElementShaderBindingsBase(
...
{
	DECLARE_EXPORTED_TYPE_LAYOUT(FLocalVertexFactoryShaderParameters, ENGINE_API, NonVirtual);
public:
