...
protected:
	...
	Audio::FDeviceId OwningDeviceID = Audio::FDeviceId(INDEX_NONE);
};
...
public:
	...
	{
		UClass* InterfaceClass = InterfaceToCastTo::UClassType::StaticClass();
		ForEachSubsystemOfClass(InterfaceClass, [Function=MoveTemp(InFunction)](USubsystem* Subsystem)
		{
			Function(CastChecked<InterfaceToCastTo>(Subsystem));
		});
	}
};
