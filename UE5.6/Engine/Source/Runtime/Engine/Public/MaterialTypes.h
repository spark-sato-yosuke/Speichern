...
inline constexpr int32 NumMaterialParameterTypes = (int32)EMaterialParameterType::Num;
inline constexpr int32 NumMaterialRuntimeParameterTypes = (int32)EMaterialParameterType::NumRuntime;
inline constexpr int32 NumMaterialEditorOnlyParameterTypes = NumMaterialParameterTypes - NumMaterialRuntimeParameterTypes;

inline bool IsNumericMaterialParameter(EMaterialParameterType InType)
{
	switch (InType)
	{
...
inline bool IsStaticMaterialParameter(EMaterialParameterType InType)
{
	switch (InType)
	{
...
inline const UEnum* GetStaticMaterialParameterTypeEnum()
{
	const UEnum* Enum = StaticEnum<EMaterialParameterType>();
	check(Enum);
	return Enum;
}

inline FString MaterialParameterTypeToString(EMaterialParameterType Type)
{
	const UEnum* Enum = GetStaticMaterialParameterTypeEnum();
	return Enum->GetNameStringByValue(int64(Type));
}

inline EMaterialParameterType GetMaterialParameterTypeFromString(FString TypeName)
{
	const UEnum* Enum = GetStaticMaterialParameterTypeEnum();
	return static_cast<EMaterialParameterType>(Enum->GetValueByName(FName(TypeName)));
}
