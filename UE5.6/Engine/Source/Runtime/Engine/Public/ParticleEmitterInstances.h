...
public:
	...
	//
	ENGINE_API virtual void InitParameters(UParticleEmitter* InTemplate);
...
{
	/** Constructor	*/
	FParticleSpriteEmitterInstance(IParticleEmitterInstanceOwner& InComponent);
...
struct FParticleMeshEmitterInstance : public FParticleEmitterInstance
{
	...
	ENGINE_API virtual void InitParameters(UParticleEmitter* InTemplate) override;
...
struct FParticleAnimTrailEmitterInstance : public FParticleTrailsEmitterInstance_Base
{
	...
	*/
	...
	/** Constructor	*/
	FParticleAnimTrailEmitterInstance(IParticleEmitterInstanceOwner& InComponent);
