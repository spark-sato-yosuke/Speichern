...
{	
	...
	bool IsFirstPersonRelevant() const { return bIsFirstPerson || bIsFirstPersonWorldSpaceRepresentation; }

	UE_DEPRECATED(5.6, "Use FPrimitiveSceneProxyDesc::IsFirstPersonRelevant() instead.")
	bool IsStaticMeshFirstPersonRelevant() const { return IsFirstPersonRelevant(); }
	...
	FPrimitiveComponentId GetPrimitiveSceneId() const { return ComponentId; }
};
