...
struct FCompositeNavModifier : public FNavigationModifier
{
	...
	void Add(const FCompositeNavModifier& Modifiers)
	{
		...
		bRasterizeAsFilledConvexVolume |= Modifiers.GetRasterizeAsFilledConvexVolume();
	...
	FORCEINLINE bool GetRasterizeAsFilledConvexVolume() const { return bRasterizeAsFilledConvexVolume; }
	FORCEINLINE void SetRasterizeAsFilledConvexVolume(bool bValue) { bRasterizeAsFilledConvexVolume = bValue; }
...
private:
	...
	uint32 bRasterizeAsFilledConvexVolume : 1;
