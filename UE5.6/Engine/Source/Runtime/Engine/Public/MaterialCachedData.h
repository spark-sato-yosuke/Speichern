...
struct FMaterialCachedExpressionData
{
	...
	bool AddParameter(const FMaterialParameterInfo& ParameterInfo, const FMaterialParameterMetadata& ParameterMeta, UObject*& OutReferencedTexture, UTextureCollection*& OutReferencedTextureCollection, FText& OutErrorMessage);

	bool AddParameter(const FMaterialParameterInfo& ParameterInfo, const FMaterialParameterMetadata& ParameterMeta, UObject*& OutReferencedTexture, FText& OutErrorMessage)
	{
		UTextureCollection* UnusedReferencedTextureCollection = nullptr;
		return AddParameter(ParameterInfo, ParameterMeta, OutReferencedTexture, UnusedReferencedTextureCollection, OutErrorMessage);
	}
#endif // WITH_EDITOR
	...
	TArray<TPair<TObjectPtr<class UMaterialExpression>, FString>> DuplicateParameterErrors;
#endif
};
