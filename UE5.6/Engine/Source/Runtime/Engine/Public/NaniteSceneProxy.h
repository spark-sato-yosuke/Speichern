...
public:
	...
	virtual void GetNaniteResourceInfo(uint32& OutResourceID, uint32& OutHierarchyOffset, uint32& OutAssemblyTransformOffset, uint32& OutImposterIndex) const override
	{
		OutResourceID = Resources->RuntimeResourceID;
		OutHierarchyOffset = Resources->HierarchyOffset;
		OutAssemblyTransformOffset = Resources->AssemblyTransformOffset;
...
public:
	...
	virtual float GetAnimationMinScreenSize() const  { return -1.0f; }
	...
	virtual void SetupFallbackRayTracingMaterials(int32 LODIndex, bool bUseStaticRayTracingGeometry, bool bWillCacheInstance, TArray<FMeshBatch>& OutMaterials) const;
