...
SHOWFLAG_FIXED_IN_SHIPPING(0, VisualizeSkyLightIlluminance, SFG_Visualize, NSLOCTEXT("UnrealEd", "VisualizeSkyLightIlluminance", "Sky Light Illuminance"))
/** Display the illuminance debug view for the skylight */
SHOWFLAG_FIXED_IN_SHIPPING(0, VisualizeLocalFogVolumes, SFG_Visualize, NSLOCTEXT("UnrealEd", "VisualizeLocalFogVolumes", "Local Fog Volumes"))
...
SHOWFLAG_FIXED_IN_SHIPPING(1, MaterialNormal, SFG_Hidden, NSLOCTEXT("UnrealEd", "MaterialNormalSF", "Material Normal"))
/** Whether to use material ambient occlusion. */
SHOWFLAG_FIXED_IN_SHIPPING(1, MaterialAmbientOcclusion, SFG_Hidden, NSLOCTEXT("UnrealEd", "MaterialAmbientOcclusionSF", "Material Ambient Occlusion"))
...
SHOWFLAG_ALWAYS_ACCESSIBLE(CompositeDebugPrimitives, SFG_Developer, NSLOCTEXT("UnrealEd", "CompositeDebugPrimitivesSF", "Composite Debug Primitives"))
...
SHOWFLAG_ALWAYS_ACCESSIBLE(UnlitRichView, SFG_Hidden, NSLOCTEXT("UnrealEd", "UnlitRichViewSF", "UnlitRichView"))
...
SHOWFLAG_ALWAYS_ACCESSIBLE(UnlitViewmode, SFG_Hidden, NSLOCTEXT("UnrealEd", "UnlitViewmodeSF", "UnlitViewmode"))
...
SHOWFLAG_ALWAYS_ACCESSIBLE(Cloud, SFG_Normal, NSLOCTEXT("UnrealEd", "CloudSF", "Cloud"))
...
SHOWFLAG_FIXED_IN_SHIPPING(0, VisualizeVirtualTexture, SFG_Hidden, NSLOCTEXT("UnrealEd", "VisualizeVirtualTextureSF", "Virtual Texture Visualization"))
...
SHOWFLAG_ALWAYS_ACCESSIBLE(AllowPrimitiveAlphaHoldout, SFG_Advanced, NSLOCTEXT("UnrealEd", "AllowPrimitiveAlphaHoldoutSF", "Allow Primitive Alpha Holdout"))

/** Invert the alpha channel at tne end of post processing. */
SHOWFLAG_ALWAYS_ACCESSIBLE(AlphaInvert, SFG_PostProcess, NSLOCTEXT("UnrealEd", "AlphaInvertSF", "Invert Alpha Channel"))
