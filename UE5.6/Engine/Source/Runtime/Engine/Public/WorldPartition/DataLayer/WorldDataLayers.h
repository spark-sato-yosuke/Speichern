...
public:
	...
	bool IsUsingExternalPackageDataLayerInstances() const { return bUseExternalPackageDataLayerInstances; }
	...
	void ForEachDataLayer(TFunctionRef<bool(UDataLayerInstance*)> Func) { return ForEachDataLayerInstance(Func); }

	UE_DEPRECATED(5.4, "Use ForEachDataLayerInstance() instead.")
	void ForEachDataLayer(TFunctionRef<bool(UDataLayerInstance*)> Func) const { return ForEachDataLayerInstance(Func); }
	...
	int32 GetDataLayersStateEpoch() const { return DataLayersStateEpoch; }
