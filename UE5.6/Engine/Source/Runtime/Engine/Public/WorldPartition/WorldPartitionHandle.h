...
struct FWorldPartitionImplBase
{
	...
	static TUniquePtr<FWorldPartitionActorDesc>* GetActorDesc(UActorDescContainer* Container, const FGuid& ActorGuid) { return nullptr;}
	UE_DEPRECATED(5.4, "Use FWorldPartitionActorDescInstance")
	static UActorDescContainer* GetActorDescContainer(TUniquePtr<FWorldPartitionActorDesc>* ActorDesc) { return nullptr; }
	UE_DEPRECATED(5.4, "Use FWorldPartitionActorDescInstance")
	static bool IsActorDescLoaded(FWorldPartitionActorDesc* ActorDesc) { return false; }
	UE_DEPRECATED(5.4, "Use FWorldPartitionActorDescInstance")
	static AActor* GetActorDescActor(FWorldPartitionActorDesc* ActorDesc) { return nullptr; }
