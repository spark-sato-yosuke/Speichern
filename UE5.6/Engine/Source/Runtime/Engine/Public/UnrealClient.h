...
extern ENGINE_API bool GetViewportScreenShot(FViewport* Viewport, TArray<FColor>& Bitmap, const FIntRect& ViewRect = FIntRect(), const FReadSurfaceDataFlags& ReadSurfaceFlags = FReadSurfaceDataFlags());
extern ENGINE_API bool GetViewportScreenShotHDR(FViewport* Viewport, TArray<FLinearColor>& Bitmap, const FIntRect& ViewRect = FIntRect(), const FReadSurfaceDataFlags& ReadSurfaceFlags = FReadSurfaceDataFlags(RCM_MinMax));
