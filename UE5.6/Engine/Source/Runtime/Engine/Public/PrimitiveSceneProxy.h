...
public:
	...
	*/
	...
	virtual RayTracing::FGeometryGroupHandle GetRayTracingGeometryGroupHandle() const { return INDEX_NONE; }
#endif // RHI_RAYTRACING

	virtual void GetStreamableRenderAssetInfo(const FBoxSphereBounds& PrimitiveBounds, TArray<struct FStreamingRenderAssetPrimitiveInfo>& StreamableRenderAssets) const { check(IsSupportingStreamableRenderAssetsGathering()); }
	bool IsSupportingStreamableRenderAssetsGathering() const { return bImplementsStreamableAssetGathering; }
	bool IsForceMipStreaming() const { return bForceMipStreaming; }
	...
	*/
	...
	virtual TConstArrayView<FPrimitiveComponentId> GetSourceLandscapeComponentIds() const { return {}; }
	...
	*/
	...
	{
		bCanSkipRedundantTransformUpdates = bCanSkip;
	}
	...
	*/
	...
	inline const TArray<int32>& GetRuntimeVirtualTextureIds() const { return RuntimeVirtualTextures; }
	...
	inline bool SupportsMaterialCache() const { return bSupportsMaterialCache; }
	...
	inline bool SupportsParallelGDRTI() const { return bSupportsParallelGDRTI; }
	inline bool IsCollisionEnabled() const { return bCollisionEnabled; }
	inline bool IsHovered() const { return bHovered; }
	inline bool IsOwnedBy(const FSceneViewOwner& Owner) const { return Owner.IsPartOf(Owners); }
	...
	inline bool WritesVirtualTexture() const{ return bSupportsRuntimeVirtualTexture && RuntimeVirtualTextures.Num() > 0; }
	UE_DEPRECATED(5.6, "Use GetRuntimeVirtualTextureIds() instead.")
	inline bool WritesVirtualTexture(URuntimeVirtualTexture* VirtualTexture) const { return false; }
	...
	inline bool IsFirstPersonWorldSpaceRepresentation() const { return bIsFirstPersonWorldSpaceRepresentation; }
	...
	inline bool IsLandscapeNaniteProxy() const { return bIsLandscapeNaniteProxy; }
	inline bool IsCompatibleWithLumenCardSharing() const { return bCompatibleWithLumenCardSharing; }
	...
	*/
	...
	virtual void GetNaniteResourceInfo(uint32& ResourceID, uint32& HierarchyOffset, uint32& AssemblyTransformOffset, uint32& ImposterIndex) const
	{
	...
	*/
	...
	FORCEINLINE bool IsDrawnInGame() const { return DrawInGame; }

	/**
	 * Set the drawn in game flag, from the render thread.
	 * @param bInDrawInGame		The new value.
 	 */
	...
	virtual FUintVector2 GetMaterialCacheTextureDescriptor() const { return FUintVector2(0, 0); }
...
protected:
	...
	bool IsRuntimeVirtualTextureOnly() const { return bVirtualTextureMainPassDrawNever; }
	...
	{
		if (bForceHidden != bForceHiddenIn)
		{
			bForceHidden = bForceHiddenIn;
...
protected:
	...
	/** This is only set to true by constructors of proxy types witch support gathering of UStreamableAssets */
...
private:
	...
	/** if true, forces mips for streamable assets used by this proxy to be resident when this proxy is created. **/
...
private:
	/** The hierarchy of owners of this primitive. This array contains the unique id of actors.  */
...
protected:
	 ...
	 */
	UE_DEPRECATED(5.6, "StaticMeshBounds is no longer a parameter of this interface, please update the implementation.")
	ENGINE_API virtual void UpdateInstances_RenderThread(FRHICommandListBase& RHICmdList, const FBoxSphereBounds& InBounds, const FBoxSphereBounds& InLocalBounds, const FBoxSphereBounds& InStaticMeshBounds) final;
	ENGINE_API virtual void UpdateInstances_RenderThread(FRHICommandListBase& RHICmdList, const FBoxSphereBounds& InBounds, const FBoxSphereBounds& InLocalBounds);
...
// Whether scene proxies will have GetDynamicRayTracingInstances called in parallel.
