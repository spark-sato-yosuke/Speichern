...
class UMaterialInstanceConstant : public UMaterialInstance
{
	...
	class UTextureCollection* K2_GetTextureCollectionParameterValue(FName ParameterName);
	...
	*/
	...
	ENGINE_API void SetTextureCollectionParameterValueEditorOnly(const FMaterialParameterInfo& ParameterInfo, class UTextureCollection* Value);
