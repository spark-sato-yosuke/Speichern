...
#endif
	virtual bool IsAllowedIn(const UObject* MaterialOrFunction) const
	{
		// UMaterialExpressionParameter is not allowed, but subclasses of UMaterialExpressionParameter are allowed.
		return GetClass() != UMaterialExpressionParameter::StaticClass();
	}
