...
class UMaterialExpressionMaterialFunctionCall : public UMaterialExpression
{
	...
	ENGINE_API void PushParameterOwner(FMaterialCompiler* Compiler);
	ENGINE_API void PopParameterOwner(FMaterialCompiler* Compiler);
#endif
	...
	ENGINE_API virtual bool IsInputConnectionRequired(int32 InputIndex) const override;
	...
	ENGINE_API virtual void GetExpressionToolTip(TArray<FString>& OutToolTip) override;
	...
	ENGINE_API virtual void GatherSubstrateMaterialInfo(FSubstrateMaterialInfo& SubstrateMaterialInfo, int32 OutputIndex) override;
	ENGINE_API virtual FSubstrateOperator* SubstrateGenerateMaterialTopologyTree(class FMaterialCompiler* Compiler, class UMaterialExpression* Parent, int32 OutputIndex) override;
	...
	ENGINE_API virtual bool SetMaterialFunction(UMaterialFunctionInterface* NewMaterialFunction);
