...
class UMaterialFunction : public UMaterialFunctionInterface
{
...
#if WITH_EDITORONLY_DATA	
	UE_DEPRECATED(5.6, "bPrefixParameterNames has been deprecated.")
	UPROPERTY()
	...
	/** The domain to use when previewing a material function. */
	UPROPERTY(EditAnywhere, Category = Preview, AssetRegistrySearchable)
	TEnumAsByte<enum EMaterialDomain> PreviewMaterialDomain;
