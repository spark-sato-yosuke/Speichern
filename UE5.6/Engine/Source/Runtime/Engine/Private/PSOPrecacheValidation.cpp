...
void PSOCollectorStats::CheckComputePipelineStateInCache(
	...
	int32 PSOCollectorIndex)
{
	bool bStatsUpdated = PSOCollectorStats::GetFullPSOPrecacheStatsCollector().CheckStateInCache(EPSOPrecacheType::MeshPass, ComputeShader, PSOCollectorStats::GetPSOPrecacheHash, PSOCollectorIndex, nullptr, PSOPrecacheResult);
