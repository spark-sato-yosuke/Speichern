...
FPostProcessSettings::FPostProcessSettings()
{
	...
	LocalExposureHighlightThresholdStrength = 1.0f;
	LocalExposureShadowThresholdStrength = 1.0f;
	...
	LumenSkylightLeakingTint = FLinearColor(1.0f, 1.0f, 1.0f, 1.0f);
	...
	DepthOfFieldPetzvalBokeh = 0;
	DepthOfFieldPetzvalBokehFalloff = 1.0f;
	DepthOfFieldPetzvalExclusionBoxExtents = FVector2f::ZeroVector;
	DepthOfFieldPetzvalExclusionBoxRadius = 0.0f;
	DepthOfFieldAspectRatioScalar = 1.0f;
	DepthOfFieldBarrelRadius = 5;
	DepthOfFieldBarrelLength = 0;
	for (int Index = 0; Index < UE_ARRAY_COUNT(DepthOfFieldMatteBoxFlags); ++Index)
	{
		DepthOfFieldMatteBoxFlags[Index] = {};
	}
	...
	RayTracingTranslucencyMaxPrimaryHitEvents = 4;
	RayTracingTranslucencyMaxSecondaryHitEvents = 2;
	RayTracingTranslucencyUseRayTracedRefraction = 0;
