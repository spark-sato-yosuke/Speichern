...
void UMaterialInstanceDynamic::SetTextureCollectionParameterValueByInfo(const FMaterialParameterInfo& ParameterInfo, UTextureCollection* Value)
{
	SetTextureCollectionParameterValueInternal(ParameterInfo, Value);
}

void UMaterialInstanceDynamic::SetTextureCollectionParameterValue(FName ParameterName, UTextureCollection* Value)
{
	FMaterialParameterInfo ParameterInfo(ParameterName);
	SetTextureCollectionParameterValueByInfo(ParameterInfo, Value);
}

UTextureCollection* UMaterialInstanceDynamic::K2_GetTextureCollectionParameterValueByInfo(const FMaterialParameterInfo& ParameterInfo)
{
	UTextureCollection* Result = NULL;
	Super::GetTextureCollectionParameterValue(ParameterInfo, Result);
	return Result;
}

UTextureCollection* UMaterialInstanceDynamic::K2_GetTextureCollectionParameterValue(FName ParameterName)
{
	FMaterialParameterInfo ParameterInfo(ParameterName);
	return K2_GetTextureCollectionParameterValueByInfo(ParameterInfo);
}
