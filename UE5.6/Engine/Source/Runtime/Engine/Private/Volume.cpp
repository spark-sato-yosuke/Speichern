...
FName AVolume::GetCustomIconName() const
{
	// Our parent class ABrush provides a default for all brushes (which includes volumes), but we don't want to use those since all volume types
	// have custom icons
	return NAME_None;
}
