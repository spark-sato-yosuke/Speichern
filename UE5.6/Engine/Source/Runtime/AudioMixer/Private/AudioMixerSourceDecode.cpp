...
int32 bDecodersCanReturnPartialBuffersCvar = 1;
FAutoConsoleVariableRef CVarDecodersCanReturnPartialBuffers(
	TEXT("au.DecodersCanReturnPartialBuffers"),
	bDecodersCanReturnPartialBuffersCvar,
	TEXT(""),
	ECVF_Default
	);
	...
	void DoWork()
	{
		...
		switch (TaskType)
		{
			...
			case EAudioTaskType::Decode:
			{
				...
				if (bDecodersCanReturnPartialBuffersCvar)
				{
