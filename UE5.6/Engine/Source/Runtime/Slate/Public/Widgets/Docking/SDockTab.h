...
public:
	...
	SLATE_BEGIN_ARGS(SDockTab)
		...
		, _IconColor()
		, _LabelOverflowPolicy(ETextOverflowPolicy::Ellipsis)
		{}
		...
		SLATE_ARGUMENT( ETextOverflowPolicy, LabelOverflowPolicy )
	SLATE_END_ARGS()
	...
	SLATE_API void SetTabLabelOverflowPolicy(ETextOverflowPolicy InOverflowPolicy) const;
