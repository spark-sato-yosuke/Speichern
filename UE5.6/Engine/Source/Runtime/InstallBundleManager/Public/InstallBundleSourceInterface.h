...
public:
	...
	// Returns the bundle names of any content that is currently removal the next time the source is initialized
	virtual TArray<FName> GetRequestedRemoveContentOnNextInit() const { return {}; }
	...
	// Override to return information about a bundle installer
	virtual TArray<FBuildInstallerStat>& GetBundleUpdateStats(FName BundleName) { return EmptyStats; }
...
private:
	TArray<FBuildInstallerStat> EmptyStats;
};
