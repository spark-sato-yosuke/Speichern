...
class UBlueprintGameplayTagLibrary : public UBlueprintFunctionLibrary
{
	 ...
	 */
	UFUNCTION(BlueprintPure, Category="GameplayTags", meta = (BlueprintThreadSafe))
	static GAMEPLAYTAGS_API FGameplayTagContainer Filter(const FGameplayTagContainer& TagContainer, const FGameplayTagContainer& OtherContainer, bool bExactMatch);
	...
	* @param	InTags	value to set the FGameplayTagQuery expression
	 ...
	 */
	UFUNCTION(BlueprintPure, Category = "GameplayTags", meta = (BlueprintThreadSafe, BlueprintAutocast))
