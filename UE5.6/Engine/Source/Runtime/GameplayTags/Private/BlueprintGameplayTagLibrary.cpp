...
FGameplayTagContainer UBlueprintGameplayTagLibrary::Filter(const FGameplayTagContainer& TagContainer, const FGameplayTagContainer& OtherContainer, bool bExactMatch)
{
	if (bExactMatch)
	{
		return TagContainer.FilterExact(OtherContainer);
	}
