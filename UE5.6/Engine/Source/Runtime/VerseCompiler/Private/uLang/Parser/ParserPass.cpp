...
namespace uLang
{
    ...
    struct generate_vst : public Verse::Grammar::generate<generate_common>
    {
        ...
        result_t String(const snippet& Snippet, const syntaxes_t& Splices) const
        {
            ...
            const TSRef<InterpolatedString> InterpolatedStringNode = TSRef<InterpolatedString>::New(UnquotedLocus);
        ...
        {
            TSRef<Interpolant> InterpolantNode = TSRef<Interpolant>::New(AsLocus(Snippet));
