...
public:
	...
	/**
	 * Get active ToolBuilder string identifier for a ToolSide
	 * @param Side which "side" should we get this Builder from 
	 */
	INTERACTIVETOOLSFRAMEWORK_API virtual const FString& GetActiveToolType(EToolSide Side) const;
	 ...
	 * another tool.
	 */
	virtual EToolManagerToolSwitchMode GetToolSwitchMode() const { return ToolSwitchMode; }
	 ...
	 */
	virtual void SetToolSwitchMode(EToolManagerToolSwitchMode ToolSwitchModeIn) { ToolSwitchMode = ToolSwitchModeIn; }
