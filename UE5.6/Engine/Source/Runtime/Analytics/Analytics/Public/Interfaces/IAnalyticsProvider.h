...
protected:
	/**
	 * Checks for duplicate key names in the attribute array. Only implemented for debug and development builds.
	 */
	void ANALYTICS_API CheckForDuplicateAttributes(const FString& EventName, const TArray<FAnalyticsEventAttribute>& Attributes);
