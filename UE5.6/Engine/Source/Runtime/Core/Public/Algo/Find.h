...
namespace Algo
{
	...
	[[nodiscard]] FORCEINLINE auto Find(RangeType&& Range, const ValueType& Value)
	 ...
	 */
	template <typename RangeType, typename ValueType, typename ProjectionType>
	[[nodiscard]] FORCEINLINE auto FindBy(RangeType&& Range, const ValueType& Value, ProjectionType Proj)
	 ...
	 */
	template <typename RangeType, typename PredicateType>
	[[nodiscard]] FORCEINLINE auto FindByPredicate(RangeType&& Range, PredicateType Pred)
