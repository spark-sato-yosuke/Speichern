...
namespace Algo
{
	...
	[[nodiscard]] FORCEINLINE bool IsHeap(const RangeType& Range)
	{
	...
	[[nodiscard]] FORCEINLINE bool IsHeap(const RangeType& Range, PredicateType Predicate)
	{
	...
	[[nodiscard]] FORCEINLINE bool IsHeapBy(const RangeType& Range, ProjectionType Projection)
	{
	...
	[[nodiscard]] FORCEINLINE bool IsHeapBy(const RangeType& Range, ProjectionType Projection, PredicateType Predicate)
	{
