...
namespace Algo
{
	...
	[[nodiscard]] FORCEINLINE auto MaxElement(RangeType&& Range)
	...
	[[nodiscard]] FORCEINLINE auto MaxElement(RangeType&& Range, ComparatorType Comp)
	...
	[[nodiscard]] FORCEINLINE auto MaxElementBy(RangeType&& Range, ProjectionType Proj)
	...
	[[nodiscard]] FORCEINLINE auto MaxElementBy(RangeType&& Range, ProjectionType Proj, ComparatorType Comp)
