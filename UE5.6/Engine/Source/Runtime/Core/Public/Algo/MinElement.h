...
namespace Algo
{
	...
	[[nodiscard]] FORCEINLINE auto MinElement(RangeType&& Range)
	...
	[[nodiscard]] FORCEINLINE auto MinElement(RangeType&& Range, ComparatorType Comp)
	...
	[[nodiscard]] FORCEINLINE auto MinElementBy(RangeType&& Range, ProjectionType Proj)
	...
	[[nodiscard]] FORCEINLINE auto MinElementBy(RangeType&& Range, ProjectionType Proj, ComparatorType Comp)
