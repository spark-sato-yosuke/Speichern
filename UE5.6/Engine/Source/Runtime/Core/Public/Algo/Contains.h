...
namespace Algo
{
	...
	[[nodiscard]] FORCEINLINE bool Contains(RangeType&& Range, const ValueType& Value)
	{
	...
	[[nodiscard]] FORCEINLINE bool ContainsBy(RangeType&& Range, const ValueType& Value, ProjectionType Proj)
	{
