...
struct FNumberFormattingOptions
{
	...
	FNumberFormattingOptions& SetIndicateNearlyInteger( bool InValue ) { IndicateNearlyInteger = InValue; return *this; }
...
public:
	 ...
	 */
	[[nodiscard]] static CORE_API FText AsNumber(float Val,	const FNumberFormattingOptions* const Options = NULL, const FCulturePtr& TargetCulture = NULL);
	[[nodiscard]] static CORE_API FText AsNumber(double Val,	const FNumberFormattingOptions* const Options = NULL, const FCulturePtr& TargetCulture = NULL);
	[[nodiscard]] static CORE_API FText AsNumber(int8 Val,		const FNumberFormattingOptions* const Options = NULL, const FCulturePtr& TargetCulture = NULL);
	[[nodiscard]] static CORE_API FText AsNumber(int16 Val,	const FNumberFormattingOptions* const Options = NULL, const FCulturePtr& TargetCulture = NULL);
	[[nodiscard]] static CORE_API FText AsNumber(int32 Val,	const FNumberFormattingOptions* const Options = NULL, const FCulturePtr& TargetCulture = NULL);
	[[nodiscard]] static CORE_API FText AsNumber(int64 Val,	const FNumberFormattingOptions* const Options = NULL, const FCulturePtr& TargetCulture = NULL);
	[[nodiscard]] static CORE_API FText AsNumber(uint8 Val,	const FNumberFormattingOptions* const Options = NULL, const FCulturePtr& TargetCulture = NULL);
	[[nodiscard]] static CORE_API FText AsNumber(uint16 Val,	const FNumberFormattingOptions* const Options = NULL, const FCulturePtr& TargetCulture = NULL);
	[[nodiscard]] static CORE_API FText AsNumber(uint32 Val,	const FNumberFormattingOptions* const Options = NULL, const FCulturePtr& TargetCulture = NULL);
	[[nodiscard]] static CORE_API FText AsNumber(uint64 Val,	const FNumberFormattingOptions* const Options = NULL, const FCulturePtr& TargetCulture = NULL);
	[[nodiscard]] static CORE_API FText AsNumber(long Val,		const FNumberFormattingOptions* const Options = NULL, const FCulturePtr& TargetCulture = NULL);


	[[nodiscard]] static CORE_API FText AsCurrency(float Val,  const FString& CurrencyCode = FString(), const FNumberFormattingOptions* const Options = NULL, const FCulturePtr& TargetCulture = NULL);
	[[nodiscard]] static CORE_API FText AsCurrency(double Val, const FString& CurrencyCode = FString(), const FNumberFormattingOptions* const Options = NULL, const FCulturePtr& TargetCulture = NULL);
	[[nodiscard]] static CORE_API FText AsCurrency(int8 Val,   const FString& CurrencyCode = FString(), const FNumberFormattingOptions* const Options = NULL, const FCulturePtr& TargetCulture = NULL);
	[[nodiscard]] static CORE_API FText AsCurrency(int16 Val,  const FString& CurrencyCode = FString(), const FNumberFormattingOptions* const Options = NULL, const FCulturePtr& TargetCulture = NULL);
	[[nodiscard]] static CORE_API FText AsCurrency(int32 Val,  const FString& CurrencyCode = FString(), const FNumberFormattingOptions* const Options = NULL, const FCulturePtr& TargetCulture = NULL);
	[[nodiscard]] static CORE_API FText AsCurrency(int64 Val,  const FString& CurrencyCode = FString(), const FNumberFormattingOptions* const Options = NULL, const FCulturePtr& TargetCulture = NULL);
	[[nodiscard]] static CORE_API FText AsCurrency(uint8 Val,  const FString& CurrencyCode = FString(), const FNumberFormattingOptions* const Options = NULL, const FCulturePtr& TargetCulture = NULL);
	[[nodiscard]] static CORE_API FText AsCurrency(uint16 Val, const FString& CurrencyCode = FString(), const FNumberFormattingOptions* const Options = NULL, const FCulturePtr& TargetCulture = NULL);
	[[nodiscard]] static CORE_API FText AsCurrency(uint32 Val, const FString& CurrencyCode = FString(), const FNumberFormattingOptions* const Options = NULL, const FCulturePtr& TargetCulture = NULL);
	[[nodiscard]] static CORE_API FText AsCurrency(uint64 Val, const FString& CurrencyCode = FString(), const FNumberFormattingOptions* const Options = NULL, const FCulturePtr& TargetCulture = NULL);
	[[nodiscard]] static CORE_API FText AsCurrency(long Val,   const FString& CurrencyCode = FString(), const FNumberFormattingOptions* const Options = NULL, const FCulturePtr& TargetCulture = NULL);
	 ...
	 */
	[[nodiscard]] static CORE_API FText AsCurrencyBase(int64 BaseVal, const FString& CurrencyCode, const FCulturePtr& TargetCulture = NULL, int32 ForceDecimalPlaces = -1);

	/**
	 * Generate an FText that represents the passed number as a percentage in the current culture
	 */
	[[nodiscard]] static CORE_API FText AsPercent(float Val,	const FNumberFormattingOptions* const Options = NULL, const FCulturePtr& TargetCulture = NULL);
	[[nodiscard]] static CORE_API FText AsPercent(double Val,	const FNumberFormattingOptions* const Options = NULL, const FCulturePtr& TargetCulture = NULL);
	 ...
	 * 
	 * This function will convert the given timestamp from UTC (eg, FDateTime::UtcNow()) to the given timezone (taking into account DST).
	 * If using a local timestamp (eg, FDateTime::Now()) then you MUST use FText::GetInvariantTimeZone() as the TimeZone argument to avoid additional timezone conversion.
	 * 
	 * @note The overload using a custom pattern uses strftime-like syntax (see FDateTime::ToFormattedString).
	 */
	[[nodiscard]] static CORE_API FText AsDate(const FDateTime& DateTime, const EDateTimeStyle::Type DateStyle = EDateTimeStyle::Default, const FString& TimeZone = FString(), const FCulturePtr& TargetCulture = NULL);
	[[nodiscard]] static CORE_API FText AsDateTime(const FDateTime& DateTime, const EDateTimeStyle::Type DateStyle = EDateTimeStyle::Default, const EDateTimeStyle::Type TimeStyle = EDateTimeStyle::Default, const FString& TimeZone = FString(), const FCulturePtr& TargetCulture = NULL);
	[[nodiscard]] static CORE_API FText AsDateTime(const FDateTime& DateTime, const FString& CustomPattern, const FString& TimeZone = FString(), const FCulturePtr& TargetCulture = NULL);
	[[nodiscard]] static CORE_API FText AsTime(const FDateTime& DateTime, const EDateTimeStyle::Type TimeStyle = EDateTimeStyle::Default, const FString& TimeZone = FString(), const FCulturePtr& TargetCulture = NULL);
	 ...
	 */
	[[nodiscard]] static CORE_API FText AsTimespan(const FTimespan& Timespan, const FCulturePtr& TargetCulture = NULL);

	/**
	 * Gets the time zone string that represents a non-specific, zero offset, culture invariant time zone.
	 */
	[[nodiscard]] static CORE_API FString GetInvariantTimeZone();

	/**
	 * Generate an FText that represents the passed number as a memory size in the current culture
	 */
	[[nodiscard]] static CORE_API FText AsMemory(uint64 NumBytes, const FNumberFormattingOptions* const Options = NULL, const FCulturePtr& TargetCulture = NULL, EMemoryUnitStandard UnitStandard = EMemoryUnitStandard::IEC);

	/**
	 * Generate an FText that represents the passed number as a memory size in the current culture
	 */
	[[nodiscard]] static CORE_API FText AsMemory(uint64 NumBytes, EMemoryUnitStandard UnitStandard);
	 ...
	 */
	[[nodiscard]] static CORE_API FText FromName( const FName& Val);
	
	/**
	 * Generate an FText representing the passed in string
	 */
	[[nodiscard]] static CORE_API FText FromString( const ANSICHAR* String );
	[[nodiscard]] static CORE_API FText FromString( const UTF8CHAR* String );
	[[nodiscard]] static CORE_API FText FromString( const WIDECHAR* String );
	[[nodiscard]] static CORE_API FText FromString( const FAnsiString& String );
	[[nodiscard]] static CORE_API FText FromString( const FString& String );
	[[nodiscard]] static CORE_API FText FromString( FString&& String );
	[[nodiscard]] static CORE_API FText FromString( const FUtf8String& String );

	/**
	 * Generate a FText representing the passed string view
	 */
	[[nodiscard]] static CORE_API FText FromStringView(FAnsiStringView InString);
	[[nodiscard]] static CORE_API FText FromStringView(FUtf8StringView InString);
	[[nodiscard]] static CORE_API FText FromStringView(FWideStringView InString);

	/**
	 * Generate a culture invariant FText representing the passed in string
	 */
	[[nodiscard]] static CORE_API FText AsCultureInvariant( const ANSICHAR* String );
	[[nodiscard]] static CORE_API FText AsCultureInvariant( const UTF8CHAR* String );
	[[nodiscard]] static CORE_API FText AsCultureInvariant( const WIDECHAR* String );
	[[nodiscard]] static CORE_API FText AsCultureInvariant( FAnsiStringView String );
	[[nodiscard]] static CORE_API FText AsCultureInvariant( FUtf8StringView String );
	[[nodiscard]] static CORE_API FText AsCultureInvariant( FWideStringView String );
	[[nodiscard]] static CORE_API FText AsCultureInvariant( FString&& String );

	/**
	 * Generate a culture invariant FText representing the passed in FText
	 */
	[[nodiscard]] static CORE_API FText AsCultureInvariant( FText Text );
	 ...
	 */
	[[nodiscard]] static CORE_API FText AsLocalizable_Advanced(const FTextKey& Namespace, const FTextKey& Key, const TCHAR* String);
	[[nodiscard]] static CORE_API FText AsLocalizable_Advanced(const FTextKey& Namespace, const FTextKey& Key, FStringView String);
	[[nodiscard]] static CORE_API FText AsLocalizable_Advanced(const FTextKey& Namespace, const FTextKey& Key, FString&& String);
	...
	[[nodiscard]] CORE_API const FString& ToString() const;

	/** Deep build of the source string for this FText, climbing the history hierarchy */
	[[nodiscard]] CORE_API FString BuildSourceString() const;

	[[nodiscard]] CORE_API bool IsNumeric() const;

	[[nodiscard]] CORE_API int32 CompareTo( const FText& Other, const ETextComparisonLevel::Type ComparisonLevel = ETextComparisonLevel::Default ) const;
	[[nodiscard]] CORE_API int32 CompareToCaseIgnored( const FText& Other ) const;

	[[nodiscard]] CORE_API bool EqualTo( const FText& Other, const ETextComparisonLevel::Type ComparisonLevel = ETextComparisonLevel::Default ) const;
	[[nodiscard]] CORE_API bool EqualToCaseIgnored( const FText& Other ) const;
	 ...
	 */
	[[nodiscard]] CORE_API bool IdenticalTo( const FText& Other, const ETextIdenticalModeFlags CompareModeFlags = ETextIdenticalModeFlags::None ) const;
	...
	[[nodiscard]] CORE_API bool IsEmpty() const;

	[[nodiscard]] CORE_API bool IsEmptyOrWhitespace() const;
	 ...
	 */
	[[nodiscard]] static CORE_API FText Format(FTextFormat Fmt, const FFormatNamedArguments& InArguments);
	[[nodiscard]] static CORE_API FText Format(FTextFormat Fmt, FFormatNamedArguments&& InArguments);
	 ...
	 * @return The formatted FText
	 */
	[[nodiscard]] static CORE_API FText Format(FTextFormat Fmt, const FFormatOrderedArguments& InArguments);
	[[nodiscard]] static CORE_API FText Format(FTextFormat Fmt, FFormatOrderedArguments&& InArguments);
	...
	[[nodiscard]] static FORCEINLINE FText Format(FTextFormat Fmt, ArgTypes... Args)
	{
	...
	[[nodiscard]] static FText FormatNamed( FTextFormat Fmt, TArguments&&... Args );
	 ...
	 */
	template < typename... TArguments >
	[[nodiscard]] static FText FormatOrdered( FTextFormat Fmt, TArguments&&... Args );
	 ...
	 */
	[[nodiscard]] static CORE_API FText Join(const FText& Delimiter, const FFormatOrderedArguments& Args);
	[[nodiscard]] static CORE_API FText Join(const FText& Delimiter, const TArray<FText>& Args);
	 ...
	 */
	template <typename... ArgTypes>
	[[nodiscard]] static FORCEINLINE FText Join(const FText& Delimiter, ArgTypes... Args)
	{
	 ...
	 */
	[[nodiscard]] static CORE_API FText FromTextGenerator( const TSharedRef<ITextGenerator>& TextGenerator );
	 ...
	 */
	[[nodiscard]] static CORE_API FCreateTextGeneratorDelegate FindRegisteredTextGenerator( FName TypeID );
	...
	[[nodiscard]] CORE_API bool IsTransient() const;
	[[nodiscard]] CORE_API bool IsCultureInvariant() const;
	[[nodiscard]] CORE_API bool IsInitializedFromString() const;
	[[nodiscard]] CORE_API bool IsFromStringTable() const;

	[[nodiscard]] CORE_API bool ShouldGatherForLocalization() const;
	 ...
	 */
	[[nodiscard]] static CORE_API FText ChangeKey( const FTextKey& Namespace, const FTextKey& Key, const FText& Text );
#endif
...
private:
	...
	/** This accessor for TextData guards against the case where TextData might be null and returns the ITextData from EmptyText instead. */
	const ITextData& GetTextData() const;
