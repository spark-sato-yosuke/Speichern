	...
	: public FGenericPlatformMisc
{
	...
	FORCEINLINE static void AsymmetricThreadFenceLight()
	{
		_ReadWriteBarrier();
	}
	...
	static bool CheckFeatureBit_X86(uint32 FeatureBit_X86) { return (GetFeatureBits_X86() & FeatureBit_X86) != 0; }
	static bool CheckAllFeatureBits_X86(uint32 FeatureBits_X86) { return (GetFeatureBits_X86() & FeatureBits_X86) == FeatureBits_X86; }
#endif
	 ...
	 * @return True if the Windows 11 min spec is met.
	 */
	...
	/** @return architecture of the host machine (x64, arm64) **/
