...
public:
	...
	[[nodiscard]] FORCEINLINE FVector2DHalf() { }
	 ...
	 */
 	[[nodiscard]] FORCEINLINE FVector2DHalf( const FFloat16& InX,const FFloat16& InY );
	 ...
	 * Iny float Y value
	 */
	[[nodiscard]] FORCEINLINE FVector2DHalf( float InX,float InY );

	/** Constructor 
	 *
	 * Vector2D float vector
	 */
	[[nodiscard]] FORCEINLINE FVector2DHalf( const FVector2f& Vector2D );
	[[nodiscard]] FORCEINLINE FVector2DHalf( const FVector2d& Vector2D );// LWC_TODO: This should probably be explicit
...
public:
	...
	[[nodiscard]] FORCEINLINE uint32 AsUInt32() const
	{
