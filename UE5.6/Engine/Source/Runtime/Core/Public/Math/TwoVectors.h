...
public:
	...
	/** Default constructor. */
	[[nodiscard]] FORCEINLINE	FTwoVectors();
	 ...
	 */
	[[nodiscard]] FORCEINLINE	FTwoVectors( FVector In1, FVector In2 );
	 ...
	 */
	[[nodiscard]] explicit FORCEINLINE FTwoVectors( EForceInit );
...
public:
	 ...
	 */
	[[nodiscard]] FORCEINLINE FTwoVectors operator+( const FTwoVectors& V ) const;
	 ...
	 */
	[[nodiscard]] FORCEINLINE FTwoVectors operator*( float Scale ) const;
	 ...
	 */
	[[nodiscard]] FORCEINLINE FTwoVectors operator-() const;
