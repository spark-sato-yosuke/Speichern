...
public:
	 ...
	 */
	[[nodiscard]] explicit FORCEINLINE TRotator(T InF);
	 ...
	 */
	[[nodiscard]] FORCEINLINE TRotator( T InPitch, T InYaw, T InRoll );
	 ...
	 */
	[[nodiscard]] explicit FORCEINLINE TRotator( EForceInit );
...
public:
	...
	[[nodiscard]] FORCEINLINE TRotator operator*( FArg Scale ) const
	{
