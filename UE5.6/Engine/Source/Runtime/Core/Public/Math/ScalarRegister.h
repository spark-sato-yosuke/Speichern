...
public:
	...
	/** default constructor */
	[[nodiscard]] FORCEINLINE ScalarRegister();

	/** Copy Constructor */
	[[nodiscard]] FORCEINLINE ScalarRegister(const ScalarRegister& VectorValue);

	/** Constructor using float value */
	[[nodiscard]] explicit FORCEINLINE ScalarRegister(const float& ScalarValue);

	/** Constructor
	 *
	 * @param RegisterType float4 vector register type
	 */
	[[nodiscard]] explicit FORCEINLINE ScalarRegister(RegisterType VectorValue);
	 ...
	 */
	[[nodiscard]] FORCEINLINE ScalarRegister operator*(const ScalarRegister& RHS) const;
