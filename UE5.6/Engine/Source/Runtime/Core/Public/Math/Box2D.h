...
public:
	 ...
	 * @return The distance.
	 */
	[[nodiscard]] FORCEINLINE T ComputeSquaredDistanceToPoint( const TVector2<T>& Point ) const
	{
	 ...
	 */
	[[nodiscard]] FORCEINLINE TVector2<T> GetClosestPointTo( const TVector2<T>& Point ) const;
	 ...
	 */
	[[nodiscard]] FORCEINLINE bool Intersect( const TBox2<T> & other ) const;
