...
public:
	 ...
	 * @see Exclusive, Inclusive, Open
	 */
	[[nodiscard]] TRangeBound(ElementValueOrConstRef InValue)
...
public:
	 ...
	 */
	[[nodiscard]] bool operator==(const TRangeBound& Other) const
	{
...
public:
	 ...
	 * @see IsOpen
	 */
	[[nodiscard]] FORCEINLINE_DEBUGGABLE ElementValueOrConstRef GetValue() const
	{
	 ...
	 */
	[[nodiscard]] FORCEINLINE_DEBUGGABLE bool IsClosed() const
	{
	 ...
	 */
	[[nodiscard]] FORCEINLINE_DEBUGGABLE bool IsExclusive() const
	{
	 ...
	 */
	[[nodiscard]] FORCEINLINE_DEBUGGABLE bool IsInclusive() const
	{
	 ...
	 */
	[[nodiscard]] FORCEINLINE_DEBUGGABLE bool IsOpen() const
	{
		return (Type == ERangeBoundTypes::Open);
	}
...
public:
	 ...
	 */
	[[nodiscard]] static FORCEINLINE TRangeBound Exclusive(ElementValueOrConstRef Value)
	{
		TRangeBound Result;
	 ...
	 */
	[[nodiscard]] static FORCEINLINE TRangeBound Inclusive(ElementValueOrConstRef Value)
	{
		TRangeBound Result;
	 ...
	 */
	[[nodiscard]] static FORCEINLINE TRangeBound Open()
	{
		TRangeBound Result;
...
public:
	 ...
	 * @return A new bound.
	 */
	[[nodiscard]] static FORCEINLINE TRangeBound FlipInclusion(const TRangeBound& Bound)
	{
	 ...
	 */
	[[nodiscard]] static FORCEINLINE const TRangeBound& MaxLower(const TRangeBound& A, const TRangeBound& B)
	{
	 ...
	 */
	[[nodiscard]] static FORCEINLINE const TRangeBound& MaxUpper(const TRangeBound& A, const TRangeBound& B)
	{
	 ...
	 */
	[[nodiscard]] static FORCEINLINE const TRangeBound& MinLower(const TRangeBound& A, const TRangeBound& B)
	{
		if (A.IsOpen()) { return A; }
		if (B.IsOpen()) { return B; }
		if (A.Value < B.Value) { return A; }
	 ...
	 */
	[[nodiscard]] static FORCEINLINE const TRangeBound& MinUpper(const TRangeBound& A, const TRangeBound& B)
	{
		if (A.IsOpen()) { return B; }
		if (B.IsOpen()) { return A; }
		if (A.Value < B.Value) { return A; }
