...
protected:
	...
	FORCEINLINE_STATS void AddMessageInner(FName InStatName, EStatOperation::Type InStatOperation, TValue Value, bool bIsCycle = false)
	{
	...
	/** Clock operation. **/
	FORCEINLINE_STATS void AddMessageInner(FName InStatName, EStatOperation::Type InStatOperation)
	{
...
public:
	 ...
	 */
	FORCEINLINE_STATS void Start(TStatId InStatId, EStatFlags InStatFlags, bool bAlways = false, UE::FSourceLocation SourceLocation = UE::FSourceLocation::Current())
	{
	...
	FORCEINLINE_STATS void Start(TStatId InStatId, bool bAlways = false, UE::FSourceLocation SourceLocation = UE::FSourceLocation::Current())
	{
...
public:
	 ...
	 * the timing of the cycles used
	 */
	FORCEINLINE_STATS FScopeCycleCounter(TStatId StatId, EStatFlags StatFlags, bool bAlways = false, UE::FSourceLocation SourceLocation = UE::FSourceLocation::Current())
	{
		UE_AUTORTFM_OPEN
		{
	...
	FORCEINLINE_STATS FScopeCycleCounter(TStatId StatId, bool bAlways = false, UE::FSourceLocation SourceLocation = UE::FSourceLocation::Current())
...
protected:
	...
	CORE_API const TStatIdData* DoSetup(FName InStatName, const TCHAR* InStatDesc, const char* InGroupName, const char* InGroupCategory, const TCHAR* InGroupDesc, bool bDefaultEnable, bool bShouldClearEveryFrame, EStatDataType::Type InStatType, bool bCycleStat, bool bSortByName, FPlatformMemory::EMemoryCounterRegion InMemoryRegion) const;
};
