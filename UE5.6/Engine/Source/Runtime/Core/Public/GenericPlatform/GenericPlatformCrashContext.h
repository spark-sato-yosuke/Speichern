...
struct FSharedCrashContext
{
	...
	// Count and offset into dynamic buffer to comma separated file list
	uint32					FilePathsNum;
...
public:
	...
	CORE_API static const TCHAR* const CrashReportOptionalAttachmentsDirName;
	...
	CORE_API static const TCHAR* const RequestDataTag;
	...
	CORE_API static void InitializeFromContext(const FSessionContext& Context, const TCHAR* EnabledPlugins, const TCHAR* EngineData, const TCHAR* GameData, const TCHAR* FilePathData, const FGPUBreadcrumbsSharedContext* GPUBreadcrumbs);
	...
	CORE_API static void AddFile(const FString& AbsoluteSourcePath);
...
protected:
	...
	CORE_API static FString GenerateNewCrashGuidBase();
