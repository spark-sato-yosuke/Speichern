...
public:
	...
	>
	[[nodiscard]] FORCEINLINE TStridedView(SizeType InBytesBetweenElements, OtherElementType* InFirstElementPtr, SizeType InNumElements)
	...
	template <
		...
		UE_REQUIRES(std::is_convertible_v<OtherElementType**, ElementType* const*>)
	>
	[[nodiscard]] FORCEINLINE TStridedView(const TStridedView<OtherElementType, SizeType>& Other)
	...
	[[nodiscard]] FORCEINLINE SizeType GetStride() const
	{
		return BytesBetweenElements;
	}

	[[nodiscard]] FORCEINLINE ElementType& GetUnsafe(SizeType Index) const
	{
	...
	[[nodiscard]] FORCEINLINE FIterator begin() const { return FIterator{ this, 0 }; }
	[[nodiscard]] FORCEINLINE FIterator end() const { return FIterator{ this, Num() }; }
...
private:
	...
	[[nodiscard]] FORCEINLINE ElementType* GetElementPtrUnsafe(SizeType Index) const
	{
	...
	[[nodiscard]] FORCEINLINE ElementType* GetElementPtr(SizeType Index) const
	{
		RangeCheck(Index);
		return GetElementPtrUnsafe(Index);
	}
