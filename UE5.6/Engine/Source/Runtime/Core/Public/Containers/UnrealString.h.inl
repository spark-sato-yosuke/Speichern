...
using PREPROCESSOR_JOIN(UE_STRING_CLASS, FormatNamedArguments) = TMap<UE_STRING_CLASS, FStringFormatArg>;
using FStringFormatOrderedArguments = TArray<FStringFormatArg>;

[[nodiscard]] UE_STRING_CHARTYPE*       GetData(UE_STRING_CLASS&);
[[nodiscard]] const UE_STRING_CHARTYPE* GetData(const UE_STRING_CLASS&);
[[nodiscard]] int32                     GetNum(const UE_STRING_CLASS& String);
...
#ifdef UE_STRING_PRINTF_FMT_CHARTYPE2
	// Alternate formatting string type, particularly used for FUtf8String which can accept both "..." and UTF8TEXT("...") for formatting strings
	using FmtCharType2 = UE_STRING_PRINTF_FMT_CHARTYPE2;
#endif
...
public:
	[[nodiscard]] UE_STRING_CLASS() = default;
	[[nodiscard]] UE_STRING_CLASS(UE_STRING_CLASS&&) = default;
	[[nodiscard]] UE_STRING_CLASS(const UE_STRING_CLASS&) = default;
	 ...
	 */
	[[nodiscard]] FORCEINLINE UE_STRING_CLASS(const UE_STRING_CLASS& Other, int32 ExtraSlack)
	 ...
	 * @param ExtraSlack number of extra characters to add to the end of the other string in this string
	 */
	[[nodiscard]] FORCEINLINE UE_STRING_CLASS(UE_STRING_CLASS&& Other, int32 ExtraSlack)
	...
	[[nodiscard]] CORE_API UE_STRING_CLASS(const ANSICHAR* Str);
	[[nodiscard]] CORE_API UE_STRING_CLASS(const WIDECHAR* Str);
	[[nodiscard]] CORE_API UE_STRING_CLASS(const UTF8CHAR* Str);
	[[nodiscard]] CORE_API UE_STRING_CLASS(const UCS2CHAR* Str);
	[[nodiscard]] CORE_API UE_STRING_CLASS(const UTF32CHAR* Str);

	/** Construct from null-terminated C substring or nullptr */
	UE_STRING_DEPRECATED(5.4, "This constructor has been deprecated - please use " PREPROCESSOR_TO_STRING(UE_STRING_CLASS) "::ConstructFromPtrSize(Ptr, Size) instead.") [[nodiscard]] CORE_API UE_STRING_CLASS(int32 Len, const ANSICHAR* Str);
	UE_STRING_DEPRECATED(5.4, "This constructor has been deprecated - please use " PREPROCESSOR_TO_STRING(UE_STRING_CLASS) "::ConstructFromPtrSize(Ptr, Size) instead.") [[nodiscard]] CORE_API UE_STRING_CLASS(int32 Len, const WIDECHAR* Str);
	UE_STRING_DEPRECATED(5.4, "This constructor has been deprecated - please use " PREPROCESSOR_TO_STRING(UE_STRING_CLASS) "::ConstructFromPtrSize(Ptr, Size) instead.") [[nodiscard]] CORE_API UE_STRING_CLASS(int32 Len, const UTF8CHAR* Str);
	UE_STRING_DEPRECATED(5.4, "This constructor has been deprecated - please use " PREPROCESSOR_TO_STRING(UE_STRING_CLASS) "::ConstructFromPtrSize(Ptr, Size) instead.") [[nodiscard]] CORE_API UE_STRING_CLASS(int32 Len, const UCS2CHAR* Str);

	/** Construct from null-terminated C string or nullptr with extra slack on top of original string length */
	UE_STRING_DEPRECATED(5.4, "This constructor has been deprecated - please use " PREPROCESSOR_TO_STRING(UE_STRING_CLASS) "::ConstructWithSlack(Ptr, Size) instead.") [[nodiscard]] CORE_API UE_STRING_CLASS(const ANSICHAR* Str, int32 ExtraSlack);
	UE_STRING_DEPRECATED(5.4, "This constructor has been deprecated - please use " PREPROCESSOR_TO_STRING(UE_STRING_CLASS) "::ConstructWithSlack(Ptr, Size) instead.") [[nodiscard]] CORE_API UE_STRING_CLASS(const WIDECHAR* Str, int32 ExtraSlack);
	UE_STRING_DEPRECATED(5.4, "This constructor has been deprecated - please use " PREPROCESSOR_TO_STRING(UE_STRING_CLASS) "::ConstructWithSlack(Ptr, Size) instead.") [[nodiscard]] CORE_API UE_STRING_CLASS(const UTF8CHAR* Str, int32 ExtraSlack);
	UE_STRING_DEPRECATED(5.4, "This constructor has been deprecated - please use " PREPROCESSOR_TO_STRING(UE_STRING_CLASS) "::ConstructWithSlack(Ptr, Size) instead.") [[nodiscard]] CORE_API UE_STRING_CLASS(const UCS2CHAR* Str, int32 ExtraSlack);

	/** Construct from null-terminated C string with extra slack on top of original string length. */
	[[nodiscard]] static CORE_API UE_STRING_CLASS ConstructWithSlack(const ANSICHAR* Str, int32 ExtraSlack);
	[[nodiscard]] static CORE_API UE_STRING_CLASS ConstructWithSlack(const WIDECHAR* Str, int32 ExtraSlack);
	[[nodiscard]] static CORE_API UE_STRING_CLASS ConstructWithSlack(const UTF8CHAR* Str, int32 ExtraSlack);
	[[nodiscard]] static CORE_API UE_STRING_CLASS ConstructWithSlack(const UCS2CHAR* Str, int32 ExtraSlack);
	[[nodiscard]] static CORE_API UE_STRING_CLASS ConstructWithSlack(const UTF32CHAR* Str, int32 ExtraSlack);

	/** Construct from a buffer.  If the buffer contains zeros, these will be present in the constructed string. */
	[[nodiscard]] static CORE_API UE_STRING_CLASS ConstructFromPtrSize(const ANSICHAR* Str, int32 Size);
	[[nodiscard]] static CORE_API UE_STRING_CLASS ConstructFromPtrSize(const WIDECHAR* Str, int32 Size);
	[[nodiscard]] static CORE_API UE_STRING_CLASS ConstructFromPtrSize(const UTF8CHAR* Str, int32 Size);
	[[nodiscard]] static CORE_API UE_STRING_CLASS ConstructFromPtrSize(const UCS2CHAR* Str, int32 Size);
	[[nodiscard]] static CORE_API UE_STRING_CLASS ConstructFromPtrSize(const UTF32CHAR* Str, int32 Size);
	...
	[[nodiscard]] static CORE_API UE_STRING_CLASS ConstructFromPtrSizeWithSlack(const ANSICHAR* Str, int32 Size, int32 ExtraSlack);
	[[nodiscard]] static CORE_API UE_STRING_CLASS ConstructFromPtrSizeWithSlack(const WIDECHAR* Str, int32 Size, int32 ExtraSlack);
	[[nodiscard]] static CORE_API UE_STRING_CLASS ConstructFromPtrSizeWithSlack(const UTF8CHAR* Str, int32 Size, int32 ExtraSlack);
	[[nodiscard]] static CORE_API UE_STRING_CLASS ConstructFromPtrSizeWithSlack(const UCS2CHAR* Str, int32 Size, int32 ExtraSlack);
	[[nodiscard]] static CORE_API UE_STRING_CLASS ConstructFromPtrSizeWithSlack(const UTF32CHAR* Str, int32 Size, int32 ExtraSlack);
	...
	>
	[[nodiscard]] FORCEINLINE explicit UE_STRING_CLASS(CharRangeType&& Str)
	{
	...
	>
	[[nodiscard]] explicit UE_STRING_CLASS(CharRangeType&& Str, int32 ExtraSlack)
	{
...
public:
	...
	[[nodiscard]] FORCEINLINE UE_STRING_CLASS(const CFStringRef In)
	{
	...
	[[nodiscard]] explicit UE_STRING_CLASS(FIntrusiveUnsetOptionalState Tag)
		: Data(Tag)
	{
	}
	...
	[[nodiscard]] FORCEINLINE UE_STRING_CLASS(const NSString* In) : UE_STRING_CLASS((__bridge CFStringRef)In)
	{
	}
#endif
...
public:
	 ...
	 */
	[[nodiscard]] FORCEINLINE ElementType& operator[](int32 Index) UE_LIFETIMEBOUND
	{
	 ...
	 */
	[[nodiscard]] FORCEINLINE const ElementType& operator[](int32 Index) const UE_LIFETIMEBOUND
	{
		checkf(IsValidIndex(Index), TEXT("String index out of bounds: Index %i from a string with a length of %i"), Index, Len());
		return Data.GetData()[Index];
	}
	 ...
	 */
	[[nodiscard]] FORCEINLINE DataType::RangedForIteratorType             begin ()       { auto Result = Data.begin();                                return Result; }
	[[nodiscard]] FORCEINLINE DataType::RangedForConstIteratorType        begin () const { auto Result = Data.begin();                                return Result; }
	[[nodiscard]] FORCEINLINE DataType::RangedForIteratorType             end   ()       { auto Result = Data.end();    if (Data.Num()) { --Result; } return Result; }
	[[nodiscard]] FORCEINLINE DataType::RangedForConstIteratorType        end   () const { auto Result = Data.end();    if (Data.Num()) { --Result; } return Result; }
	[[nodiscard]] FORCEINLINE DataType::RangedForReverseIteratorType      rbegin()       { auto Result = Data.rbegin(); if (Data.Num()) { ++Result; } return Result; }
	[[nodiscard]] FORCEINLINE DataType::RangedForConstReverseIteratorType rbegin() const { auto Result = Data.rbegin(); if (Data.Num()) { ++Result; } return Result; }
	[[nodiscard]] FORCEINLINE DataType::RangedForReverseIteratorType      rend  ()       { auto Result = Data.rend();                                 return Result; }
	[[nodiscard]] FORCEINLINE DataType::RangedForConstReverseIteratorType rend  () const { auto Result = Data.rend();                                 return Result; }
	...
	[[nodiscard]] CORE_API CFStringRef GetCFString() const;
#endif

#ifdef __OBJC__
	/** Convert the string to Objective-C NSString */
	[[nodiscard]] CORE_API NSString* GetNSString() const;
#endif
	/**
	 ...
	 *
	 * @param InPrefix     The prefix to search for at the start of the string to remove.
	 * @param InPrefixLen  The length of InPrefix
	 * @return true if the prefix was removed, otherwise false.
	 */
	 ...
	 *
	 * @param InSuffix     The suffix to search for at the end of the string to remove.
	 * @param InSuffixLen  The length of InSuffix
	 * @param SearchCase   Indicates whether the search is case sensitive or not (defaults to ESearchCase::IgnoreCase)
	 * @return true if the suffix was removed, otherwise false.
	 */
...
public:
	...
	* Concatenate this path with given path ensuring the / character is used between them
	* 
	* @param Str path range of CharType (string class/string view/string builder etc) to be concatenated onto the end of this
	* @return reference to path
	*/
	template <
		typename CharRangeType,
	...
	*/
	...
	FORCEINLINE void LeftInline(int32 Count, EAllowShrinking AllowShrinking = EAllowShrinking::Default)
	{
	...
	FORCEINLINE void LeftChopInline(int32 Count, EAllowShrinking AllowShrinking = EAllowShrinking::Default)
	{
		const int32 Length = Len();
	...
	FORCEINLINE void RightInline(int32 Count, EAllowShrinking AllowShrinking = EAllowShrinking::Default)
	{
		const int32 Length = Len();
	...
	FORCEINLINE void RightChopInline(int32 Count, EAllowShrinking AllowShrinking = EAllowShrinking::Default)
	{
	...
	FORCEINLINE void MidInline(int32 Start, int32 Count = MAX_int32, EAllowShrinking AllowShrinking = EAllowShrinking::Default)
	{
	 ...
	 *
	 * @return  Index into this string of the first found instance. If SubStr is empty, returns clamped StartPosition.
	 *
	 * @note  When searching backwards where a StartPosition is provided, searching will actually begin from
	 *        StartPosition - GetNum(SubStr), therefore:
	 *
	 ...
	 *
	 * @note  When searching backwards where a StartPosition is provided, searching will actually begin from
	 *        StartPosition - Strlen(SubStr), therefore:
	 *
	 *        FString("X").Find("X", ESearchCase::CaseSensitive, ESearchDir::FromEnd, 0) == INDEX_NONE
	 *
	 *        Consider using UE::String::FindLast() as an alternative.
	 ...
	 *
	 * @note  When searching backwards where a StartPosition is provided, searching will actually begin from
	 *        StartPosition - InSubStrLen, therefore:
	 *
	 *        FString("X").Find("X", ESearchCase::CaseSensitive, ESearchDir::FromEnd, 0) == INDEX_NONE
	 *
	 *        Consider using UE::String::FindLast() as an alternative.
	 ...
	 */
	FORCEINLINE bool FindChar(ElementType InChar, int32& OutIndex) const
	{
	 ...
	 * @return true if character was found in this string, otherwise false
	 */
	FORCEINLINE bool FindLastChar(ElementType InChar, int32& OutIndex) const
	{
	 ...
	 */
	CORE_API bool Split(const UE_STRING_CLASS& InStr, UE_STRING_CLASS* LeftS, UE_STRING_CLASS* RightS, ESearchCase::Type SearchCase,
		ESearchDir::Type SearchDir = ESearchDir::FromStart) const;
	 ...
	 *
	 * @param Fmt  Format string that specifies how the string should be built optionally using additional args. Refer to standard printf format.
	...
	[[nodiscard]] static UE_STRING_CLASS Printf(UE::Core::TCheckedFormatString<FmtCharType, Types...> Fmt, Types... Args)
	{
		return PrintfImpl((const ElementType*)Fmt.FormatString, Args...);
	}
#ifdef UE_STRING_PRINTF_FMT_CHARTYPE2
	template <typename... Types>
	[[nodiscard]] static UE_STRING_CLASS Printf(UE::Core::TCheckedFormatString<FmtCharType2, Types...> Fmt, Types... Args)
	{
		return PrintfImpl((const ElementType*)Fmt.FormatString, Args...);
	}
#endif
	...
	{
		AppendfImpl(*this, (const ElementType*)Fmt.FormatString, Args...);
		return *this;
	}
#ifdef UE_STRING_PRINTF_FMT_CHARTYPE2
	template <typename... Types>
	UE_STRING_CLASS& Appendf(UE::Core::TCheckedFormatString<FmtCharType2, Types...> Fmt, Types... Args)
	{
		AppendfImpl(*this, (const ElementType*)Fmt.FormatString, Args...);
		return *this;
	}
...
public:
	 ...
	 */
	[[nodiscard]] static UE_STRING_CLASS Format(const FmtCharType* InFormatString, const PREPROCESSOR_JOIN(UE_STRING_CLASS, FormatNamedArguments)& InNamedArguments)
	{
		return FormatImpl((const ElementType*)InFormatString, InNamedArguments);
	}
#ifdef UE_STRING_PRINTF_FMT_CHARTYPE2
	[[nodiscard]] static UE_STRING_CLASS Format(const FmtCharType2* InFormatString, const PREPROCESSOR_JOIN(UE_STRING_CLASS, FormatNamedArguments)& InNamedArguments)
	{
		return FormatImpl((const ElementType*)InFormatString, InNamedArguments);
	}
#endif
	 ...
	 * @return A string containing the formatted text
	 */
	[[nodiscard]] static UE_STRING_CLASS Format(const FmtCharType* InFormatString, const FStringFormatOrderedArguments& InOrderedArguments)
	{
		return FormatImpl((const ElementType*)InFormatString, InOrderedArguments);
	}
#ifdef UE_STRING_PRINTF_FMT_CHARTYPE2
	[[nodiscard]] static UE_STRING_CLASS Format(const FmtCharType2* InFormatString, const FStringFormatOrderedArguments& InOrderedArguments)
	{
		return FormatImpl((const ElementType*)InFormatString, InOrderedArguments);
	}
#endif
...
private:
	static CORE_API UE_STRING_CLASS FormatImpl(const ElementType* InFormatString, const PREPROCESSOR_JOIN(UE_STRING_CLASS, FormatNamedArguments)& InNamedArguments);
	static CORE_API UE_STRING_CLASS FormatImpl(const ElementType* InFormatString, const FStringFormatOrderedArguments& InOrderedArguments);
public:
	 ...
	 * @param Str Reference to the string being serialized.
	 *
	 * @return Reference to the Archive after serialization.
	 */
	friend CORE_API FArchive& operator<<(FArchive& Ar, UE_STRING_CLASS& Str);


	/**
	 * Test whether this string starts with given prefix.
	 *
	 * @param InPrefix    The prefix to search for at the start of the string.
	 * @param SearchCase  Indicates whether the search is case sensitive or not (defaults to ESearchCase::IgnoreCase)
	 ...
	 *
	 * @param InSuffix    The suffix to search for at the end of the string.
	 * @param SearchCase  Indicates whether the search is case sensitive or not (defaults to ESearchCase::IgnoreCase)
	 ...
	 *
	 * @param Wildcard     *?-type wildcard
	 * @param WildcardLen  The length of Wildcard
	 * @param SearchCase   Indicates whether the search is case sensitive or not (defaults to ESearchCase::IgnoreCase)
	 * @return true if this string matches the *?-type wildcard given.
	 * @warning This is a simple, SLOW routine. Use with caution
	 */
	...
	*/
	 ...
	 * @param bInCullEmpty  If true, empty strings are not added to the array
	 *
	 * @return	The number of elements in OutArray
	 */
	...
	*/
	 ...
	 *
	 * @param	InOutArray  The array to cull
	 *
	 * @return	The number of elements left in InOutArray
	 */
	 ...
	 * @param To          The substring to insert in its place.
	 * @param SearchCase  Indicates whether the search is case sensitive or not (defaults to ESearchCase::IgnoreCase)
	...
	{
		if (SearchCase == ESearchCase::IgnoreCase && TChar<ElementType>::IsAlpha(From))
		{
			ReplaceCharInlineIgnoreCase(From, To);
		}
		else
		{
...
private:
	CORE_API void ReplaceCharInlineCaseSensitive(ElementType From, ElementType To);
	CORE_API void ReplaceCharInlineIgnoreCase(ElementType From, ElementType To);
...
public:
	...
	[[nodiscard]] friend FORCEINLINE uint32 GetTypeHash(const UE_STRING_CLASS& S)
	{
...
{
	[[nodiscard]] FORCEINLINE static TCHAR const* GetName()
	{
		return TEXT(PREPROCESSOR_TO_STRING(UE_STRING_CLASS));
	}
};

[[nodiscard]] inline UE_STRING_CLASS::ElementType* GetData(UE_STRING_CLASS& String)
{
	return String.GetCharArray().GetData();
}

[[nodiscard]] inline const UE_STRING_CLASS::ElementType* GetData(const UE_STRING_CLASS& String)
{
	return String.GetCharArray().GetData();
}

[[nodiscard]] inline int32 GetNum(const UE_STRING_CLASS& String)
{
	return String.Len();
}
 ...
 * }
 */
[[nodiscard]] FORCEINLINE const UE_STRING_CLASS::ElementType* ToCStr(const UE_STRING_CLASS& Str)
{
	return *Str;
}
 ...
 */
[[nodiscard]] CORE_API int32 FindMatchingClosingParenthesis(const UE_STRING_CLASS& TargetString, const int32 StartSearch = 0);
...
*/
[[nodiscard]] CORE_API UE_STRING_CLASS SlugStringForValidName(const UE_STRING_CLASS& DisplayString, const TCHAR* ReplaceWith = TEXT(""));
