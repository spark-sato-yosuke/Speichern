...
public:
	...
	[[nodiscard]] TBasicArray(TBasicArray&& Other)
		: Data(Other.Data)
	{
		Other.Data = nullptr;
	}
...
private:
	...
	[[nodiscard]] friend       T* begin(      TBasicArray& Arr) { return Arr.GetData(); }
	[[nodiscard]] friend const T* begin(const TBasicArray& Arr) { return Arr.GetData(); }
	[[nodiscard]] friend       T* end  (      TBasicArray& Arr) { return Arr.GetData() + Arr.Num(); }
	[[nodiscard]] friend const T* end  (const TBasicArray& Arr) { return Arr.GetData() + Arr.Num(); }
};
