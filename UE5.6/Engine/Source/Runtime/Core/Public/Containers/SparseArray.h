...
private:
	...
	public:
		...
		[[nodiscard]] FORCEINLINE const FRelativeBitReference& GetRelativeBitReference() const
		{
			return BitArrayIt;
		}
...
public:
	...
	public:
		...
		public:
			...
			[[nodiscard]] FORCEINLINE bool operator!=(const TRangedForIterator& Rhs) const
			{
		...
		public:
			...
			[[nodiscard]] FORCEINLINE bool operator!=(const TRangedForConstIterator& Rhs) const
			{
				// We only need to do the check in this operator, because no other operator will be
				// called until after this one returns.
				//
...
public:
	 ...
	 */
	[[nodiscard]] FORCEINLINE TRangedForIterator      begin()       { return TRangedForIterator     (*this, TConstSetBitIterator<typename Allocator::BitArrayAllocator>(AllocationFlags)); }
	[[nodiscard]] FORCEINLINE TRangedForConstIterator begin() const { return TRangedForConstIterator(*this, TConstSetBitIterator<typename Allocator::BitArrayAllocator>(AllocationFlags)); }
	[[nodiscard]] FORCEINLINE TRangedForIterator      end  ()       { return TRangedForIterator     (*this, TConstSetBitIterator<typename Allocator::BitArrayAllocator>(AllocationFlags, AllocationFlags.Num())); }
	[[nodiscard]] FORCEINLINE TRangedForConstIterator end  () const { return TRangedForConstIterator(*this, TConstSetBitIterator<typename Allocator::BitArrayAllocator>(AllocationFlags, AllocationFlags.Num())); }
...
public:
	[[nodiscard]] static FScriptSparseArrayLayout GetScriptLayout(int32 ElementSize, int32 ElementAlignment)
	{
