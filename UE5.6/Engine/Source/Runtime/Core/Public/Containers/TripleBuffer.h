...
public:
	...
	[[nodiscard]] explicit TTripleBuffer(ENoInit)
	{
		Initialize();
	}
	 ...
	 */
	[[nodiscard]] explicit TTripleBuffer(const BufferType& InValue)
	{
		Initialize();
	 ...
	 */
	[[nodiscard]] TTripleBuffer(BufferType (&InBuffers)[3])
	{
		Buffers = &InBuffers[0];
...
public:
	 ...
	 */
	[[nodiscard]] BufferType& GetWriteBuffer()
	{
...
public:
	 ...
	 */
	[[nodiscard]] const BufferType& SwapAndRead()
	{
		SwapReadBuffers();
		return Read();
	}
...
private:
	...
	[[nodiscard]] static FORCEINLINE int32 SwapReadWithTempFlags(int32 Flags)
	{
	...
	[[nodiscard]] static FORCEINLINE int32 SwapWriteWithTempFlags(int32 Flags)
	{
