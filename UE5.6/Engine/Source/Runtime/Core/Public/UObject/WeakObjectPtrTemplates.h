...
public:
	...
	*/
	...
	[[nodiscard]] FORCENOINLINE bool operator==(const TWeakObjectPtr<RhsT, TWeakObjectPtrBase>& Rhs) const
	{
		return WeakPtr == Rhs.WeakPtr;
	}

	template <typename RhsT, typename = decltype((T*)nullptr == (RhsT*)nullptr)>
	[[nodiscard]] FORCENOINLINE bool operator==(const RhsT* Rhs) const
	{
...
[[nodiscard]] FORCEINLINE bool operator==(const LhsT* Lhs, const TWeakObjectPtr<RhsT, OtherTWeakObjectPtrBase>& Rhs)
{
	return Rhs == Lhs;
}
template <typename RhsT, typename OtherTWeakObjectPtrBase>
[[nodiscard]] FORCEINLINE bool operator==(TYPE_OF_NULLPTR, const TWeakObjectPtr<RhsT, OtherTWeakObjectPtrBase>& Rhs)
{
	return Rhs == nullptr;
}
