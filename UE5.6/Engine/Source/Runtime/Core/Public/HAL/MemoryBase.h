 ...
 * FMemory wraps GMalloc but also provides low-level memory tracking and AutoRTFM support.
 */
...
/** 
 * Un-namespaced GMalloc remains exposed for backwards compatibility.
 * Most callers should use FMemory::Malloc instead of accessing GMalloc directly.
 * FMemory wraps GMalloc but also provides low-level memory tracking and AutoRTFM support.
 */
