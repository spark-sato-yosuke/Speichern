...
#ifndef ANDROID_PROFILING_ENABLED
...
public:
	...
	// If this true the RHI will not be blocked while the app is in the background. Instead the RHI will detach the window and any further draw operations will be made to an offscreen surface.
	// false, standard blocking background behavior will be used...
	static CORE_API bool UseNewWindowBehavior();

#if STATS || ENABLE_STATNAMEDEVENTS
	/** Override to add Android features when stats are on, otherwise use version on FGenericPlatformMisc. */
