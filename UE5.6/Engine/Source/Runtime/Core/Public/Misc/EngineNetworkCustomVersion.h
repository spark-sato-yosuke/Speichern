...
struct FEngineNetworkCustomVersion
{
	enum Type
	{
		...
		MontagePlayCountSerialization = 37,		// Bump version to support serialization changes for dynamic montage play count 
		RemoteObjectReferences = 38,			// Bump version to support serialization changes for remote object references 
		BeaconNetIDVariant = 39,				// Bump version for online beacon's BeaconAssignGUID control message switching to use FNetIDVariant
		JoinNoPawn = 40,						// Bump version to support NMT_JoinNoPawn and NMT_JoinNoPawnSplit control messages.
		ClientHandshakeId = 41,					// Bump version to support serialization of APlayerController::ClientHandeshakeId.
		PawnRemoteViewPitchTo16Bit = 42,		// Bump version to support higher precision PawnRemoteViewPitch
