...
#if UE_EDITOR
CORE_API int32 StaticDedicatedServerCheck(); // Internal, use IsRunningDedicatedServer()
CORE_API int32 StaticGameCheck(); // Internal, use IsRunningGame()
CORE_API int32 StaticClientOnlyCheck(); // Internal, use IsRunningClientOnly()
#endif
...
UE_DECLARE_THREAD_SINGLETON_TLS(class FScriptExceptionHandler, CORE_API)
