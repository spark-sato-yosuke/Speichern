...
inline constexpr auto DefaultQueuedWorkPriorityWrapper = [](EQueuedWorkPriority InPriority) { return InPriority; };
...
protected:
	...
	private:
		...
		{
			return FReturnedRefCountValue{uint32(NumRefs.Increment())};
		}
