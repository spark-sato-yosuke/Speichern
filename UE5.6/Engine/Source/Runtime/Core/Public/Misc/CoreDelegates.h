...
struct FMountPaksExArgs
{
	...
	// TODO: @Daniel.Lamb - this should use FError
...
public:
	...
	// Callback to prompt the pak system to mount multiple pak files
	// Returns true if any paks were mounted.
	...
	// Used by asset manager to translate from a pakchunk name to the chunkId it should have.
	static CORE_API TDelegate<int32(const FString& /*InPakchunkName*/)> PakChunkIdOverrideDelegate;
	...
	// [iOS only] Called when the audio session is interrupted
