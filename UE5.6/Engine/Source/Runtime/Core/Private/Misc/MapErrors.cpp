...
FLazyName FMapErrors::FixedUpNonMatchingTargetLayer(TEXT("FixedUpNonMatchingTargetLayer"));
...
FLazyName FMapErrors::StaticLightWithLumen_Warning(TEXT("StaticLightWithLumen_Warning"));
