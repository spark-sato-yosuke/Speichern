...
class FConsoleCommandDumpVisitor
{
public:
	/**
	 ...
	 */
	static void OnConsoleObject(const TCHAR *Name, IConsoleObject* Object, TSet<FString>* Sink)
	{
		if (!Object->AsCommand() || Object->TestFlags(ECVF_Unregistered))
		{
			return;
		}
...
bool ConsoleCommandLibrary_DumpLibrary(UWorld* InWorld, FExec& SubSystem, const TCHAR* Prefix, FOutputDevice& Ar)
{
	...
	IConsoleManager::Get().ForEachConsoleObjectThatStartsWith(
		FConsoleObjectVisitor::CreateStatic(
			&FConsoleCommandDumpVisitor::OnConsoleObject,
