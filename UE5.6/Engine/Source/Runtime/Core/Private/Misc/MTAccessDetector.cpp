...
bool FRWAccessDetector_ConcurentReadTest::RunTest(const FString& Parameters)
{
	...
	{
		Success |= TestTrue(TEXT("Acquiring Read Access 1"), MTAccessDetector.AcquireReadAccess());
		bReading1 = true;
	...
	Success |= TestTrue(TEXT("Acquiring Read Access 2"), MTAccessDetector.AcquireReadAccess());
	bReading2 = true;
	AccessThread.Join();
...
bool FRWAccessDetector_ConcurentWriteTest::RunTest(const FString& Parameters)
{
	...
	FThread AccessThread = FThread(TEXT("AccessThread"), [&]()
	{
		Success |= TestTrue(TEXT("Acquiring Write Access"), MTAccessDetector.AcquireWriteAccess());
		bWriting1 = true;
	...
	Success |= TestFalse(TEXT("Acquiring Write Access"), MTAccessDetector.AcquireWriteAccess());
	bWriting2 = true;
	AccessThread.Join();
...
bool FRWAccessDetector_ConcurentReadWriteTest::RunTest(const FString& Parameters)
{
	...
	FThread AccessThread = FThread(TEXT("AccessThread"), [&]()
	{
		Success |= TestTrue(TEXT("Acquiring Read Access"), MTAccessDetector.AcquireReadAccess());
		bReading = true;
...
bool FRWAccessDetector_WriteReentrance::RunTest(const FString& Parameters)
{
	...
	bool Success = false;
	Success |= TestTrue(TEXT("Acquiring 1st Write Access"), MTAccessDetector.AcquireWriteAccess());
	Success |= TestFalse(TEXT("Acquiring 2nd Write Access"), MTAccessDetector.AcquireWriteAccess());
...
bool FRWAccessDetector_ReadReentrance::RunTest(const FString& Parameters)
{
	...
	bool Success = false;
	Success |= TestTrue(TEXT("Acquiring Write Access"), MTAccessDetector.AcquireWriteAccess());
	Success |= TestFalse(TEXT("Acquiring Read Access"), MTAccessDetector.AcquireReadAccess());
	Success |= TestFalse(TEXT("Releasing Read Access"), MTAccessDetector.ReleaseReadAccess());
	Success |= TestTrue(TEXT("Releasing Write Access"), MTAccessDetector.ReleaseWriteAccess());
...
bool FRWAccessDetector_RecursiveWriteReentrance::RunTest(const FString& Parameters)
{
	...
	bool Success = false;
	Success |= TestTrue(TEXT("Acquiring 1st Write Access"), MTAccessDetector.AcquireWriteAccess());
	Success |= TestTrue(TEXT("Acquiring 2nd Write Access"), MTAccessDetector.AcquireWriteAccess());
	Success |= TestTrue(TEXT("Releasing Write Access"), MTAccessDetector.ReleaseWriteAccess());
	Success |= TestTrue(TEXT("Releasing Write Access"), MTAccessDetector.ReleaseWriteAccess());
