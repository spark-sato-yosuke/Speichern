...
FTransactionallySafeCriticalSection* GetExecRegistryLock()
{
	...
	static FTransactionallySafeCriticalSection ExecRegistryLock;
...
{
	UE::TScopeLock ScopeLock(*GetExecRegistryLock());
...
UE_DEFINE_THREAD_SINGLETON_TLS(FScriptExceptionHandler)
