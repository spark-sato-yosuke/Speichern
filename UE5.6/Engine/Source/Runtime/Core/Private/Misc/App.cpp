...
std::atomic<double> FApp::FixedDeltaTime = 1 / 30.0;
std::atomic<double> FApp::CurrentTime = 0.0;
std::atomic<double> FApp::LastTime = 0.0;
std::atomic<double> FApp::DeltaTime = 1 / 30.0;
std::atomic<double> FApp::IdleTime = 0.0;
std::atomic<double> FApp::IdleTimeOvershoot = 0.0;
std::atomic<double> FApp::GameTime = 0.0;
...
#error No architecture name defined!
	...
	UE_LOG(LogInit, Log, TEXT("Allocator: %s"), UE::Private::GMalloc->GetDescriptiveName());
