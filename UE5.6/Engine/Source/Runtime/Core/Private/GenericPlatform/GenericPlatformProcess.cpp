...
#include "Async/TaskGraphInterfaces.h"
	...
	// By default we assume the platform supports multithreading
...
const TCHAR* FGenericPlatformProcess::GetArchitectureSuffix()
{
	return nullptr;
}
...
bool FGenericPlatformProcess::ModuleExists(const FString& Filename)
{
...
UE::FPlatformSystemWideMutexNotImplemented::FPlatformSystemWideMutexNotImplemented(const FString& Name, FTimespan Timeout)
{
	UE_LOG(LogHAL, Fatal, TEXT("FPlatformSystemWideMutex not implemented on this platform."));
}
