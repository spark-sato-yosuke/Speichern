...
UE::Editor::DataStorage::ICoreProvider* UTypedElementRegistry::GetMutableDataStorage()
{
	using namespace UE::Editor::DataStorage;
	return GetMutableDataStorageFeature<ICoreProvider>(StorageFeatureName);
}

const UE::Editor::DataStorage::ICoreProvider* UTypedElementRegistry::GetDataStorage() const
{
	using namespace UE::Editor::DataStorage;
	return GetDataStorageFeature<ICoreProvider>(StorageFeatureName);
}

UE::Editor::DataStorage::ICompatibilityProvider* UTypedElementRegistry::GetMutableDataStorageCompatibility()
{
	using namespace UE::Editor::DataStorage;
	return GetMutableDataStorageFeature<ICompatibilityProvider>(CompatibilityFeatureName);
}

const UE::Editor::DataStorage::ICompatibilityProvider* UTypedElementRegistry::GetDataStorageCompatibility() const
{
	using namespace UE::Editor::DataStorage;
	return GetDataStorageFeature<ICompatibilityProvider>(CompatibilityFeatureName);
}

UE::Editor::DataStorage::IUiProvider* UTypedElementRegistry::GetMutableDataStorageUi()
{
	using namespace UE::Editor::DataStorage;
	return GetMutableDataStorageFeature<IUiProvider>(UiFeatureName);
}

const UE::Editor::DataStorage::IUiProvider* UTypedElementRegistry::GetDataStorageUi() const
{
	using namespace UE::Editor::DataStorage;
	return GetDataStorageFeature<IUiProvider>(UiFeatureName);
}
