...
public:
	...
	// Append all ref counts from another RefCountVector, offsetting FreeIndices to refer to their corresponded new array positions
	// Note this does not try to 'fill in' original free indices, by design -- all existing IDs remain untouched, and all new IDs are simply offsets of the Other's IDs
