...
FAndroidGPUInfo::FAndroidGPUInfo()
{
	...
	EGL->InitRenderSurface(false, bCreateSurface, TOptional<FAndroidWindow::FNativeAccessor>());
	EGL->SetCurrentRenderingContext();
...
void FAndroidGPUInfo::ReadGPUFamily()
{
