...
public:
	...
	void SetParameters(FRHIBatchedShaderParameters& BatchedParameters, FRHIComputeShader* Shader, class FShaderBindingState* StateCacheShaderBindings = nullptr) const
	{
	...
	UE_DEPRECATED(5.5, "Use version with explicit FRHIRayTracingGeometry.")
	...
	UE_DEPRECATED(5.5, "Use version with explicit FRHIShaderBindingTable.")
