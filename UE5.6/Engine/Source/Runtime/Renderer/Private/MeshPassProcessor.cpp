...
{
	FRayTracingLocalShaderBindings* Bindings = SetRayTracingShaderBindings(BindingWriter, HitGroupIndexInPipeline, INDEX_NONE, 0, ERayTracingLocalShaderBindingType::Transient);
