...
public:
	...
	FRayTracingPersistentShaderBindingTableID MaterialRayTracingSBTID = INDEX_NONE;
	FRayTracingPersistentShaderBindingTableID LumenRayTracingSBTID = INDEX_NONE;
	FRayTracingPersistentShaderBindingTableID InlineRayTracingSBTID = INDEX_NONE;
