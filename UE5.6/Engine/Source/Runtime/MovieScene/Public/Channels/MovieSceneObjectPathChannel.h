...
struct FMovieSceneObjectPathChannel : public FMovieSceneChannel
{
	...
	typedef FMovieSceneObjectPathChannelKeyValue CurveValueType;
...
public:
	...
	FORCEINLINE void SetDefault(FMovieSceneObjectPathChannelKeyValue InDefaultValue)
	{
		DefaultValue = InDefaultValue;
	}
...
inline bool EvaluateChannel(const FMovieSceneObjectPathChannel* InChannel, FFrameTime InTime, FMovieSceneObjectPathChannelKeyValue& OutValue)
{
	UObject* Value = nullptr;
	bool bSuccess = InChannel->Evaluate(InTime, Value);
	OutValue = FMovieSceneObjectPathChannelKeyValue(Value);
	return bSuccess;
}
