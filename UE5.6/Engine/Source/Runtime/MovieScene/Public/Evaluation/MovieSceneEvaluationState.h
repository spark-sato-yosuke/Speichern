...
namespace UE::MovieScene
{
	...
	{
		UE_DECLARE_MOVIESCENE_PLAYBACK_CAPABILITY_API(MOVIESCENE_API, IStaticBindingOverridesPlaybackCapability)
	...
	/**
	 * A re-usable implementation of IStaticBindingOverridesPlaybackCapability.
	 */
	struct FStaticBindingOverrides : public IStaticBindingOverridesPlaybackCapability
	{
		UE_API virtual FMovieSceneEvaluationOperand* GetBindingOverride(const FMovieSceneEvaluationOperand& InOperand) override;
		UE_API virtual void AddBindingOverride(const FMovieSceneEvaluationOperand& InOperand, const FMovieSceneEvaluationOperand& InOverrideOperand) override;
		UE_API virtual void RemoveBindingOverride(const FMovieSceneEvaluationOperand& InOperand) override;

	private:
		TMap<FMovieSceneEvaluationOperand, FMovieSceneEvaluationOperand> BindingOverrides;

		friend class ::IMovieScenePlayer;
	};
...
struct FMovieSceneEvaluationState : public UE::MovieScene::IPlaybackCapability
{
	...
	UE_DECLARE_MOVIESCENE_PLAYBACK_CAPABILITY_API(MOVIESCENE_API, FMovieSceneEvaluationState)

	FMovieSceneEvaluationState() = default;
	FMovieSceneEvaluationState(const FMovieSceneEvaluationState&) = delete;
	FMovieSceneEvaluationState& operator=(const FMovieSceneEvaluationState&) = delete;
