...
UE_TRACE_EVENT_BEGIN(NetTrace, ObjectExistsEvent)	
	UE_TRACE_EVENT_FIELD(uint64, TypeId)
	UE_TRACE_EVENT_FIELD(uint64, ObjectId)
	UE_TRACE_EVENT_FIELD(uint32, OwnerId)
	UE_TRACE_EVENT_FIELD(uint32, NameId)
...
UE_TRACE_EVENT_BEGIN(NetTrace, ObjectPolledEvent)
	UE_TRACE_EVENT_FIELD(uint64, ObjectId)
	UE_TRACE_EVENT_FIELD(uint64, Cycles)
	UE_TRACE_EVENT_FIELD(bool, bIsWaste)
	UE_TRACE_EVENT_FIELD(uint8, GameInstanceId)
UE_TRACE_EVENT_END()

UE_TRACE_EVENT_BEGIN(NetTrace, ObjectQuantizedEvent)
	UE_TRACE_EVENT_FIELD(uint64, ObjectId)
	UE_TRACE_EVENT_FIELD(uint64, Cycles)
	UE_TRACE_EVENT_FIELD(uint8, GameInstanceId)
UE_TRACE_EVENT_END()

UE_TRACE_EVENT_BEGIN(NetTrace, ObjectWrittenEvent)
	UE_TRACE_EVENT_FIELD(uint64, ObjectId)
	UE_TRACE_EVENT_FIELD(uint64, Cycles)
	UE_TRACE_EVENT_FIELD(uint8, GameInstanceId)
UE_TRACE_EVENT_END()

UE_TRACE_EVENT_BEGIN(NetTrace, SubObjectEvent)
	UE_TRACE_EVENT_FIELD(uint64, ParentObjectId)
	UE_TRACE_EVENT_FIELD(uint64, SubObjectId)
	UE_TRACE_EVENT_FIELD(uint8, GameInstanceId)
UE_TRACE_EVENT_END()
...
void FNetTraceReporter::ReportObjectExists(uint32 GameInstanceId, uint64 NetObjectId, UE::Net::FNetDebugNameId NameId, uint64 TypeIdentifier, uint32 OwnerId)
{
	UE_TRACE_LOG(NetTrace, ObjectExistsEvent, NetChannel)
		<< ObjectExistsEvent.TypeId(TypeIdentifier)
		<< ObjectExistsEvent.ObjectId(NetObjectId)
		<< ObjectExistsEvent.OwnerId(OwnerId)
		<< ObjectExistsEvent.NameId(NameId)
		<< ObjectExistsEvent.GameInstanceId((uint8)GameInstanceId);
}
...
void FNetTraceReporter::ReportObjectPolled(uint32 GameInstanceId, uint64 NetObjectId, uint64 Cycles, bool bIsWaste)
{
	UE_TRACE_LOG(NetTrace, ObjectPolledEvent, NetChannel)
		<< ObjectPolledEvent.ObjectId(NetObjectId)
		<< ObjectPolledEvent.Cycles(Cycles)
		<< ObjectPolledEvent.bIsWaste(bIsWaste)
		<< ObjectPolledEvent.GameInstanceId((uint8)GameInstanceId);
}

void FNetTraceReporter::ReportObjectQuantized(uint32 GameInstanceId, uint64 NetObjectId, uint64 Cycles)
{
	UE_TRACE_LOG(NetTrace, ObjectQuantizedEvent, NetChannel)
		<< ObjectQuantizedEvent.ObjectId(NetObjectId)
		<< ObjectQuantizedEvent.Cycles(Cycles)
		<< ObjectQuantizedEvent.GameInstanceId((uint8)GameInstanceId);
}

void FNetTraceReporter::ReportObjectWritten(uint32 GameInstanceId, uint64 NetObjectId, uint64 Cycles)
{
	UE_TRACE_LOG(NetTrace, ObjectWrittenEvent, NetChannel)
		<< ObjectWrittenEvent.ObjectId(NetObjectId)
		<< ObjectWrittenEvent.Cycles(Cycles)
		<< ObjectWrittenEvent.GameInstanceId((uint8)GameInstanceId);
}

void FNetTraceReporter::ReportSubObject(uint32 GameInstanceId, uint64 ParentObjectId, uint64 SubObjectId)
{
	UE_TRACE_LOG(NetTrace, SubObjectEvent, NetChannel)
		<< SubObjectEvent.ParentObjectId(ParentObjectId)
		<< SubObjectEvent.SubObjectId(SubObjectId)
		<< SubObjectEvent.GameInstanceId((uint8)GameInstanceId);
}
