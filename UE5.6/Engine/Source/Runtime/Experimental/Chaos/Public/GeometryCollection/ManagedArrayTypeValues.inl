...
MANAGED_ARRAY_TYPE(TArray<TArray<FVector3f>>, FVector3fNestedArray)
MANAGED_ARRAY_TYPE(FUintVector2, UintVector2)
MANAGED_ARRAY_TYPE(TObjectPtr<UObject>, UObjectArray)
MANAGED_ARRAY_TYPE(Chaos::FLinearCurve, LinearCurve)
// NOTE: new types must be added at the bottom to keep serialization from breaking
