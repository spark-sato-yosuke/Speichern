...
namespace Chaos
{
	...
	*/
	...
	public:
		...
		bool GetGyroscopicTorqueEnabled() const { return Flags.bGyroscopicTorqueEnabled; }
		FRigidParticleControlFlags& SetGyroscopicTorqueEnabled(const bool bEnabled) { Flags.bGyroscopicTorqueEnabled = bEnabled; return *this; }
	...
	private:
		struct FFlags
		{
			...
			FStorage bGyroscopicTorqueEnabled : 1;
