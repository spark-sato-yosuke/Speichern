...
namespace Chaos
{
	...
	namespace Private
	{
		...
		public:
			 ...
			 * NOTE: The definitive active constraints list is compiled after the parallel phase 
			 * is complete (FCollisionConstraintAllocator::ProcessNewConstraints).
			 */
		...
		*/
		...
		public:
			...
			*/
			...
			/**
			 * This should be called when a sleeping constraint is activated after the narrow phase, typically
			 * in the island manager. This is mainly so that any systems asking for a list of active constraints
			 * are provided all constraints that may have contributed to the simulation, including those that
			 * were added when an island is awoken.
			 */
		...
		private:
			...
			CHAOS_API void ProcessNewNonCcdConstraints(const TArray<FPBDCollisionConstraint*>& NewConstraints, TArray<TArray<FPBDCollisionConstraint*>>& CCDConstraintsBatch);
