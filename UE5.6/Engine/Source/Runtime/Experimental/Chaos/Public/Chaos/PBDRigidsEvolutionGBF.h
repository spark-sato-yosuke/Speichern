...
namespace Chaos
{
	...
	public:
		...
		UE_DEPRECATED(5.5, "No longer used, see combined constraint in FPBDRigidsEvolutionGBF::GetJointCombinedConstraints")
		FORCEINLINE FPBDJointConstraints& GetJointConstraints() { return JointConstraints.LinearConstraints; }
		UE_DEPRECATED(5.5, "No longer used, see combined constraint in FPBDRigidsEvolutionGBF::GetJointCombinedConstraints")
		FORCEINLINE const FPBDJointConstraints& GetJointConstraints() const { return JointConstraints.LinearConstraints; }

		FORCEINLINE FJointConstraints& GetJointCombinedConstraints() { return JointConstraints; }
		FORCEINLINE const FJointConstraints& GetJointCombinedConstraints() const { return JointConstraints; }
