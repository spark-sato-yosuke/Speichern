...
struct FGeometryCollectionProximitySpatial
{
	...
	{
		TArray<TSet<int32>> Proximity = MoveTemp(KnownProximity);
...
TArray<TSet<int32>> FGeometryCollectionProximityUtility::ComputePreciseProximity(const FGeometryCollection& Collection)
{
	...
	return Spatial.MoveProximityToArray();
}
