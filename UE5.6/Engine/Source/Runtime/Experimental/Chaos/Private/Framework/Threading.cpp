...
UE_DEFINE_THREAD_SINGLETON_TLS(Chaos::FPhysicsThreadContext)
#endif
...
#if UE_AUTORTFM && UE_WITH_REMOTE_OBJECT_HANDLE
	FPhysSceneLockCallbacks GPhysSceneLockRemoteObjectCallbacks;
#endif
}
