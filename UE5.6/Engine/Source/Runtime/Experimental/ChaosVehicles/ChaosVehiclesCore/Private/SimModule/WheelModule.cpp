...
namespace Chaos
{
	...
	void FWheelSimModule::Animate()
	{
		...
		float AngularPositionDegrees = -AngularPosition * 180.0f / PI;
		float SteeringAngleDegrees = SteerAngleDegrees;

		AnimationData.AnimFlags = EAnimationFlags::AnimateRotation;
		AnimationData.AnimationRotOffset.Pitch = AngularPositionDegrees;
		AnimationData.AnimationRotOffset.Yaw = SteeringAngleDegrees;
		AnimationData.CombinedRotation = (Steer * Rot);
