...
public:
	...
	// End of UObject editor only interface
...
public:
	...
	void RemoveStaticConstraint(UTickableConstraint* InConstraint) { Constraints.Remove(InConstraint); }
	bool IsStaticConstraint(UTickableConstraint* InConstraint) const { return Constraints.Contains(InConstraint); }
...
enum class EConstraintsManagerNotifyType
{
	...
	GraphUpdated						/** The evaluation graph has been updated/reset. */
};
