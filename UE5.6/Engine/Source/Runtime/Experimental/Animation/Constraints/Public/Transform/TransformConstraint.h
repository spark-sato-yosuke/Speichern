...
protected:
	...
	*/
	...
	/** Perform necessary pre-evaluation steps before calculating the constraint's result. */
	void PreEvaluate() const;

	/** Perform necessary post-evaluation steps after calculating the constraint's result. */
...
{
	UE_DEPRECATED(5.6, "This function was moved to the UE::TransformConstraintUtil namespace.")
