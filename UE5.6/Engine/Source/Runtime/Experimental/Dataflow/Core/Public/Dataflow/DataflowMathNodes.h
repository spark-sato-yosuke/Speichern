...
{
	GENERATED_USTRUCT_BODY()
	DATAFLOW_NODE_DEFINE_INTERNAL(FDataflowMathMinimumNode_v2, "Minimum", DATAFLOW_MATH_NODES_CATEGORY, "")
...
{
	GENERATED_USTRUCT_BODY()
	DATAFLOW_NODE_DEFINE_INTERNAL(FDataflowMathMaximumNode_v2, "Maximum", DATAFLOW_MATH_NODES_CATEGORY, "")
...
{
	GENERATED_USTRUCT_BODY()
	DATAFLOW_NODE_DEFINE_INTERNAL(FDataflowMathClampNode, "Clamp", DATAFLOW_MATH_NODES_CATEGORY, "")
