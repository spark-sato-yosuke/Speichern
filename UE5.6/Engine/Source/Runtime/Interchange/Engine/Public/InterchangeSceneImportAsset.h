...
public:
	...
	INTERCHANGEENGINE_API const UInterchangeFactoryBaseNode* GetFactoryNode(const FSoftObjectPath& ObjectPath) const;

	INTERCHANGEENGINE_API void GetSceneSoftObjectPaths(TArray<FSoftObjectPath>& SoftObjectPaths) const;

	INTERCHANGEENGINE_API bool ContainsObject(const FSoftObjectPath& SoftObjectPath) const;
