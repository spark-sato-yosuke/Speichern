...
public:
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Interchange | Translator")
	virtual void SetSettings(const UInterchangeTranslatorSettings* InterchangeTranslatorSettings) { }
	...
	TSharedPtr<UE::Interchange::FAnalyticsHelper> AnalyticsHelper = nullptr;
};
