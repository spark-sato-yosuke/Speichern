...
struct FNativeFrame
{
	...
	const FOp* CallerPC;
	VFrame* CallerFrame;
	FNativeFrame* PreviousNativeFrame;
...
struct FContextImpl
{
	...
	void PushNativeFrame(VFailureContext*, const VNativeFunction* Callee, const FOp*, VFrame*, VTask*, const TFunctor&);
