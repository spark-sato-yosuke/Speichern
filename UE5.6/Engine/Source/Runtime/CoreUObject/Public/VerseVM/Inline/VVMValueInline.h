...
namespace Verse
{
FORCEINLINE VValue VRestValue::Get(FAllocationContext Context)
{
...
FORCEINLINE VValue VValue::Follow() const
{
	checkSlow(!IsRoot());
...
inline FOpResult VValue::Freeze(FAllocationContext Context, VValue Value)
{
