...
struct VValue
{
	...
	static ECompares Equal(FAllocationContext Context, VValue Left, VValue Right, HandlePlaceholderFunction HandlePlaceholder);
	...
	static FOpResult Freeze(FAllocationContext Context, VValue Value);
