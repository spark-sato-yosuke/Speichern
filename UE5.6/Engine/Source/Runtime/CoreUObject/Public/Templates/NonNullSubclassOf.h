...
public:
	...
	[[nodiscard]] FORCEINLINE TNonNullSubclassOf(EDefaultConstructNonNullSubclassOf)
		: Super(nullptr)
	{
	}
	...
	[[nodiscard]] FORCEINLINE TNonNullSubclassOf(PtrType* From)
		: Super(From)
	{
	...
	>
	[[nodiscard]] FORCEINLINE TNonNullSubclassOf(const TSubclassOf<U>& From)
		: Super(From)
	{
	}
	...
	[[nodiscard]] FORCEINLINE explicit TNonNullSubclassOf(FIntrusiveUnsetOptionalState)
		: Super(nullptr)
	{
	}
	
	[[nodiscard]] FORCEINLINE bool operator==(FIntrusiveUnsetOptionalState) const
	{
