...
/**
* Report a Verse native struct that needs to be examined further
*/
COREUOBJECT_API void MarkNativeStructAsReachable(::Verse::VNativeStruct* NativeStruct);
#endif
...
public:
	...
	bool LockSucceeded() const { return bLockSuccessful;}
...
extern COREUOBJECT_API TSAN_ATOMIC(bool) GIsGarbageCollecting;
...
{
	COREUOBJECT_API void SetSkipDestroy(bool bSkip);
}
