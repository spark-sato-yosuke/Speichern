...
private:
	/**
	 * Hash of the Package's bytes when it was saved to disk. Accessed through GetSavedHash/SetSavedHash.
	 */
	FIoHash		SavedHash;
...
public:
	...
	*/
	...
	COREUOBJECT_API int64 GetSavedHashRelativeOffset() const;
#endif
