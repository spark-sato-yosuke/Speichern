...
class UPackageMap : public UObject
{
	...
	virtual bool			IsUsingRemoteObjectReferences() const { return false; }
...
struct FNetDeltaSerializeInfo
{
	...
	/** Whether or not FFastArraySerializer will call user provided client-side callbacks (e.g. PreReplicatedRemove()). */
	bool bCallFastArrayClientCallbacks = true;
#endif
