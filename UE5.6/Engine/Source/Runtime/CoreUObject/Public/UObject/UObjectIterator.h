...
{
	return InternalExclusionFlags | EInternalObjectFlags::Unreachable | EInternalObjectFlags::AutoRTFMConstructionAborted | EInternalObjectFlags::PendingConstruction | EInternalObjectFlags::Remote | UE::GetAsyncLoadingInternalFlagsExclusion();
}
...
public:
	...
	FORCEINLINE UObject* operator*() const
	{
		...
		return (UObject*)(ObjectItem ? ObjectItem->GetObject() : nullptr);
	}
	/**
	 * Iterator dereference
	 * @return	the object pointer pointed at by the iterator
