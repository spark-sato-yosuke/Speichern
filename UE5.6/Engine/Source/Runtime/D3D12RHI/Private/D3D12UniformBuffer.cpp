...
FD3D12UniformBuffer::~FD3D12UniformBuffer()
{
	...
	{
		//UE_LOG(LogD3D12RHI, Log, TEXT("Deleting uniform buffer %#016llx with GPU address: \"0x%llX\" and %d listeners still registered"), this, ResourceLocation.GetGPUVirtualAddress(), UpdateListeners.Num());
