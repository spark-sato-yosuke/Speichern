...
const FString& FNullHttpRequest::GetURL() const
{
	return Url;
}
...
const FString& FNullHttpResponse::GetURL() const
{
	return URL;
}
...
FUtf8StringView FNullHttpResponse::GetContentAsUtf8StringView() const
{
