...
public:
	...
	const TCHAR* GetShaderFwdFilename() const { return *ShaderFwdFilename; }
	...
	bool IncludesFwdShaderFile() const                 { return HasFlags(EVertexFactoryFlags::IncludesFwdShader); }
	bool SupportsTriangleSorting() const               { return HasFlags(EVertexFactoryFlags::SupportsTriangleSorting); }
...
public:
	...
	RENDERCORE_API virtual ~FVertexFactory();
	...
	*/
	...
	{
		return GetType()->SupportsTriangleSorting();
	}
