...
static bool IsMobileDeferred(const FGBufferParams& Params)
{
	return IsMobilePlatform(Params.ShaderPlatform) && IsMobileDeferredShadingEnabled(Params.ShaderPlatform);
}
