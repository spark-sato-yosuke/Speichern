...
FJavaAndroidWebBrowser::FJavaAndroidWebBrowser(bool swizzlePixels, bool vulkanRenderer, int32 width, int32 height,
	jlong widgetPtr, bool bEnableRemoteDebugging, bool bUseTransparency, bool bEnableDomStorage, bool bShouldUseBitmapRender, const FString& UserAgentApplication, bool bEnableFloatingCloseButton)
	: FJavaClassObject(GetClassName(), "(JIIZZZZZZLjava/lang/String;Z)V", widgetPtr, width, height, swizzlePixels, vulkanRenderer, bEnableRemoteDebugging, bUseTransparency, bEnableDomStorage, bShouldUseBitmapRender, *FJavaHelper::ToJavaString(AndroidJavaEnv::GetJavaEnv(), UserAgentApplication), bEnableFloatingCloseButton)
	...
	, ShowFloatingCloseButtonMethod(GetClassMethod("ShowFloatingCloseButton", "(ZZ)V"))
...
void FJavaAndroidWebBrowser::ShowFloatingCloseButton(bool bShow, bool bDraggable)
{
	CallMethod<void>(ShowFloatingCloseButtonMethod, bShow, bDraggable);
}
