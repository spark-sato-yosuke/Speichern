...
{
	// This method may called several times with IsLoading = false (one time for each frame in the page)
...
void FAndroidWebBrowserWindow::ShowFloatingCloseButton(bool bShow, bool bDraggable)
{
...
void FAndroidWebBrowserWindow::FloatingCloseButtonPressed()
{
