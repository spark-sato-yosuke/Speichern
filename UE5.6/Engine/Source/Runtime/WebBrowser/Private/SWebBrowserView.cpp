...
void SWebBrowserView::Construct(const FArguments& InArgs, const TSharedPtr<IWebBrowserWindow>& InWebBrowserWindow)
{
	...
	if (BrowserWindow.IsValid())
	{
		...
		{
			BrowserWindow->OnFloatingCloseButtonPressed().BindSP(this, &SWebBrowserView::HandleFloatingCloseButtonPressed);
		}
...
void SWebBrowserView::ShowFloatingCloseButton(bool bShow, bool bDraggable)
{
...
void SWebBrowserView::HandleFloatingCloseButtonPressed()
{
	if (OnFloatingCloseButtonPressed.IsBound())
	{
