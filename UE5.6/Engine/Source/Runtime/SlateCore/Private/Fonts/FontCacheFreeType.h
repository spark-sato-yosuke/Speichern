...
public:
	...
	/**
	 * Returns the preprocessed font geometry object associated with the font data if available.
	 * It can only be available if this was initialized with a FontFaceData object.
	 */
