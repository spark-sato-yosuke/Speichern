...
// This is super annoying but huge functions can take a very long time to compile on msvc
// .. and by sprinkling these splits inside functions we cut this file's compile time in half
#if PLATFORM_COMPILER_CLANG
	#define UE_COMPILE_SCOPE_BEGIN
	#define UE_COMPILE_SCOPE_SPLIT
	#define UE_COMPILE_SCOPE_END
#else
	#define UE_COMPILE_SCOPE_BEGIN [&](){
	#define UE_COMPILE_SCOPE_SPLIT }();[&](){
	#define UE_COMPILE_SCOPE_END }();
