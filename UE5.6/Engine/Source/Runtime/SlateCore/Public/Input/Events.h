...
public:
	...
	FInputEvent()
		...
		, EventPath(nullptr)
		, EventTimestamp(FPlatformTime::Cycles64())	/* Initalize the timestamp of event input event to the current CPU cycle */
	{ }
	 ...
	 * Virtual destructor.
	 */
	SLATECORE_API virtual ~FInputEvent();
...
public:
	...
	*/
	...
	/**
	 * @return The CPU cycle timestamp of when this input event was created.  
	 */
	...
	/**
	 * @return The amount of time in milliseconds which have passes since this input event was constructed
	 */
	double GetMillisecondsSinceEvent() const
	{
		return FPlatformTime::ToMilliseconds64(FPlatformTime::Cycles64() - EventTimestamp);
	}
...
protected:
	...
	// The timestamp of when this input event was recorded. This is the
	// cycle at which this event was recorded, populated by FPlatformTime::Cycles64()
...
public:
	...
	SLATECORE_API virtual ~FKeyEvent();
...
public:
	...
	*/
	...
	SLATECORE_API virtual ~FAnalogInputEvent();
...
public:
	...
	SLATECORE_API virtual ~FCharacterEvent();
...
public:
	...
	FPointerEvent(
		...
		, TouchpadIndex(0)
		, Force(1.0f)
		, bIsTouchEvent(InGestureType != EGestureEvent::None)
	...
	SLATECORE_API virtual ~FPointerEvent();
