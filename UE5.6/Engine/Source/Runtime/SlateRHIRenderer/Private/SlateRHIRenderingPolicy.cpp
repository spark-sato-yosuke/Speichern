	...
	const FSlateRenderBatchOp& RenderBatchOp)
{
	...
	if (RenderBatchOp.ShaderResourceType == ESlateShaderResource::Material)
	{
		...
		if (PSOCollectorStats::IsFullPrecachingValidationEnabled())
		{
			...
			PSOCollectorStats::CheckFullPipelineStateInCache(State.GraphicsPSOInit, EPSOPrecacheResult::Unknown, nullptr, nullptr, nullptr, MaterialPSOCollectorIndex);
		}
	...
	TArray<FPSOPrecacheData>& PSOInitializers)
{
	...
	AddRenderTargetInfo(PF_A2B10G10R10, ETextureCreateFlags::RenderTargetable, RenderTargetsInfo);
