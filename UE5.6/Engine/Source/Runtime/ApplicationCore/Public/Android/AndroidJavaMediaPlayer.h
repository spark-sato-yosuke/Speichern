...
public:
	...
	bool IsUsingBitmapRendererImageReader();
	jobject GetVideoLastMediaFrameData();
...
private:
	...
	// new way of getting video frame data
	FJavaClassMethod SetUsingBitmapRendererImageReaderMethod;
	FJavaClassMethod GetVideoLastMediaFrameDataMethod;
	...
	BitmapRendererSelection BRSelection; // BR - BitmapRenderer
	bool UsingVulkanRenderer;

	void SelectBitmapRenderer();
