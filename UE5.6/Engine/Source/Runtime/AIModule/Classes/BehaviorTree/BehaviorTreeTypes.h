...
namespace UE::BehaviorTree::Messages
{
	extern AIMODULE_API FText BlackboardNotSet;
}
...
#if WITH_EDITOR
	void PreSave(const UObject* Outer, const UBlackboardData& Blackboard, FName PropertyName);
#endif // WITH_EDITOR
