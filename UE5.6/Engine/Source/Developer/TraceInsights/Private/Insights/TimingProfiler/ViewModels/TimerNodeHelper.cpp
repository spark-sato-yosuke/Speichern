...
FText TimerNodeTypeHelper::ToText(const ETimerNodeType NodeType)
{
	...
	switch (NodeType)
	{
		...
		case ETimerNodeType::VerseScope:	return LOCTEXT("Timer_Name_Verse", "Verse");
...
FText TimerNodeTypeHelper::ToDescription(const ETimerNodeType NodeType)
{
	...
	switch (NodeType)
	{
		...
		case ETimerNodeType::VerseScope:	return LOCTEXT("Timer_Desc_Verse", "Verse scope timer");
...
const FSlateBrush* TimerNodeTypeHelper::GetIconForTimerNodeType(const ETimerNodeType NodeType)
{
	...
	switch (NodeType)
	{
		...
		case ETimerNodeType::VerseScope:	return FInsightsStyle::GetBrush("Icons.CpuTimer.TreeItem");
