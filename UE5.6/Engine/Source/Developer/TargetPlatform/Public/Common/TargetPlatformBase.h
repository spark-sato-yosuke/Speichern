...
public:
	...
	TARGETPLATFORM_API virtual bool ShouldStripNaniteFallbackMeshes() const override;
	...
	TARGETPLATFORM_API virtual EOfflineBVHMode GetSkeletalMeshOfflineBVHMode() const override;
	...
	TARGETPLATFORM_API virtual FName GetFallbackASTCHDR() const override;
...
public:
	...
	virtual void RefreshAllDevices() override
	{
		TargetPlatformControls->RefreshAllDevices();
	}
	virtual FName GetZlibReplacementFormat() const override 
	{
	...
	{
		return TargetPlatformSettings->ShouldStripNaniteFallbackMeshes();
	}
	...
	virtual EOfflineBVHMode GetSkeletalMeshOfflineBVHMode() const override
	{
		return TargetPlatformSettings->GetSkeletalMeshOfflineBVHMode();
	}
	...
	virtual FName GetFallbackASTCHDR() const override
	{
		return TargetPlatformSettings->GetFallbackASTCHDR();
	}
	...
	{
		TargetPlatformSettings->GetPossibleArchitectures(OutArchitectures);
	}
	virtual FString GetHostArchitecture() const override
	{
		return TargetPlatformSettings->GetHostArchitecture();
	}
