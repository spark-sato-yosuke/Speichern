...
class TRACEINSIGHTSCORE_API FFilter : public TSharedFromThis<FFilter>
{
...
class TRACEINSIGHTSCORE_API FFilterWithSuggestionsValueConverter : public IFilterValueConverter
{
public:
...
class TRACEINSIGHTSCORE_API FFilterWithSuggestions : public FFilter
{
...
class TRACEINSIGHTSCORE_API FFilterStorage
{
public:
	FFilterStorage();
	~FFilterStorage();
...
class TRACEINSIGHTSCORE_API FFilterService
{
public:
	FFilterService();
	~FFilterService();
	...
	TSharedPtr<SWidget> CreateFilterConfiguratorWidget(TSharedPtr<class FFilterConfigurator> FilterConfiguratorViewModel, TWeakPtr<SWidget> ParentWidget = nullptr);
