...
struct TRACEINSIGHTSCORE_API FTableColumnConfig
{
	FName ColumnId;
	bool bIsVisible;
	float Width;
...
class TRACEINSIGHTSCORE_API ITableTreeViewPreset
{
public:
...
class TRACEINSIGHTSCORE_API FTableTaskCancellationToken
{
public:
...
struct TRACEINSIGHTSCORE_API FTableTaskInfo
{
 ...
 */
class TRACEINSIGHTSCORE_API STableTreeView : public SCompoundWidget, public IAsyncOperationStatusProvider
{
...
protected:
	...
	virtual void ConstructHeaderArea(TSharedRef<SVerticalBox> InHostBox);
	virtual void ConstructFooterArea(TSharedRef<SVerticalBox> InHostBox);
	...
	void CountNumNodesPerDepthRec(FBaseTreeNode* InRoot, TArray<int32>& InOutNumNodesPerDepth, int32 InDepth, int32 InMaxDepth, int32 InMaxNodes) const;
	...
	TSharedPtr<ITableTreeViewPreset> GetSelectedViewPreset() const;
	void SelectViewPreset(TSharedPtr<ITableTreeViewPreset> InPreset);
	...
	void ConstructViewPreset(TSharedPtr<SHorizontalBox> InHorizontalBox, float InMinDesiredWidth = 50.0f);
...
class TRACEINSIGHTSCORE_API FTableTreeViewNodeFilteringAsyncTask
{
public:
...
class TRACEINSIGHTSCORE_API FTableTreeViewHierarchyFilteringAsyncTask
{
public:
...
class TRACEINSIGHTSCORE_API FTableTreeViewSortingAsyncTask
{
public:
...
class TRACEINSIGHTSCORE_API FTableTreeViewGroupingAsyncTask
{
public:
...
class TRACEINSIGHTSCORE_API FSearchForItemToSelectTask
{
public:
...
class TRACEINSIGHTSCORE_API FSelectNodeByTableRowIndexTask
{
public:
