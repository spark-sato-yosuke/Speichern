...
enum class TRACEINSIGHTSCORE_API ETableColumnFlags : uint32
{
	None            = 0,
...
enum class TRACEINSIGHTSCORE_API ETableColumnAggregation : uint32
{
	None = 0,
	Sum,
	Min,
 ...
 */
class TRACEINSIGHTSCORE_API FTableColumn
{
public:
