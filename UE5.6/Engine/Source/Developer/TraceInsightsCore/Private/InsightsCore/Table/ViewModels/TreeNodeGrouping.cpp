...
FTreeNodeGrouping::FTreeNodeGrouping(const FText& InShortName, const FText& InTitleName, const FText& InDescription, const FSlateBrush* InIcon)
...
FName FTreeNodeGrouping::GetBrushName() const
{
	PRAGMA_DISABLE_DEPRECATION_WARNINGS
	return BrushName;
	PRAGMA_ENABLE_DEPRECATION_WARNINGS
