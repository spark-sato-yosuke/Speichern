...
class FSourceControlModule final : public ISourceControlModule
{
public:
	...
	virtual FSimpleMulticastDelegate& OnCustomProjectsChanged() override;
...
private:
	...
	uint8 TemporarilyDisabledCount;
	...
	FSimpleMulticastDelegate CustomProjectsChangedDelegate;

	friend FScopedDisableSourceControl;
};
