	...
	: Owner(InOwner)
{
	...
	Module.OnModuleConfigurationCompleted(FSimpleDelegate::CreateRaw(this, &FProxyGenerationProcessor::OnModuleConfigurationCompleted));
#endif // WITH_EDITOR
}
...
void FProxyGenerationProcessor::OnModuleConfigurationCompleted()
{
#if WITH_EDITOR
	IMeshReductionManagerModule& Module = FModuleManager::Get().LoadModuleChecked<IMeshReductionManagerModule>("MeshReductionInterface");
