...
public:
	...
	FNetProfilerNameIndexType AddNetProfilerName(const TCHAR* Name);
	...
	const TCHAR* InternalGetNetProfilerName(FNetProfilerNameIndexType NameIndex) const { return Names[NameIndex].Name; }
private:
	
	const FNetProfilerName* GetNetProfilerName(FNetProfilerNameIndexType ProfilerNameId) const;
