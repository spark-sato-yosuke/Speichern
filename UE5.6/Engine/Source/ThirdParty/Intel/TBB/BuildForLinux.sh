...
# -Wl,--undefined-version is needed to prevent some irrelevant errors when lld is used for linking
C_FLAGS=""
CXX_FLAGS="-nostdinc++ -I$UE_TOOLCHAIN_ARCH_INCLUDE_LOCATION"
LINKER_FLAGS="-Wl,--undefined-version -fuse-ld=lld -nodefaultlibs -stdlib=libc++ $UE_TOOLCHAIN_ARCH_LIB_LOCATION/libc++.a $UE_TOOLCHAIN_ARCH_LIB_LOCATION/libc++abi.a -lm -lc -lgcc_s -lgcc"
