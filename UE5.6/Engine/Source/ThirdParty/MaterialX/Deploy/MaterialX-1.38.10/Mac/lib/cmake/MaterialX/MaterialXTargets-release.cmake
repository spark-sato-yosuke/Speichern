...
set_target_properties(MaterialXCore PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/Mac/lib/libMaterialXCore.a"
  )

list(APPEND _cmake_import_check_targets MaterialXCore )
list(APPEND _cmake_import_check_files_for_MaterialXCore "${_IMPORT_PREFIX}/Mac/lib/libMaterialXCore.a" )
...
set_target_properties(MaterialXFormat PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/Mac/lib/libMaterialXFormat.a"
  )

list(APPEND _cmake_import_check_targets MaterialXFormat )
list(APPEND _cmake_import_check_files_for_MaterialXFormat "${_IMPORT_PREFIX}/Mac/lib/libMaterialXFormat.a" )
...
set_target_properties(MaterialXGenShader PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/Mac/lib/libMaterialXGenShader.a"
  )

list(APPEND _cmake_import_check_targets MaterialXGenShader )
list(APPEND _cmake_import_check_files_for_MaterialXGenShader "${_IMPORT_PREFIX}/Mac/lib/libMaterialXGenShader.a" )
...
set_target_properties(MaterialXGenGlsl PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/Mac/lib/libMaterialXGenGlsl.a"
  )

list(APPEND _cmake_import_check_targets MaterialXGenGlsl )
list(APPEND _cmake_import_check_files_for_MaterialXGenGlsl "${_IMPORT_PREFIX}/Mac/lib/libMaterialXGenGlsl.a" )
...
set_target_properties(MaterialXGenOsl PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/Mac/lib/libMaterialXGenOsl.a"
  )

list(APPEND _cmake_import_check_targets MaterialXGenOsl )
list(APPEND _cmake_import_check_files_for_MaterialXGenOsl "${_IMPORT_PREFIX}/Mac/lib/libMaterialXGenOsl.a" )
...
set_target_properties(MaterialXGenMdl PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/Mac/lib/libMaterialXGenMdl.a"
  )

list(APPEND _cmake_import_check_targets MaterialXGenMdl )
list(APPEND _cmake_import_check_files_for_MaterialXGenMdl "${_IMPORT_PREFIX}/Mac/lib/libMaterialXGenMdl.a" )
...
set_target_properties(MaterialXGenMsl PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/Mac/lib/libMaterialXGenMsl.a"
  )

list(APPEND _cmake_import_check_targets MaterialXGenMsl )
list(APPEND _cmake_import_check_files_for_MaterialXGenMsl "${_IMPORT_PREFIX}/Mac/lib/libMaterialXGenMsl.a" )
...
set_target_properties(MaterialXRender PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/Mac/lib/libMaterialXRender.a"
  )

list(APPEND _cmake_import_check_targets MaterialXRender )
list(APPEND _cmake_import_check_files_for_MaterialXRender "${_IMPORT_PREFIX}/Mac/lib/libMaterialXRender.a" )
...
set_target_properties(MaterialXRenderHw PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/Mac/lib/libMaterialXRenderHw.a"
  )

list(APPEND _cmake_import_check_targets MaterialXRenderHw )
list(APPEND _cmake_import_check_files_for_MaterialXRenderHw "${_IMPORT_PREFIX}/Mac/lib/libMaterialXRenderHw.a" )
...
set_target_properties(MaterialXRenderGlsl PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "C;CXX"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/Mac/lib/libMaterialXRenderGlsl.a"
  )

list(APPEND _cmake_import_check_targets MaterialXRenderGlsl )
list(APPEND _cmake_import_check_files_for_MaterialXRenderGlsl "${_IMPORT_PREFIX}/Mac/lib/libMaterialXRenderGlsl.a" )
...
set_target_properties(MaterialXRenderMsl PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/Mac/lib/libMaterialXRenderMsl.a"
  )

list(APPEND _cmake_import_check_targets MaterialXRenderMsl )
list(APPEND _cmake_import_check_files_for_MaterialXRenderMsl "${_IMPORT_PREFIX}/Mac/lib/libMaterialXRenderMsl.a" )
...
set_target_properties(MaterialXRenderOsl PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/Mac/lib/libMaterialXRenderOsl.a"
  )

list(APPEND _cmake_import_check_targets MaterialXRenderOsl )
list(APPEND _cmake_import_check_files_for_MaterialXRenderOsl "${_IMPORT_PREFIX}/Mac/lib/libMaterialXRenderOsl.a" )
