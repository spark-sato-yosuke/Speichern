...
set_target_properties(MaterialXCore PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/VS2015/x64/lib/MaterialXCore.lib"
  )

list(APPEND _cmake_import_check_targets MaterialXCore )
list(APPEND _cmake_import_check_files_for_MaterialXCore "${_IMPORT_PREFIX}/VS2015/x64/lib/MaterialXCore.lib" )
...
set_target_properties(MaterialXFormat PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/VS2015/x64/lib/MaterialXFormat.lib"
  )

list(APPEND _cmake_import_check_targets MaterialXFormat )
list(APPEND _cmake_import_check_files_for_MaterialXFormat "${_IMPORT_PREFIX}/VS2015/x64/lib/MaterialXFormat.lib" )
...
set_target_properties(MaterialXGenShader PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/VS2015/x64/lib/MaterialXGenShader.lib"
  )

list(APPEND _cmake_import_check_targets MaterialXGenShader )
list(APPEND _cmake_import_check_files_for_MaterialXGenShader "${_IMPORT_PREFIX}/VS2015/x64/lib/MaterialXGenShader.lib" )
...
set_target_properties(MaterialXGenGlsl PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/VS2015/x64/lib/MaterialXGenGlsl.lib"
  )

list(APPEND _cmake_import_check_targets MaterialXGenGlsl )
list(APPEND _cmake_import_check_files_for_MaterialXGenGlsl "${_IMPORT_PREFIX}/VS2015/x64/lib/MaterialXGenGlsl.lib" )
...
set_target_properties(MaterialXGenOsl PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/VS2015/x64/lib/MaterialXGenOsl.lib"
  )

list(APPEND _cmake_import_check_targets MaterialXGenOsl )
list(APPEND _cmake_import_check_files_for_MaterialXGenOsl "${_IMPORT_PREFIX}/VS2015/x64/lib/MaterialXGenOsl.lib" )
...
set_target_properties(MaterialXGenMdl PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/VS2015/x64/lib/MaterialXGenMdl.lib"
  )

list(APPEND _cmake_import_check_targets MaterialXGenMdl )
list(APPEND _cmake_import_check_files_for_MaterialXGenMdl "${_IMPORT_PREFIX}/VS2015/x64/lib/MaterialXGenMdl.lib" )
...
set_target_properties(MaterialXGenMsl PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/VS2015/x64/lib/MaterialXGenMsl.lib"
  )

list(APPEND _cmake_import_check_targets MaterialXGenMsl )
list(APPEND _cmake_import_check_files_for_MaterialXGenMsl "${_IMPORT_PREFIX}/VS2015/x64/lib/MaterialXGenMsl.lib" )
...
set_target_properties(MaterialXRender PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/VS2015/x64/lib/MaterialXRender.lib"
  )

list(APPEND _cmake_import_check_targets MaterialXRender )
list(APPEND _cmake_import_check_files_for_MaterialXRender "${_IMPORT_PREFIX}/VS2015/x64/lib/MaterialXRender.lib" )
...
set_target_properties(MaterialXRenderHw PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/VS2015/x64/lib/MaterialXRenderHw.lib"
  )

list(APPEND _cmake_import_check_targets MaterialXRenderHw )
list(APPEND _cmake_import_check_files_for_MaterialXRenderHw "${_IMPORT_PREFIX}/VS2015/x64/lib/MaterialXRenderHw.lib" )
...
set_target_properties(MaterialXRenderGlsl PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/VS2015/x64/lib/MaterialXRenderGlsl.lib"
  )

list(APPEND _cmake_import_check_targets MaterialXRenderGlsl )
list(APPEND _cmake_import_check_files_for_MaterialXRenderGlsl "${_IMPORT_PREFIX}/VS2015/x64/lib/MaterialXRenderGlsl.lib" )
...
set_target_properties(MaterialXRenderOsl PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/VS2015/x64/lib/MaterialXRenderOsl.lib"
  )

list(APPEND _cmake_import_check_targets MaterialXRenderOsl )
list(APPEND _cmake_import_check_files_for_MaterialXRenderOsl "${_IMPORT_PREFIX}/VS2015/x64/lib/MaterialXRenderOsl.lib" )
