...
# If building OpenEXR version 3.3.2, be sure to apply this patch to disable
# building the website example code. It does not link correctly, but it does
# not get installed anyway.
# From the "openexr-3.3.2" source directory, run:
#     git apply ../openexr_v3.3.2_disable_website_example.patch
...
IMATH_CMAKE_LOCATION="$UE_SOURCE_THIRD_PARTY_LOCATION/Imath/Deploy/Imath-3.1.12/Unix/$ARCH_NAME/lib/cmake/Imath"
