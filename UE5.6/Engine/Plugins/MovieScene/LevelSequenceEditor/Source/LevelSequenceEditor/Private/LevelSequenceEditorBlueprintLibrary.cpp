...
FMovieSceneSequencePlaybackParams ULevelSequenceEditorBlueprintLibrary::GetPlaybackStartPosition(EMovieSceneTimeUnit TimeUnit)
{
	FMovieSceneSequencePlaybackParams Params;
...
FMovieSceneSequencePlaybackParams ULevelSequenceEditorBlueprintLibrary::GetPlaybackEndPosition(EMovieSceneTimeUnit TimeUnit)
{
	FMovieSceneSequencePlaybackParams Params;
