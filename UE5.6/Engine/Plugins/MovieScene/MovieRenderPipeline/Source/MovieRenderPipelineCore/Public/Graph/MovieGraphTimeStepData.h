...
public:
	FMovieGraphTimeStepData()
		...
		, bHasRelativeTimeBeenUsed(false)
		, WorldSeconds(0.f)
	...
	/** True if time dilation was used on this frame, or any in the past, even if WorldTimeDilation has returned to 1.0 */
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = "Movie Graph")
	bool bHasRelativeTimeBeenUsed;
