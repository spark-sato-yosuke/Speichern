...
protected:
	...
	*/
	...
	/**
	* Was the world allowing time dilation before this render started? We'll cache and then restore this value to
	* avoid changing any user settings.
	*/
	bool bPrevWorldAllowTimeDilation = true;
};
