...
public:	
	...
	*/
	...
	DECLARE_MULTICAST_DELEGATE_TwoParams(FOnSequenceSet, UMoviePipelineExecutorJob* Job, ULevelSequence* Sequence);

	/** Retrieve multicast delegate for when a sequence is set. */
