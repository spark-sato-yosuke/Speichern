...
#include "KeysAndChannels/MovieSceneScriptingParticle.h"
...
TArray<UMovieSceneScriptingChannel*> UMovieSceneSectionExtensions::GetAllChannels(UMovieSceneSection* Section)
{
	...
	GetScriptingChannelsForChannel<FMovieSceneParticleChannel, UMovieSceneScriptingParticleChannel>(ChannelProxy, Sequence, Section, Channels);
...
TArray<UMovieSceneScriptingChannel*> UMovieSceneSectionExtensions::GetChannelsByType(UMovieSceneSection* Section, TSubclassOf<UMovieSceneScriptingChannel> ChannelType)
{
	...
	else if (ChannelType == UMovieSceneScriptingParticleChannel::StaticClass()) { GetScriptingChannelsForChannel<FMovieSceneParticleChannel, UMovieSceneScriptingParticleChannel>(ChannelProxy, Sequence, Section, Channels); }
	else
	{
...
UMovieSceneScriptingChannel* UMovieSceneSectionExtensions::GetChannel(UMovieSceneSection* Section, const FName& ChannelName)
{
	...
	else if (ChanneHandle.GetChannelTypeName() == FMovieSceneParticleChannel::StaticStruct()->GetFName())
	{
		return GetScriptingChannelForChannel<FMovieSceneParticleChannel, UMovieSceneScriptingParticleChannel>(MovieSceneChannel, ChannelProxy, ChanneHandle, Sequence, Section, ChannelName);
	}
#endif
