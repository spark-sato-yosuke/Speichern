...
namespace NiagaraParameterBindingCustomizationPrivate
{
	...
	FText GetAllowedBindingTypesText(FNiagaraParameterBinding* ParameterBinding)
	{
		FText BoundTypes;
		BuildTypesText(
			BoundTypes,
...
FText FNiagaraParameterBindingCustomization::GetTooltipText() const
{
	if ( FNiagaraParameterBinding* ParameterBinding = GetParameterBinding() )
	{
		...
		TooltipTexts.Add(NiagaraParameterBindingCustomizationPrivate::GetAllowedBindingTypesText(ParameterBinding));
