...
public:
	...
	void RenderStaticMesh(UTextureRenderTarget2D* RenderTarget, UStaticMesh* StaticMesh) const;
...
private:
	...
	mutable TObjectPtr<UStaticMeshComponent> StaticMeshPreviewComponent = nullptr;
	mutable TSharedPtr<FAdvancedPreviewScene> StaticMeshPreviewScene;
