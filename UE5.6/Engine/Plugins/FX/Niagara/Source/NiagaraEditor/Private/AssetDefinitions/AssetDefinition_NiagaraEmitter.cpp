				...
				{
					{
						...
						const FSlateIcon Icon = FSlateIconFinder::FindIconForClass(UNiagaraSystem::StaticClass());
					...
					}
					{
						...
						const FSlateIcon Icon = FSlateIcon(FAppStyle::GetAppStyleSetName(), "Icons.Duplicate");
					...
					}
					{
						...
						const FSlateIcon Icon = FSlateIcon(FAppStyle::GetAppStyleSetName(), "Icons.DirtyBadge");
