...
TObjectPtr<UObject> FNiagaraCollectionParameterViewModel::GetDefaultValueObjectAsset()
{
	return CollectionInst->GetParameterStore().GetUObject(Parameter);
}

void FNiagaraCollectionParameterViewModel::SetDefaultValueObjectAsset(TObjectPtr<UObject> Object)
{
