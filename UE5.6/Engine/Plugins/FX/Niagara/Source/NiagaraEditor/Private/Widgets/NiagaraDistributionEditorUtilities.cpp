...
FText FNiagaraDistributionEditorUtilities::DistributionModeToDisplayName(ENiagaraDistributionEditorMode InMode)
{
	...
	case ENiagaraDistributionEditorMode::Expression:
		return LOCTEXT("ExpressionDisplayName", "Expression");
...
FText FNiagaraDistributionEditorUtilities::DistributionModeToToolTipText(ENiagaraDistributionEditorMode InMode)
{
	...
	case ENiagaraDistributionEditorMode::Expression:
		return LOCTEXT("ExpressionToolTip", "Value bound to a expression chain.");
	case ENiagaraDistributionEditorMode::Constant:
...
bool FNiagaraDistributionEditorUtilities::IsExpression(ENiagaraDistributionEditorMode InMode)
{
	return
		InMode == ENiagaraDistributionEditorMode::Expression;
}
