...
const FName SNiagaraGraphActionMenu::FavoriteActionsProfile = FName("NiagaraGraphActions");
		...
		[
            ...
            [   
				...
				[
					...
					{
						return FNiagaraEditorUtilities::GetWeightForItem(InCurrentAction, SNiagaraGraphActionMenu::FavoriteActionsProfile, InFilterTerms);
					})
					...
					.OnItemRowHoverEvent_Lambda([](const TSharedPtr<FNiagaraAction_NewNode>& Item, bool bHover)
					{
...
{	
	...
	{
		FNiagaraFavoriteActionsProfile& ActionsProfile = UNiagaraFavoriteActionsConfig::Get()->GetActionsProfile(SNiagaraGraphActionMenu::FavoriteActionsProfile);
		TOptional<bool> bIsFavorite = ActionsProfile.IsFavorite(Item->FavoritesActionData.GetValue());
		if(bIsFavorite.IsSet() && bIsFavorite.GetValue())
		{
...
TSharedRef<SWidget> SNiagaraGraphActionMenu::OnGenerateWidgetForItem(const TSharedPtr<FNiagaraAction_NewNode>& Item)
{
	...
	ActionData.FavoriteActionsProfileName = SNiagaraGraphActionMenu::FavoriteActionsProfile;
