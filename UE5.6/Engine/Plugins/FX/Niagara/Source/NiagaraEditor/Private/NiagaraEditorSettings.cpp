...
FLinearColor UNiagaraEditorSettings::GetDefaultNoteColor() const
{
...
EGraphZoomLimitHandling UNiagaraEditorSettings::GetScriptEditorZoomLimitHandling() const
{
	return ScriptGraphZoomLimitHandling;
}
