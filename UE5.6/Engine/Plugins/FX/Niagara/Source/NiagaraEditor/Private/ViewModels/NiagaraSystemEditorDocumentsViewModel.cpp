...
void UNiagaraSystemEditorDocumentsViewModel::InitializePreTabManager(TSharedPtr<FNiagaraSystemToolkit> InToolkit)
{
	...
	// Register the document factories
	{
		...
		TSharedRef<FDocumentTabFactory> GraphEditorFactory = MakeShared<FDocumentTabFactory_NiagaraScratchPad>(
			InToolkit,
			FDocumentTabFactory_NiagaraScratchPad::FOnCreateGraphEditorWidget::CreateUObject(this, &UNiagaraSystemEditorDocumentsViewModel::CreateGraphEditorWidget)
		);
