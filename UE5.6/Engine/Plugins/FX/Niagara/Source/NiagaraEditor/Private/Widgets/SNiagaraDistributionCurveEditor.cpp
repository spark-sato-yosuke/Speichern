				...
				[
					SNew(SHorizontalBox)
						...
						[
							SNew(SButton)
								.ButtonStyle(FAppStyle::Get(), "SimpleButton")
								.OnClicked(this, &SNiagaraDistributionCurveEditor::FlipCurve, ECurveFlipDirection::Horizontal)
						...
						[
							SNew(SButton)
								.ButtonStyle(FAppStyle::Get(), "SimpleButton")
								.OnClicked(this, &SNiagaraDistributionCurveEditor::FlipCurve, ECurveFlipDirection::Vertical)
...
FReply SNiagaraDistributionCurveEditor::FlipCurve(ECurveFlipDirection Direction)
{
