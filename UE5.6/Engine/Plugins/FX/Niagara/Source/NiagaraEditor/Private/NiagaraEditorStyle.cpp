...
void FNiagaraEditorStyle::InitParameters()
{
	...
	Set("NiagaraEditor.Verse.Private",	new IMAGE_BRUSH_SVG("Icons/Verse_Icon", Icon20x20, FLinearColor(0.2f, 0.2f, 0.2f)));
	Set("NiagaraEditor.Verse.Public",	new IMAGE_BRUSH_SVG("Icons/Verse_Icon", Icon20x20, FLinearColor(1.0f, 1.0f, 1.0f)));
}
...
{
	Set("NiagaraEditor.ToggleOriginAxis", new IMAGE_BRUSH_SVG("Icons/OriginAxis_16", Icon16x16));
...
void FNiagaraEditorStyle::InitStackWidgets()
{
	...
	NoteHeaderStyle.SetFont(DEFAULT_FONT("Regular", 11.f));
...
void FNiagaraEditorStyle::InitScriptGraph()
{
	...
	Set("NiagaraEditor.ScriptGraph.SearchBoxStyle", SearchBoxStyle);
}
