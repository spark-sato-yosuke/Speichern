...
public:
	...
	NIAGARAEDITOR_API virtual bool SupportsDebugDraw() const override;
	NIAGARAEDITOR_API virtual TOptional<FText> GetDebugDrawTooltip() const override;
	NIAGARAEDITOR_API virtual bool IsDebugDrawEnabled() const override;
	NIAGARAEDITOR_API virtual void SetDebugDrawEnabled(bool bInEnabled) override;
