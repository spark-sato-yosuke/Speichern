...
public:
	...
	UHierarchyRoot* GetSummaryRoot() const { return SummaryViewRoot; }
	const TArray<UHierarchySection*>& GetSummarySections() const;
...
private:
	...
	UPROPERTY()
	TObjectPtr<UHierarchyRoot> SummaryViewRoot = nullptr;
