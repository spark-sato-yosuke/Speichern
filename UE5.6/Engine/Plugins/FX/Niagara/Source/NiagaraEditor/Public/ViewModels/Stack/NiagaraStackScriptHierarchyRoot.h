...
public:
	...
	NIAGARAEDITOR_API const TArray<UHierarchySection*>& GetSections() const;
	NIAGARAEDITOR_API const UHierarchySection* GetActiveSection() const;
	NIAGARAEDITOR_API void SetActiveSection(const UHierarchySection* InActiveSection);
