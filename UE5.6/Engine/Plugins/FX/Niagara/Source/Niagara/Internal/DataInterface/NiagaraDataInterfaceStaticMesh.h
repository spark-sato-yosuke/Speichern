...
public:
	...
	NIAGARA_API UStaticMesh* ResolveStaticMesh(UObject*& OutComponent, class FNiagaraSystemInstance* SystemInstance = nullptr, UObject* ParameterBindingValue = nullptr) const;
