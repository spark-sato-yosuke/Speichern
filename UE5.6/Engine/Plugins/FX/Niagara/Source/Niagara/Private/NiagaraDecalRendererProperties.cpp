...
namespace NiagaraDecalRendererPropertiesLocal
{
	...
	static void SetupBindings(UNiagaraDecalRendererProperties* Props)
	{
		...
		Props->DecalOrientationBinding.Setup(UNiagaraDecalRendererProperties::GetDecalOrientationVariable(), UNiagaraDecalRendererProperties::GetDecalOrientationVariable());
		Props->DecalSizeBinding.Setup(UNiagaraDecalRendererProperties::GetDecalSizeVariable(), UNiagaraDecalRendererProperties::GetDecalSizeVariable());
		Props->DecalFadeBinding.Setup(UNiagaraDecalRendererProperties::GetDecalFadeVariable(), UNiagaraDecalRendererProperties::GetDecalFadeVariable());
		...
		Props->DecalVisibleBinding.Setup(UNiagaraDecalRendererProperties::GetDecalVisibleVariable(), UNiagaraDecalRendererProperties::GetDecalVisibleVariable());
...
FNiagaraVariable UNiagaraDecalRendererProperties::GetDecalOrientationVariable()
{
	using namespace NiagaraDecalRendererPropertiesLocal;
...
FNiagaraVariable UNiagaraDecalRendererProperties::GetDecalSizeVariable()
{
	using namespace NiagaraDecalRendererPropertiesLocal;
...
FNiagaraVariable UNiagaraDecalRendererProperties::GetDecalFadeVariable()
{
	using namespace NiagaraDecalRendererPropertiesLocal;
...
FNiagaraVariable UNiagaraDecalRendererProperties::GetDecalVisibleVariable()
{
	using namespace NiagaraDecalRendererPropertiesLocal;
