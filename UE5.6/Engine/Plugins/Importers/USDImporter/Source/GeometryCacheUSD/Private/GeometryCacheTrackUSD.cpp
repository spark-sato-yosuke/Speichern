...
bool UGeometryCacheTrackUsd::LoadUsdStage()
{
	...
	USD_LOG_WARNING(TEXT("UGeometryCacheTrackUsd track failed to access USD stage to stream requested frames"));
	return false;
}
...
)
{
	...
	{
		USD_LOG_WARNING(TEXT("Invalid USD GeometryCache FPS detected. Falling back to 1 FPS"));
		FramesPerSecond = 1;
	}
