...
FString UUsdConversionBlueprintLibrary::GetPrimPathForObject(
...
void UUsdConversionBlueprintLibrary::BeginUniquePathScope()
{
	UsdUnreal::ExportUtils::BeginUniquePathScope();
}

void UUsdConversionBlueprintLibrary::EndUniquePathScope()
{
	UsdUnreal::ExportUtils::EndUniquePathScope();
}

FString UUsdConversionBlueprintLibrary::GetUniqueFilePathForExport(const FString& DesiredPathWithExtension)
{
