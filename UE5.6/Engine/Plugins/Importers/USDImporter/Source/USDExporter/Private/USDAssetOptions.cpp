...
void UsdUtils::AddAnalyticsAttributes(const FUsdMaterialBakingOptions& Options, TArray<FAnalyticsEventAttribute>& InOutAttributes)
{
...
void UsdUtils::AddAnalyticsAttributes(const FUsdMeshAssetOptions& Options, TArray<FAnalyticsEventAttribute>& InOutAttributes)
{
...
{
	HashToUpdate.Update(reinterpret_cast<const uint8*>(Options.Properties.GetData()), Options.Properties.Num() * Options.Properties.GetTypeSize());

	HashToUpdate.Update(reinterpret_cast<const uint8*>(&Options.DefaultTextureSize), sizeof(Options.DefaultTextureSize));

	HashToUpdate.Update(reinterpret_cast<const uint8*>(&Options.bConstantColorAsSingleValue), sizeof(Options.bConstantColorAsSingleValue));
...
void UsdUtils::HashForMeshExport(const FUsdMeshAssetOptions& Options, FSHA1& HashToUpdate)
{
	...
	HashToUpdate.Update(reinterpret_cast<const uint8*>(&Options.bBakeMaterials), sizeof(Options.bBakeMaterials));
