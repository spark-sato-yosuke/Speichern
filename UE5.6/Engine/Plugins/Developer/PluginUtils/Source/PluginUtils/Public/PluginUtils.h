...
public:
	 ...
	 */
	static FString GetPluginFolder(const FString& PluginFilePath, bool bFullPath = false);
	 ...
	 * @param PluginFilePath Plugin descriptor file path
	 */
	static FString GetPluginName(const FString& PluginFilePath);
	 ...
	 * @param PluginFilePath Plugin descriptor file path
	 */
	static FString GetPluginContentFolder(const FString& PluginFilePath, bool bFullPath = false);
	 ...
	 * @param PluginFilePath Plugin descriptor file path
	 */
	static FString GetPluginResourcesFolder(const FString& PluginFilePath, bool bFullPath = false);
	 ...
	 */
	static TSharedPtr<IPlugin> CreateAndLoadNewPlugin(const FString& PluginFilePath, const FNewPluginParams& CreationParams, FLoadPluginParams& LoadParams);
	 ...
	 * @note This function can circumvent the standard plugin directory structure, in which case the newly created plugin may also need to be loaded by full path
	 */
	static TSharedPtr<IPlugin> CreateAndLoadNewPlugin(const FString& PluginFilePath, const FNewPluginParamsWithDescriptor& CreationParams, FLoadPluginParams& LoadParams);
	 ...
	 * @return The loaded plugin or null on failure
	 */
	static TSharedPtr<IPlugin> LoadPlugin(const FString& PluginFilePath, FLoadPluginParams& LoadParams);
	 ...
	 * @return
	 */
	static bool ValidateNewPluginFilePath(const FString& PluginFilePath, FText* FailReason = nullptr);
