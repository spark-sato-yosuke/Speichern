...
class FPerforceRevisionInfoWorker final : public IPerforceSourceControlWorker
{
public:
	FPerforceRevisionInfoWorker(FPerforceSourceControlProvider& InSourceControlProvider)
		: IPerforceSourceControlWorker(InSourceControlProvider)
	{}
	virtual ~FPerforceRevisionInfoWorker() = default;
