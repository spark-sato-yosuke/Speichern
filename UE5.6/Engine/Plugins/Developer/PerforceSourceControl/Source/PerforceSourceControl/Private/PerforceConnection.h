...
public:
	...
	// When OutResultInfo is set, errors encountered will be added to it and when not set (nullptr) errors will be logged immediately
	FPerforceConnection(const FPerforceConnectionInfo& InConnectionInfo, FPerforceSourceControlProvider& InSCCProvider, FSourceControlResultInfo* OutResultInfo);
	 ...
	 * @param InConnectionInfo		Connection credentials
	 * @param OutResultInfo Optional structure to store errors encountered while establishing the connection.
	 *                      When set to nullptr, errors will be immediately logged.
	 */
	void EstablishConnection(const FPerforceConnectionInfo& InConnectionInfo, FSourceControlResultInfo* OutResultInfo);
...
private:
	...
	void Initialize(const FPerforceConnectionInfo& InConnectionInfo, FPerforceSourceControlProvider& SCCProvider, FSourceControlResultInfo* OutResultInfo);
