...
{
	BEGIN_DEFINE_SPEC(FDirtyPackageOnReplication, "Editor.Concert.Replication.DirtyPackageOnReplication", EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)
		UPackage* Package;
