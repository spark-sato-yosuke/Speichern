...
#include "h265/VideoDecoderH265_JavaWrapper_Android.h"
...
class FElectraVideoDecoderH265_Android;


class FElectraDecoderDefaultVideoOutputFormatH265_Android : public IElectraDecoderDefaultVideoOutputFormat
{
public:
	virtual ~FElectraDecoderDefaultVideoOutputFormatH265_Android()
	{ }
};


class FElectraVideoDecoderOutputH265_Android : public IElectraDecoderVideoOutput
{
public:
	virtual ~FElectraVideoDecoderOutputH265_Android()
	{
		ReleaseOutputBuffer();
	}
...
class FElectraVideoDecoderH265_Android : public IElectraVideoDecoderH265_Android
{
public:
	FElectraVideoDecoderH265_Android(const TMap<FString, FVariant>& InOptions, TSharedPtr<IElectraDecoderResourceDelegate, ESPMode::ThreadSafe> InResourceDelegate);

	virtual ~FElectraVideoDecoderH265_Android();
	...
	void ReleaseOutputBuffer(const IElectraH265VideoDecoderAndroidJava::FOutputBufferInfo* InBufferInfo, bool bInRender, int64 InReleaseAt);
...
private:
	...
	{
	public:
		FBufferReleaseCallback(TWeakPtr<FElectraVideoDecoderH265_Android, ESPMode::ThreadSafe> InOwningDecoder)
	...
	struct FDecoderInput
	{
		...
		TSharedPtr<ElectraDecodersUtil::MPEG::H265::FSequenceParameterSet, ESPMode::ThreadSafe> SPS;
	};
	...
	TSharedPtr<ElectraDecodersUtil::MPEG::H265::FHEVCDecoderConfigurationRecord, ESPMode::ThreadSafe> GetDCRFromOptions(const TMap<FString, FVariant>& InOptions);
	TSharedPtr<ElectraDecodersUtil::MPEG::H265::FSequenceParameterSet, ESPMode::ThreadSafe> GetSPSFromOptions(const TMap<FString, FVariant>& InOptions);
	...
	EConvertResult ConvertDecoderOutput(const IElectraH265VideoDecoderAndroidJava::FOutputBufferInfo& InInfo);
	...
	TSharedPtr<ElectraDecodersUtil::MPEG::H265::FHEVCDecoderConfigurationRecord, ESPMode::ThreadSafe> ConfigRecord;
	TSharedPtr<ElectraDecodersUtil::MPEG::H265::FSequenceParameterSet, ESPMode::ThreadSafe> CurrentSPS;
	TSharedPtr<FElectraVideoDecoderOutputH265_Android, ESPMode::ThreadSafe> CurrentOutput;
	TArray<TSharedPtr<FDecoderInput, ESPMode::NotThreadSafe>> InDecoderInput;

	TSharedPtr<IElectraH265VideoDecoderAndroidJava, ESPMode::ThreadSafe> DecoderInstance;
	IElectraH265VideoDecoderAndroidJava::FDecoderInformation DecoderInfo;
	TArray<IElectraH265VideoDecoderAndroidJava::FOutputBufferInfo> PendingDecoderOutputBuffers;
...
std::atomic<uint32>  FElectraVideoDecoderH265_Android::NextNativeDecoderID { 0 };


namespace IElectraVideoDecoderH265_Android_Platform
{
	static TArray<IElectraVideoDecoderH265_Android::FSupportedConfiguration> DecoderConfigurations;
	static bool bDecoderConfigurationsDirty = true;
}

void IElectraVideoDecoderH265_Android::PlatformGetSupportedConfigurations(TArray<FSupportedConfiguration>& OutSupportedConfigurations)
{
	if (IElectraVideoDecoderH265_Android_Platform::bDecoderConfigurationsDirty)
	{
		IElectraVideoDecoderH265_Android_Platform::DecoderConfigurations.Empty();
		...
		// Main
		IElectraVideoDecoderH265_Android_Platform::DecoderConfigurations.Emplace(IElectraVideoDecoderH265_Android::FSupportedConfiguration(0, 1, 0, 153, 60, 4096, 2304, 0));
		IElectraVideoDecoderH265_Android_Platform::DecoderConfigurations.Emplace(IElectraVideoDecoderH265_Android::FSupportedConfiguration(0, 1, 0, 153, 0, 0, 0, (3840 / 8) * (2160 / 8) * 60));
		// Main10
		IElectraVideoDecoderH265_Android_Platform::DecoderConfigurations.Emplace(IElectraVideoDecoderH265_Android::FSupportedConfiguration(0, 2, 0, 153, 60, 4096, 2304, 0));
		IElectraVideoDecoderH265_Android_Platform::DecoderConfigurations.Emplace(IElectraVideoDecoderH265_Android::FSupportedConfiguration(0, 2, 0, 153, 0, 0, 0, (3840 / 8) * (2160 / 8) * 60));

		IElectraVideoDecoderH265_Android_Platform::bDecoderConfigurationsDirty = false;
	}
	OutSupportedConfigurations = IElectraVideoDecoderH265_Android_Platform::DecoderConfigurations;
}

void IElectraVideoDecoderH265_Android::GetConfigurationOptions(TMap<FString, FVariant>& OutOptions)
{
...
TSharedPtr<IElectraDecoder, ESPMode::ThreadSafe> IElectraVideoDecoderH265_Android::Create(const TMap<FString, FVariant>& InOptions, TSharedPtr<IElectraDecoderResourceDelegate, ESPMode::ThreadSafe> InResourceDelegate)
{
	if (InResourceDelegate)
	{
		TSharedPtr<FElectraVideoDecoderH265_Android, ESPMode::ThreadSafe> New = MakeShared<FElectraVideoDecoderH265_Android>(InOptions, InResourceDelegate);
		return New;
	}
	return nullptr;
}
...
FElectraVideoDecoderH265_Android::FElectraVideoDecoderH265_Android(const TMap<FString, FVariant>& InOptions, TSharedPtr<IElectraDecoderResourceDelegate, ESPMode::ThreadSafe> InResourceDelegate)
	: InitialCreationOptions(InOptions)
{
	...
	if (Var)
	{
		...
		if (Var->GetType() == EVariantTypes::String && ElectraDecodersUtil::ParseCodecH265(ci, Var->GetValue<FString>()))
		{
...
FElectraVideoDecoderH265_Android::~FElectraVideoDecoderH265_Android()
{
...
TSharedPtr<ElectraDecodersUtil::MPEG::H265::FHEVCDecoderConfigurationRecord, ESPMode::ThreadSafe> FElectraVideoDecoderH265_Android::GetDCRFromOptions(const TMap<FString, FVariant>& InOptions)
{
	TArray<uint8> SidebandData = ElectraDecodersUtil::GetVariantValueUInt8Array(InOptions, TEXT("dcr"));
	if (SidebandData.Num())
	{
		TSharedPtr<ElectraDecodersUtil::MPEG::H265::FHEVCDecoderConfigurationRecord, ESPMode::ThreadSafe> NewConfigRecord;
		NewConfigRecord = MakeShared<ElectraDecodersUtil::MPEG::H265::FHEVCDecoderConfigurationRecord, ESPMode::ThreadSafe>();
		if (NewConfigRecord->Parse(SidebandData))
		{
...
TSharedPtr<ElectraDecodersUtil::MPEG::H265::FSequenceParameterSet, ESPMode::ThreadSafe> FElectraVideoDecoderH265_Android::GetSPSFromOptions(const TMap<FString, FVariant>& InOptions)
{
	...
	if (SidebandData.Num())
	{
		...
		ElectraDecodersUtil::MPEG::H265::ParseBitstreamForNALUs(NALUs, SidebandData.GetData(), SidebandData.Num());
		for(int32 i=0; i<NALUs.Num(); ++i)
		{
			if (NALUs[i].Type == 33)
			{
				TSharedPtr<ElectraDecodersUtil::MPEG::H265::FSequenceParameterSet, ESPMode::ThreadSafe> NewSPS = MakeShared<ElectraDecodersUtil::MPEG::H265::FSequenceParameterSet, ESPMode::ThreadSafe>();
				if (ElectraDecodersUtil::MPEG::H265::ParseSequenceParameterSet(*NewSPS, ElectraDecodersUtil::AdvancePointer(SidebandData.GetData(), NALUs[i].Offset + NALUs[i].UnitLength), NALUs[i].Size))
				{
					return NewSPS;
				}
				else
...
void FElectraVideoDecoderH265_Android::GetFeatures(TMap<FString, FVariant>& OutFeatures) const
{
...
IElectraDecoder::FError FElectraVideoDecoderH265_Android::GetError() const
{
	return LastError;
}


void FElectraVideoDecoderH265_Android::Close()
{
	ResetToCleanStart();
...
IElectraDecoder::ECSDCompatibility FElectraVideoDecoderH265_Android::IsCompatibleWith(const TMap<FString, FVariant>& CSDAndAdditionalOptions)
{
	...
	TSharedPtr<ElectraDecodersUtil::MPEG::H265::FSequenceParameterSet, ESPMode::ThreadSafe> NewSPS = GetSPSFromOptions(CSDAndAdditionalOptions);
	if (!NewSPS.IsValid())
	{
...
bool FElectraVideoDecoderH265_Android::ResetToCleanStart()
{
	DETAILLOG(LogElectraDecoders, Log, TEXT("VideoDecoderH265::ResetToCleanStart()"));
...
TSharedPtr<IElectraDecoderDefaultOutputFormat, ESPMode::ThreadSafe> FElectraVideoDecoderH265_Android::GetDefaultOutputFormatFromCSD(const TMap<FString, FVariant>& CSDAndAdditionalOptions)
{
	return nullptr;
}


IElectraDecoder::EDecoderError FElectraVideoDecoderH265_Android::DecodeAccessUnit(const FInputAccessUnit& InInputAccessUnit, const TMap<FString, FVariant>& InAdditionalOptions)
{
	...
	{
		DETAILLOG(LogElectraDecoders, Log, TEXT("VideoDecoderH265::DecodeAccessUnit() - require new decoder, destroying..."));
		InternalDecoderDestroy();
	}
	if (!DecoderInstance.IsValid())
	{
	...
	if (InInputAccessUnit.Data && InInputAccessUnit.DataSize)
	{
		...
		if (InputBufferIndex >= 0)
		{
			...
			DETAILLOG(LogElectraDecoders, Log, TEXT("VideoDecoderH265::DecodeAccessUnit() - queue input %lld, 0x%x"), (long long int)InInputAccessUnit.PTS.GetTicks(), InInputAccessUnit.Flags);
			if (Result == 0)
			{
...
IElectraDecoder::EDecoderError FElectraVideoDecoderH265_Android::SendEndOfData()
{
	DETAILLOG(LogElectraDecoders, Log, TEXT("VideoDecoderH265::SendEndOfData()"));
	// If already in error do nothing!
	if (LastError.IsSet())
	{
		return IElectraDecoder::EDecoderError::Error;
	...
	if (DecodeState == EDecodeState::Draining)
	{
		DETAILLOG(LogElectraDecoders, Log, TEXT("VideoDecoderH265::SendEndOfData() - already sent"));
		return IElectraDecoder::EDecoderError::EndOfData;
	}
...
IElectraDecoder::EDecoderError FElectraVideoDecoderH265_Android::Flush()
{
	DETAILLOG(LogElectraDecoders, Log, TEXT("VideoDecoderH265::Flush()"));
	// If already in error do nothing!
	if (LastError.IsSet())
	{
		return IElectraDecoder::EDecoderError::Error;
...
IElectraDecoder::EOutputStatus FElectraVideoDecoderH265_Android::HaveOutput()
{
	// If already in error do nothing!
	if (LastError.IsSet())
	{
	...
	{
		DETAILLOG(LogElectraDecoders, Log, TEXT("VideoDecoderH265::HaveOutput() -> Have"));
		return IElectraDecoder::EOutputStatus::Available;
	}

	if (bNewDecoderRequired || !DecoderInstance.IsValid())
	{
		DETAILLOG(LogElectraDecoders, Log, TEXT("VideoDecoderH265::HaveOutput() no / need new decoder"));
	...
	if (DecodeState == EDecodeState::Draining && !bDidSendEOS)
	{
		int32 Result = -1;
		int32 InputBufferIndex = DecoderInstance->DequeueInputBuffer(0);
		DETAILLOG(LogElectraDecoders, Log, TEXT("VideoDecoderH265::HaveOutput() Sending EOS"));
		if (InputBufferIndex >= 0)
		{
	...
	while(1)
	{
		IElectraH265VideoDecoderAndroidJava::FOutputBufferInfo OutputBufferInfo;
		...
		if (OutputBufferInfo.BufferIndex >= 0)
		{
			...
			{
				DETAILLOG(LogElectraDecoders, Log, TEXT("VideoDecoderH265::HaveOutput() got EOS, %d still in?"), InDecoderInput.Num());
		...
		else if (OutputBufferInfo.BufferIndex == IElectraH265VideoDecoderAndroidJava::FOutputBufferInfo::EBufferIndexValues::MediaCodec_INFO_TRY_AGAIN_LATER)
		{
			if (DecodeState == EDecodeState::Draining)
			{
				DETAILLOG(LogElectraDecoders, Log, TEXT("VideoDecoderH265::HaveOutput() - DRAINING - TRY AGAIN LATER!?!"));
				return IElectraDecoder::EOutputStatus::TryAgainLater;
			}
			DETAILLOG(LogElectraDecoders, Log, TEXT("VideoDecoderH265::HaveOutput() - TRY AGAIN LATER!?!"));
			return IElectraDecoder::EOutputStatus::NeedInput;
		}
		else if (OutputBufferInfo.BufferIndex == IElectraH265VideoDecoderAndroidJava::FOutputBufferInfo::EBufferIndexValues::MediaCodec_INFO_OUTPUT_FORMAT_CHANGED)
		{
			// Not needed.
		}
		else if (OutputBufferInfo.BufferIndex == IElectraH265VideoDecoderAndroidJava::FOutputBufferInfo::EBufferIndexValues::MediaCodec_INFO_OUTPUT_BUFFERS_CHANGED)
		{
...
TSharedPtr<IElectraDecoderOutput, ESPMode::ThreadSafe> FElectraVideoDecoderH265_Android::GetOutput()
{
...
void FElectraVideoDecoderH265_Android::Suspend()
{
	DETAILLOG(LogElectraDecoders, Log, TEXT("VideoDecoderH265::Suspend()"));
}


void FElectraVideoDecoderH265_Android::Resume()
{
	DETAILLOG(LogElectraDecoders, Log, TEXT("VideoDecoderH265::Resume()"));
	// Increment the resume counter to re-create the decoder.
	++CurrentResumeCount;
}


bool FElectraVideoDecoderH265_Android::PostError(int32 ApiReturnValue, FString Message, int32 Code)
{
	LastError.Code = Code;
...
bool FElectraVideoDecoderH265_Android::InternalDecoderCreate()
{
	bDidSendEOS = false;
...
bool FElectraVideoDecoderH265_Android::InternalHandleDecoderCreate()
{
...
bool FElectraVideoDecoderH265_Android::InternalFinishDecoderCreate()
{
	if (CurrentSurfaceRequest.IsValid())
	{
		DecoderInstance = IElectraH265VideoDecoderAndroidJava::Create();
		...
		if (ConfigRecord.IsValid())
		{
			if (ensure(!ConfigRecord->GetParsedSequenceParameterSets().IsEmpty()))
			{
				const ElectraDecodersUtil::MPEG::H265::FSequenceParameterSet& SPS = ConfigRecord->GetParsedSequenceParameterSets()[0];
				if (SPS.GetWidth() > Width || SPS.GetHeight() > Height || SPS.profile_tier_level.general_profile_idc > ProfileIdc || SPS.profile_tier_level.general_level_idc > LevelIdc)
				{
					Width = SPS.GetWidth();
					Height = SPS.GetHeight();
					ProfileIdc = SPS.profile_tier_level.general_profile_idc;
					LevelIdc = SPS.profile_tier_level.general_level_idc;
				}
			}
		}
		...
		IElectraH265VideoDecoderAndroidJava::FCreateParameters cp;
		cp.CodecData = ConfigRecord.Get();
		cp.MaxWidth = Width;
		cp.MaxHeight = Height;
		cp.MaxTier = 1;					// not currently used, set to 1 (high tier)
		...
		const IElectraH265VideoDecoderAndroidJava::FDecoderInformation* DecInf = DecoderInstance->GetDecoderInformation();
		if (!DecInf)
		{
		...
		if (PlatformResource)
		{
			CurrentBufferReleaseCallback = MakeShared<FBufferReleaseCallback, ESPMode::ThreadSafe>(StaticCastWeakPtr<FElectraVideoDecoderH265_Android>(AsWeak()));
...
bool FElectraVideoDecoderH265_Android::InternalDecoderDrain()
{
	bDidSendEOS = false;
	return true;
}
...
void FElectraVideoDecoderH265_Android::InternalDecoderDestroy()
{
	DETAILLOG(LogElectraDecoders, Log, TEXT("VideoDecoderH265::InternalDecoderDestroy()"));
	if (DecoderInstance.IsValid())
	{
		CurrentBufferReleaseCallback.Reset();
		CurrentSurfaceRequest.Reset();
...
void FElectraVideoDecoderH265_Android::ReleaseOutputBuffer(const IElectraH265VideoDecoderAndroidJava::FOutputBufferInfo* InBufferInfo, bool bInRender, int64 InReleaseAt)
{
...
bool FElectraVideoDecoderH265_Android::HavePendingOutputIndex(int32 InIndex, bool bRemoveIfExists)
{
...
FElectraVideoDecoderH265_Android::EConvertResult FElectraVideoDecoderH265_Android::ConvertDecoderOutput(const IElectraH265VideoDecoderAndroidJava::FOutputBufferInfo& InInfo)
{
	DETAILLOG(LogElectraDecoders, Log, TEXT("VideoDecoderH265::ConvertDecoderOutput()"));
	...
	{
		DETAILLOG(LogElectraDecoders, Log, TEXT("VideoDecoderH265::ConvertDecoderOutput() - Discard replay output %lld, 0x%x"), (long long int)In->AccessUnit.PTS.GetTicks(), In->AccessUnit.Flags);
		if (DecoderInstance.IsValid())
		{
	...
	DETAILLOG(LogElectraDecoders, Log, TEXT("VideoDecoderH265::ConvertDecoderOutput() - Convert output %lld, 0x%x"), (long long int)In->AccessUnit.PTS.GetTicks(), In->AccessUnit.Flags);

	TSharedPtr<FElectraVideoDecoderOutputH265_Android, ESPMode::ThreadSafe> NewOutput = MakeShared<FElectraVideoDecoderOutputH265_Android>();
	...
	ElectraDecodersUtil::FFractionalValue fr(In->SPS->GetTiming());
	if (fr.Denom)
	{
		NewOutput->FrameRateN = fr.Num;
		NewOutput->FrameRateD = fr.Denom;
	}

	NewOutput->OwningDecoder = StaticCastWeakPtr<FElectraVideoDecoderH265_Android>(AsWeak());
...
void FElectraVideoDecoderOutputH265_Android::ReleaseOutputBuffer()
{
