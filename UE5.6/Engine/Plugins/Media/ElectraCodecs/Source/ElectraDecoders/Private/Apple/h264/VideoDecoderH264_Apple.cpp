...
TSharedPtr<ElectraDecodersUtil::MPEG::H264::FSequenceParameterSet, ESPMode::ThreadSafe> FElectraVideoDecoderH264_Apple::GetSPSFromOptions(const TMap<FString, FVariant>& InOptions)
{
