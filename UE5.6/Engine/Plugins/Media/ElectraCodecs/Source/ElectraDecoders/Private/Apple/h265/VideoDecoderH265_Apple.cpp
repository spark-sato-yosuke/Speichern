...
void IElectraVideoDecoderH265_Apple::PlatformGetSupportedConfigurations(TArray<FSupportedConfiguration>& OutSupportedConfigurations)
{
	if (IElectraVideoDecoderH265_Apple_Platform::bDecoderConfigurationsDirty)
	{
		...
		// What is really supported isn't quite clear so allow for 4K.
...
TSharedPtr<ElectraDecodersUtil::MPEG::H265::FSequenceParameterSet, ESPMode::ThreadSafe> FElectraVideoDecoderH265_Apple::GetSPSFromOptions(const TMap<FString, FVariant>& InOptions)
{
