...
TSharedPtr<ElectraDecodersUtil::MPEG::H265::FHEVCDecoderConfigurationRecord, ESPMode::ThreadSafe> FElectraVideoDecoderH265_Linux::GetDCRFromOptions(const TMap<FString, FVariant>& InOptions)
{
...
TSharedPtr<ElectraDecodersUtil::MPEG::H265::FSequenceParameterSet, ESPMode::ThreadSafe> FElectraVideoDecoderH265_Linux::GetSPSFromOptions(const TMap<FString, FVariant>& InOptions)
{
