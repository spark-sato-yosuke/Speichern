...
void IElectraVideoDecoderH264_DX::PlatformGetSupportedConfigurations(TArray<FSupportedConfiguration>& OutSupportedConfigurations)
{
	if (IElectraVideoDecoderH264_DX_Platform::bDecoderConfigurationsDirty)
	{
		...
		// Baseline
		IElectraVideoDecoderH264_DX_Platform::DecoderConfigurations.Emplace(IElectraVideoDecoderH264_DX::FSupportedConfiguration(66, 52, 120, 4096, 2304, 0 /*1280*720 / 256*/));
		// Main
		IElectraVideoDecoderH264_DX_Platform::DecoderConfigurations.Emplace(IElectraVideoDecoderH264_DX::FSupportedConfiguration(77, 52, 120, 4096, 2304, 0 /*1280*720 / 256*/));
		// High
		IElectraVideoDecoderH264_DX_Platform::DecoderConfigurations.Emplace(IElectraVideoDecoderH264_DX::FSupportedConfiguration(100, 52, 120, 4096, 2304, 0 /*1280*720 / 256*/));
