...
namespace Electra
{
	...
	//! (bool) false (default) to emit the first decoded video frame while prerolling so it can be displayed while scrubbing, true to not display it right away.
	const FName OptionKeyHoldBackFirstVideoFrame(TEXT("hold_back_first_frame"));
