...
namespace Electra
{
	...
	namespace HTTP
	{
		enum EStatusErrorCode
		{
			ERRCODE_OK = 0,
			ERRCODE_HTTP_CONNECTION_TIMEOUT = 1,
			ERRCODE_HTTP_RETURNED_ERROR = 2,
			ERRCODE_WRITE_ERROR = 3,
			ERRCODE_HTTP_RANGE_ERROR = 4,
			ERRCODE_HTTP_FILE_COULDNT_READ_FILE = 5,
			ERRCODE_HTTPMODULE_FAILURE = 100
		};
