...
public:
	...
	TSharedPtr<IElectraDecoderBitstreamProcessor, ESPMode::ThreadSafe> CreateBitstreamProcessor() override
	{
		...
		return FElectraDecoderBitstreamProcessorGenericVideo::Create(DecoderFeatures, InitialCreationOptions);
	}
...
public:
	...
	int32 SupportsFormat(TMap<FString, FVariant>& OutFormatInfo, const FString& InCodecFormat, bool bInEncoder, const TMap<FString, FVariant>& InOptions) const override
	{
		...
		switch((uint32)ElectraDecodersUtil::GetVariantValueSafeU64(InOptions, TEXT("codec_4cc"), 0))
		{
			...
			{
				OutFormatInfo.Emplace(IElectraDecoderFormatInfo::HumanReadableFormatName, FVariant(FString(TEXT("Apple ProRes 422 High Quality"))));
				break;
			}
			case Make4CC('a','p','c','n'):
			{
				OutFormatInfo.Emplace(IElectraDecoderFormatInfo::HumanReadableFormatName, FVariant(FString(TEXT("Apple ProRes 422 Standard Definition"))));
				break;
			}
			case Make4CC('a','p','c','s'):
			{
				OutFormatInfo.Emplace(IElectraDecoderFormatInfo::HumanReadableFormatName, FVariant(FString(TEXT("Apple ProRes 422 LT"))));
				break;
			}
			case Make4CC('a','p','c','o'):
			{
				OutFormatInfo.Emplace(IElectraDecoderFormatInfo::HumanReadableFormatName, FVariant(FString(TEXT("Apple ProRes 422 Proxy"))));
				break;
			}
			case Make4CC('a','p','4','h'):
			{
				OutFormatInfo.Emplace(IElectraDecoderFormatInfo::HumanReadableFormatName, FVariant(FString(TEXT("Apple ProRes 4444"))));
				break;
			}
			case Make4CC('a','p','4','x'):
			{
				OutFormatInfo.Emplace(IElectraDecoderFormatInfo::HumanReadableFormatName, FVariant(FString(TEXT("Apple ProRes 4444 XQ"))));
				break;
			}
			case Make4CC('a','p','r','n'):
			{
				OutFormatInfo.Emplace(IElectraDecoderFormatInfo::HumanReadableFormatName, FVariant(FString(TEXT("Apple ProRes RAW"))));
				break;
			}
			case Make4CC('a','p','r','h'):
			{
				OutFormatInfo.Emplace(IElectraDecoderFormatInfo::HumanReadableFormatName, FVariant(FString(TEXT("Apple ProRes RAW HQ"))));
				break;
			}
			default:
			{
