...
PRAGMA_DISABLE_DEPRECATION_WARNINGS
		GConfig->GetBool(INI_SECTION, TEXT("bUseEOSSessions"), GCachedSettings->bUseEOSSessions, GEngineIni);
		GConfig->GetBool(INI_SECTION, TEXT("bMirrorStatsToEOS"), GCachedSettings->bMirrorStatsToEOS, GEngineIni);
		GConfig->GetBool(INI_SECTION, TEXT("bMirrorAchievementsToEOS"), GCachedSettings->bMirrorAchievementsToEOS, GEngineIni);
		GConfig->GetBool(INI_SECTION, TEXT("bMirrorPresenceToEAS"), GCachedSettings->bMirrorPresenceToEAS, GEngineIni);
PRAGMA_ENABLE_DEPRECATION_WARNINGS
