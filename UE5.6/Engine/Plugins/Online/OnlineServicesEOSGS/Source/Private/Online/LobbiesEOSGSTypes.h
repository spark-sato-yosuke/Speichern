...
public:
	 ...
	 */
	TFuture<TDefaultErrorResultInternal<FLobbyServiceSnapshot>> GetLobbySnapshot(bool bCopyMemberData) const;
...
public:
	...
	{
		FPlatformString::Strncpy(Data, InviteIdEOS, MaxLobbyInviteIdSize);
	}
