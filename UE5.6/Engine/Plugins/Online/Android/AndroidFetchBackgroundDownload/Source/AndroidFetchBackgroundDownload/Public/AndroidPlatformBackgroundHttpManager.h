...
protected:
	...
	struct FAndroidBackgroundHTTPManagerDefaultLocalizedText
	{
		...
		FPolyglotTextData DefaultNotificationText_AirplaneMode;
		FPolyglotTextData DefaultNotificationText_DataSaverEnabled;
...
public:
	...
	static const FString NOTIFICATION_CONTENT_AIRPLANE_MODE_TEXT_KEY;
	static const FString NOTIFICATION_CONTENT_DATA_SAVER_ENABLED_TEXT_KEY;
