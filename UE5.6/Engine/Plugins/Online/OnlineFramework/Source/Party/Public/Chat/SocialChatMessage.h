...
public:
	...
	UE_API virtual FString GetSourceName() const PURE_VIRTUAL(FSocialChatMessage::GetSourceName, return TEXT(""););
...
public:
	...
	UE_API virtual FString GetSourceName() const override;
