...
namespace ErrorCode
{
	...
	namespace System
	{
		inline constexpr ErrorCodeType Engine = 1;
		inline constexpr ErrorCodeType Game = 2;
		inline constexpr ErrorCodeType ThirdPartyPlugin = 3;
	}
}
...
namespace ErrorCode { namespace Category { static constexpr int Category_Value_##Value##_Is_Taken_In_##InSystem = 0; } }\
