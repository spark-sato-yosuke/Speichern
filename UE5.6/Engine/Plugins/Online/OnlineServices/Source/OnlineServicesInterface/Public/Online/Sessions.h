...
struct FSessionSettingsUpdate
{
	...
	UE_API FSessionSettingsUpdate& operator+=(FSessionSettingsUpdate&& UpdatedValue);
};
...
struct FSessionSettings
{
	...
	UE_API FSessionSettings& operator+=(const FSessionSettingsChanges& UpdatedValue);
};
...
struct FSessionUpdate
{
	...
	UE_API FSessionUpdate& operator+=(const FSessionUpdate& SessionUpdate);
};
