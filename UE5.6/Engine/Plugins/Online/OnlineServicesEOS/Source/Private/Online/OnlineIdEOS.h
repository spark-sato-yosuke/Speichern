...
public:
	...
	virtual FAccountId FindOrAddAccountId(const EOS_ProductUserId ProductUserId) override;
	...
	static inline bool ValidateOnlineId(const TOnlineId<IdType> OnlineId)
	{
