...
void FPackImportWorkflow::SetDownloadNotificationProgress(const float Progress) const
{
...
void FPackImportWorkflow::ExpireDownloadNotification(bool bSuccess) const
{
