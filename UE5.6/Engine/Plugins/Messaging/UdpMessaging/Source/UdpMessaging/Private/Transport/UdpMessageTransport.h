...
private:
	...
	void HandleProcessorMessageReassembled(FUdpReassembledMessageSharedPtr ReassembledMessagePtr, const TSharedPtr<IMessageAttachment, ESPMode::ThreadSafe>& Attachment, const FGuid& NodeId);
...
private:
	...
	/** Async task queue for running deserialization of reassembled messages. */
	TUniquePtr<UE::Tasks::FTaskConcurrencyLimiter> DeserializationTasks;
};
