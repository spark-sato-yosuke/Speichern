...
namespace UE::Chaos::ClothAsset
{
	...
	public:
		...
		*/
		...
		TManagedArray<FVector3f>* GetPreResizedSimPosition3D() { return PreResizedSimPosition3D; }
		...
		TManagedArray<float>* GetSimCustomResizingBlend() { return SimCustomResizingBlend; }

		//~ Sim Morph Targets Group
		TManagedArray<FString>* GetSimMorphTargetName() { return SimMorphTargetName; }
		TManagedArray<int32>* GetSimMorphTargetVerticesStart() { return SimMorphTargetVerticesStart; }
		TManagedArray<int32>* GetSimMorphTargetVerticesEnd() { return SimMorphTargetVerticesEnd; }

		//~ Sim Morph Targets Vertices Group
		TManagedArray<FVector3f>* GetSimMorphTargetPositionDelta() { return SimMorphTargetPositionDelta; }
		TManagedArray<FVector3f>* GetSimMorphTargetTangentZDelta() { return SimMorphTargetTangentZDelta; }
		TManagedArray<int32>* GetSimMorphTargetSimVertex3DIndex() { return SimMorphTargetSimVertex3DIndex; }
		...
		TManagedArray<float>* GetRenderCustomResizingBlend() { return RenderCustomResizingBlend; }

		//~ Group Resizing Group
		TManagedArray<FString>* GetCustomResizingRegionSet() { return CustomResizingRegionSet; }
		TManagedArray<int32>* GetCustomResizingRegionType() { return CustomResizingRegionType; }
	...
	private:
		...
		TManagedArray<float>* SimCustomResizingBlend; // Resizing weight map. How much to use group resizing result (1) vs rbf interpolation result (0) when doing sim mesh resizing
		TManagedArray<FVector3f>* PreResizedSimPosition3D;

		//~ Sim Morph Targets Group
		TManagedArray<FString>* SimMorphTargetName;
		TManagedArray<int32>* SimMorphTargetVerticesStart;
		TManagedArray<int32>* SimMorphTargetVerticesEnd;

		//~ Sim Morph Target Vertices Group
		TManagedArray<FVector3f>* SimMorphTargetPositionDelta;
		TManagedArray<FVector3f>* SimMorphTargetTangentZDelta;
		TManagedArray<int32>* SimMorphTargetSimVertex3DIndex;
		...
		TManagedArray<float>* RenderCustomResizingBlend; // Resizing weight map. How much to use group resizing result (1) vs rbf interpolation result (0) when doing render mesh resizing

		//~ Group Resizing Group
		TManagedArray<FString>* CustomResizingRegionSet; // Name of the set associated with this binding type
		TManagedArray<int32>* CustomResizingRegionType; // Actually an Enum for binding type
	};
