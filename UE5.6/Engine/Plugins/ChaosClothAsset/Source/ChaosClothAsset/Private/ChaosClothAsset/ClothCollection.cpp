...
namespace UE::Chaos::ClothAsset
{
	...
	bool FClothCollection::IsValid(EClothCollectionExtendedSchemas OptionalSchemas) const
	{
	...
	void FClothCollection::DefineSchema(EClothCollectionExtendedSchemas OptionalSchemas)
	{
		...
		if (EnumHasAnyFlags(OptionalSchemas, EClothCollectionExtendedSchemas::CookedOnly))
		{
			...
			// Sim Morph Targets Group
			SimMorphTargetName = &ManagedArrayCollection->AddAttribute<FString>(ClothCollectionAttribute::SimMorphTargetName, ClothCollectionGroup::SimMorphTargets);
			SimMorphTargetVerticesStart = &ManagedArrayCollection->AddAttribute<int32>(ClothCollectionAttribute::SimMorphTargetVerticesStart, ClothCollectionGroup::SimMorphTargets);
			SimMorphTargetVerticesEnd = &ManagedArrayCollection->AddAttribute<int32>(ClothCollectionAttribute::SimMorphTargetVerticesEnd, ClothCollectionGroup::SimMorphTargets);

			// Sim Morph Target Vertices Group
			SimMorphTargetPositionDelta = &ManagedArrayCollection->AddAttribute<FVector3f>(ClothCollectionAttribute::SimMorphTargetPositionDelta, ClothCollectionGroup::SimMorphTargetVertices);
			SimMorphTargetTangentZDelta = &ManagedArrayCollection->AddAttribute<FVector3f>(ClothCollectionAttribute::SimMorphTargetTangentZDelta, ClothCollectionGroup::SimMorphTargetVertices);
			SimMorphTargetSimVertex3DIndex = &ManagedArrayCollection->AddAttribute<int32>(ClothCollectionAttribute::SimMorphTargetSimVertex3DIndex, ClothCollectionGroup::SimMorphTargetVertices);
			
			// Sim Vertices 3D Group
			PreResizedSimPosition3D = &ManagedArrayCollection->AddAttribute<FVector3f>(ClothCollectionAttribute::PreResizedSimPosition3D, ClothCollectionGroup::SimVertices3D);
		...
		if (EnumHasAnyFlags(OptionalSchemas, EClothCollectionExtendedSchemas::SimMorphTargets))
		{
			// Sim Morph Targets Group
			SimMorphTargetName = &ManagedArrayCollection->AddAttribute<FString>(ClothCollectionAttribute::SimMorphTargetName, ClothCollectionGroup::SimMorphTargets);
			SimMorphTargetVerticesStart = &ManagedArrayCollection->AddAttribute<int32>(ClothCollectionAttribute::SimMorphTargetVerticesStart, ClothCollectionGroup::SimMorphTargets, SimMorphTargetVerticesDependency);
			SimMorphTargetVerticesEnd = &ManagedArrayCollection->AddAttribute<int32>(ClothCollectionAttribute::SimMorphTargetVerticesEnd, ClothCollectionGroup::SimMorphTargets, SimMorphTargetVerticesDependency);

			// Sim Morph Target Vertices Group
			SimMorphTargetPositionDelta = &ManagedArrayCollection->AddAttribute<FVector3f>(ClothCollectionAttribute::SimMorphTargetPositionDelta, ClothCollectionGroup::SimMorphTargetVertices);
			SimMorphTargetTangentZDelta = &ManagedArrayCollection->AddAttribute<FVector3f>(ClothCollectionAttribute::SimMorphTargetTangentZDelta, ClothCollectionGroup::SimMorphTargetVertices);
			SimMorphTargetSimVertex3DIndex = &ManagedArrayCollection->AddAttribute<int32>(ClothCollectionAttribute::SimMorphTargetSimVertex3DIndex, ClothCollectionGroup::SimMorphTargetVertices, SimVertices3DDependency);
		}
		...
		{
			// Sim Vertices 3D Group
			SimCustomResizingBlend = &ManagedArrayCollection->AddAttribute<float>(ClothCollectionAttribute::SimCustomResizingBlend, ClothCollectionGroup::SimVertices3D);
			PreResizedSimPosition3D = &ManagedArrayCollection->AddAttribute<FVector3f>(ClothCollectionAttribute::PreResizedSimPosition3D, ClothCollectionGroup::SimVertices3D);

			// Render Vertices Group
			RenderCustomResizingBlend = &ManagedArrayCollection->AddAttribute<float>(ClothCollectionAttribute::RenderCustomResizingBlend, ClothCollectionGroup::RenderVertices);

			// Group Resizing Group
			CustomResizingRegionSet = &ManagedArrayCollection->AddAttribute<FString>(ClothCollectionAttribute::CustomResizingRegionSet, ClothCollectionGroup::CustomResizingRegions);
			CustomResizingRegionType = &ManagedArrayCollection->AddAttribute<int32>(ClothCollectionAttribute::CustomResizingRegionType, ClothCollectionGroup::CustomResizingRegions);
		}
	}
	...
	template CHAOSCLOTHASSET_API TArray<FName> FClothCollection::GetUserDefinedAttributeNames<TArray<int32>>(const FName& GroupName) const;
	...
	TManagedArray<T>* FClothCollection::FindOrAddUserDefinedAttribute(const FName& Name, const FName& GroupName, const FName& GroupDependency)
	{
		...
		if (const TArray<FName>* const FixedAttributeNames = FixedAttributeNamesMap.Find(GroupName))
		{
			...
			{
				return ManagedArrayCollection->FindOrAddAttributeTyped<T>(Name, GroupName, FManagedArrayCollection::FConstructionParameters(GroupDependency));
			}
		}
	...
	template CHAOSCLOTHASSET_API bool FClothCollection::HasUserDefinedAttribute<TArray<int32>>(const FName& Name, const FName& GroupName) const;
	...
	template CHAOSCLOTHASSET_API const TManagedArray<TArray<int32>>* FClothCollection::GetUserDefinedAttribute<TArray<int32>>(const FName& Name, const FName& GroupName) const;
