...
namespace UE::Chaos::ClothAsset
{
	...
	namespace ClothCollectionGroup
	{
		...
		/** Contains sim morph target relationships to other groups. */
		inline const FName SimMorphTargets = FName(TEXT("SimMorphTargets"));
		/** Contains morph target vertices */
		inline const FName SimMorphTargetVertices = FName(TEXT("SimMorphTargetVertices"));
		/** Contains custom region resizing data */
		inline const FName CustomResizingRegions = FName(TEXT("CustomResizingRegions"));
	}
