...
void FMassCrowdClaimWaitSlotTask::GetDependencies(UE::MassBehavior::FStateTreeDependencyBuilder& Builder) const
{
	Builder.AddReadOnly<FMassZoneGraphLaneLocationFragment>();
	Builder.AddReadOnly<FMassMoveTargetFragment>();
	Builder.AddReadWrite(CrowdSubsystemHandle);
}
