...
USTRUCT()
struct ANIMNEXTSTATETREE_API FAnimNextStateTreeRigVMConditionInstanceData
{
	GENERATED_BODY()
 ...
 */
USTRUCT()
struct ANIMNEXTSTATETREE_API FAnimNextStateTreeRigVMConditionBase : public FStateTreeConditionBase
{
	GENERATED_BODY()
