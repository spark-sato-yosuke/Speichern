...
#if WITH_EDITOR
TArray<UE::Landscape::EditLayers::FEditLayerRenderItem> AWaterLandscapeBrush::GetRenderItems(const UE::Landscape::EditLayers::FMergeContext* InMergeContext) const
{
	using namespace UE::Landscape::EditLayers; 

	TArray<FEditLayerRenderItem> RenderItems = Super::GetRenderItems(InMergeContext);
