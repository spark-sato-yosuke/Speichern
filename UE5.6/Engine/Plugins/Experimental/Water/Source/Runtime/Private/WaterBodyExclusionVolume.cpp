	...
	: Super(ObjectInitializer)
{
	...
	// By default, exclusion volume are not spatially loaded to avoid recomputing water body collision at runtime when the actor is streamed in,
	//  which is allowed, but tends to be expensive
