...
class FNavigationToolLengthColumn : public FNavigationToolColumn
{
public:
	UE_NAVIGATIONTOOL_INHERITS(FNavigationToolLengthColumn, FNavigationToolColumn);

	static FName StaticColumnId() { return TEXT("Length"); }
