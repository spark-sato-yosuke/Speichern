...
class FNavigationToolFilter_Unbound : public FNavigationToolFilter
{
public:
	static FString StaticName() { return TEXT("Unbound"); }

	FNavigationToolFilter_Unbound(INavigationToolFilterBar& InFilterInterface, TSharedPtr<FFilterCategory> InCategory = nullptr);
	...
	virtual bool PassesFilter(FNavigationToolFilterType InItem) const override;
	//~ End IFilter
};
