...
class FNavigationToolRevisionControlColumn : public FNavigationToolColumn
{
public:
	UE_NAVIGATIONTOOL_INHERITS(FNavigationToolRevisionControlColumn, FNavigationToolColumn);

	static FName StaticColumnId() { return TEXT("RevisionControl"); }
