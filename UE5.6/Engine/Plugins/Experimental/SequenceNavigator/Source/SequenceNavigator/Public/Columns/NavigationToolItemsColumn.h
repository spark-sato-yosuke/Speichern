...
class FNavigationToolItemsColumn : public FNavigationToolColumn
{
public:
	UE_NAVIGATIONTOOL_INHERITS(FNavigationToolItemsColumn, FNavigationToolColumn);

	static FName StaticColumnId() { return TEXT("Items"); }
...
protected:
	...
	virtual float GetFillWidth() const override { return 3.f; }
