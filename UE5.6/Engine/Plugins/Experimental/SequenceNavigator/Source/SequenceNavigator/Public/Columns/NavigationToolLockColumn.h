...
class FNavigationToolLockColumn : public FNavigationToolColumn
{
public:
	UE_NAVIGATIONTOOL_INHERITS(FNavigationToolLockColumn, FNavigationToolColumn);

	static FName StaticColumnId() { return TEXT("Lock"); }
