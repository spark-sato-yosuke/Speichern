...
class FNavigationToolColorColumn : public FNavigationToolColumn
{
public:
	UE_NAVIGATIONTOOL_INHERITS(FNavigationToolColorColumn, FNavigationToolColumn);

	static FName StaticColumnId() { return TEXT("Color"); }
...
protected:
	...
	SEQUENCENAVIGATOR_API virtual SHeaderRow::FColumn::FArguments ConstructHeaderRowColumn(const TSharedRef<INavigationToolView>& InView, const float InFillSize) override;
