...
class FNavigationToolHBiasColumn : public FNavigationToolColumn
{
public:
	UE_NAVIGATIONTOOL_INHERITS(FNavigationToolHBiasColumn, FNavigationToolColumn);

	static FName StaticColumnId() { return TEXT("HBias"); }
