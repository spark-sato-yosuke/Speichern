...
class FNavigationToolStartFrameOffsetColumn : public FNavigationToolColumn
{
public:
	UE_NAVIGATIONTOOL_INHERITS(FNavigationToolStartFrameOffsetColumn, FNavigationToolColumn);

	static FName StaticColumnId() { return TEXT("StartFrameOffset"); }
