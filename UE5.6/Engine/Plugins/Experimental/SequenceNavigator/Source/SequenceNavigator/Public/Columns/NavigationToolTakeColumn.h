...
class FNavigationToolTakeColumn : public FNavigationToolColumn
{
public:
	UE_NAVIGATIONTOOL_INHERITS(FNavigationToolTakeColumn, FNavigationToolColumn);

	static FName StaticColumnId() { return TEXT("ShotTake"); }
