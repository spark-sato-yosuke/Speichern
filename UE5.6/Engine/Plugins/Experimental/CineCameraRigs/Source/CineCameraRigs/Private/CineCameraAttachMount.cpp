...
void ACineCameraAttachMount::CreateConstraint()
{
	...
	UE::TransformConstraintUtil::GetParentConstraints(World, this, Constraints);
	...
	UTickableTransformConstraint* Constraint = UE::TransformConstraintUtil::CreateAndAddFromObjects(World, TargetActor.Get(), TargetSocket, this, NAME_None, ETransformConstraintType::Parent);
	if (Constraint)
	{
