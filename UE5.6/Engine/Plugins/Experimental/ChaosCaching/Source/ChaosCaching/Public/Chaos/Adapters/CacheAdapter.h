...
namespace Chaos
{
	...
	public:
		...
		*/
		...
		/**
		 * if the cache adapter supports playback when recording
		 */
		virtual bool SupportsPlayWhileRecording() const { return false;  };
		virtual bool SupportsRestartSimulation() const { return false; };
