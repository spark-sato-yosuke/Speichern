...
public:
	...
	/** Sets the maximum number of agents that this manager is configured to handle. */
	UFUNCTION(BlueprintCallable, Category = "LearningAgents", meta = (ClampMin = "1", UIMin = "1"))
	void SetMaxAgentNum(const int32 InMaxAgentNum);
