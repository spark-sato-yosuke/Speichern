...
namespace UE::AnimNext
{
	FScopedClearNodeTemplateRegistry::FScopedClearNodeTemplateRegistry()
	{
		...
		// Can't use Swap because the move constructor is private and Swap thinks it's non-swappable
		FMemory::Memswap(&Registry, &TmpRegistry, sizeof(FNodeTemplateRegistry));
	}
