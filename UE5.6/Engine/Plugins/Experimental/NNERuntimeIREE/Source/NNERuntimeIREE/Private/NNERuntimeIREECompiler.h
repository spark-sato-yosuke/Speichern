...
namespace UE::NNERuntimeIREE::CPU
{
	...
	private:
		static inline FString GetOnnxFilePath(const FString& InModelName, const FString& InOutputDir);
		static inline FString GetMlirFilePath(const FString& InModelName, const FString& InOutputDir);
