...
protected:
	...
	UE_API virtual bool AttemptJump(float UpwardsSpeed, FMoverTickEndData& Output);

	UE_API void CaptureFinalState(USceneComponent* UpdatedComponent, const FFloorCheckResult& FloorResult, const FMovementRecord& Record, FMoverDefaultSyncState& OutputSyncState) const;
	...
	float OriginalCapsuleHalfHeight = 75.f;
};
