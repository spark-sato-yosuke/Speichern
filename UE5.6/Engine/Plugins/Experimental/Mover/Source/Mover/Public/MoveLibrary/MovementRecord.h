...
struct FMovementRecord
{
	...
	UE_API void Append(FMovementSubstep Substep);
	...
	const FVector& GetTotalMoveDelta() const { return TotalMoveDelta; }
	const FVector& GetRelevantMoveDelta() const { return RelevantMoveDelta; }
