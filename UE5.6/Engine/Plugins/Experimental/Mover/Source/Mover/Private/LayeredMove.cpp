...
void FLayeredMoveBase::StartMove_Async(UMoverBlackboard* SimBlackboard, float CurrentSimTimeMs)
{
	StartSimTimeMs = CurrentSimTimeMs;
...
void FLayeredMoveBase::EndMove_Async(UMoverBlackboard* SimBlackboard, float CurrentSimTimeMs)
{
...
void FLayeredMoveGroup::FlushMoveArrays(const UMoverComponent* MoverComp, UMoverBlackboard* SimBlackboard, float CurrentSimTimeMs, bool bIsAsync)
{
	if (bIsAsync)
	{
