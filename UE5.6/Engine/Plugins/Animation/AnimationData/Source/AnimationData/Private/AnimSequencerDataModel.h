...
public:
	...
	static int32 LazyRigHierarchyInitializationMode;
	...
	virtual FGuid GenerateGuid(const FGuidGenerationSettings& InSettings) const override;
#if WITH_EDITOR
	virtual FString GenerateDebugStateString() const override;
#endif
...
private:	
	...
	void InitializeRigHierarchy(UFKControlRig* FKControlRig, const USkeleton* Skeleton) const;
