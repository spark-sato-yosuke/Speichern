...
void FIKRigSkeletonCommands::RegisterCommands()
{
	...
	UI_COMMAND(SetStartBoneOnSolver, "Set Start Bone on Selected Solver", "Set the Start Bone on the selected solver.", EUserInterfaceActionType::Button, FInputChord());
	...
	UI_COMMAND(SetPelvis, "Set Pelvis", "Set the Pelvis bone used for retargeting.", EUserInterfaceActionType::Button, FInputChord());
	UI_COMMAND(ClearPelvis, "Clear Pelvis", "Clear the Pelvis bone used for retargeting.", EUserInterfaceActionType::Button, FInputChord());
