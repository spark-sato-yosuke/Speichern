...
#include "SIKRigHierarchy.generated.h"
...
public:
	...
	void GetStruct(const UScriptStruct*& OutType, uint8*& OutMemory) const;
...
public:
	...
	/** return true if a skeleton hierarchy has been loaded from an asset*/
	bool IsSkeletonLoaded() const;
	/** import skeletal mesh into the asset */
	FReply OnImportSkeletonClicked() const;
...
private:
	...
	FIKRigHierarchyImportSettings ImportSettings;
