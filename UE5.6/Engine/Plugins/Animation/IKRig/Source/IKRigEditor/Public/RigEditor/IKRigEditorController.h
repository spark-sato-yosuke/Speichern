...
public:
	...
	FIKRigProcessor* GetIKRigProcessor() const;
	...
	// show the currently configured StructViewer object in the details tab
	void ShowStructViewerInDetailsView(UIKRigStructViewer* StructViewer) const;
