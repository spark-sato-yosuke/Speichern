...
public:
	...
	/** Add an object transform */
	void AppendObjectTransform(uint64 InObjectId, double InProfileTime, double InRecordingTime, const FTransform& Transform);
	...
	/** find the Transform of an object within a frame that Starts at InStartTime, and ends at InEndTime */
	virtual bool GetObjectTransform(uint64 InObjectId, double InStartTime, double InEndTime, FTransform& OutTransform) const override;
...
private:
	...
	TMap<uint64, uint32> ObjectIdToTransformTimeline;
	...
	struct FObjectTransformMessage
   	{
   		uint64 ObjectId = 0;
	...
	TraceServices::TPointTimeline<FObjectTransformMessage> TransformTimeline;
