...
public:
	...
	virtual void StartupModule() override
	{
		...
		StyleSet->Set("LiveLinkHub.Sources.Icon", new IMAGE_PLUGIN_BRUSH(TEXT("Starship/Sources"), Icon16x16));
		...
		StyleSet->Set("LiveLinkHub.AutoConnect.Disabled", new IMAGE_PLUGIN_BRUSH_SVG("Starship/AutoConnectDisabled", Icon16x16));
		StyleSet->Set("LiveLinkHub.AutoConnect.Global", new IMAGE_PLUGIN_BRUSH_SVG("Starship/AutoConnectGlobal", Icon16x16));
		StyleSet->Set("LiveLinkHub.AutoConnect.Local", new IMAGE_PLUGIN_BRUSH_SVG("Starship/AutoConnectLocal", Icon16x16));
		...
		StyleSet->Set("LiveLinkHub.EllipsisIcon", new IMAGE_PLUGIN_BRUSH_SVG(TEXT("Starship/Ellipsis"), Icon16x16));
		StyleSet->Set("LiveLinkHub.TimecodeGenlock", new IMAGE_PLUGIN_BRUSH_SVG(TEXT("Starship/TimecodeGenlock"), Icon16x16));
		StyleSet->Set("LiveLinkHub.SpokeMode", new IMAGE_PLUGIN_BRUSH_SVG(TEXT("Starship/SpokeMode"), Icon16x16, FSlateColor(FLinearColor(1.000, 0.168, 0.350))));
		StyleSet->Set("LiveLinkHub.HubMode", new IMAGE_PLUGIN_BRUSH_SVG(TEXT("Starship/HubMode"), Icon16x16, FSlateColor(FLinearColor(0.271, 0.554, 0.067))));
...
private:
	...
	void RegisterCustomizations()
	{
		...
		PropertyEditorModule.RegisterCustomClassLayout(ULiveLinkHubSubjectSettings::StaticClass()->GetFName(), FOnGetDetailCustomizationInstance::CreateStatic(&FLiveLinkHubSubjectSettingsDetailsCustomization::MakeInstance));
