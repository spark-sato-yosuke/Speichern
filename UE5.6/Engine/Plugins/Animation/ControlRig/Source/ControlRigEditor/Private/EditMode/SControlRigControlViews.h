...
private:
	...
	*/
	...
	ECheckBoxState IsAdditivePoseChecked() const;
	void OnAdditivePoseChecked(ECheckBoxState NewState);
	...
	static bool bIsAdditive;
	static float bDynamicMin;
	static float bDynamicMax;
