...
public:
	...
	const FConstrainable& GetParent() const;
	bool IsParentValid() const;

private:

	/** Updates the current constrainable parent data. */
	void UpdateParent(AActor* InActor);
	...
	TSharedRef<SWidget> OnGetParentMenuContent();
	TSharedPtr<SComboButton> GetActorChooserWidget();
	TSharedRef<SWidget> GetUseSelectedActorWidget();
	void OnParentMenuOpenChanged(bool bOpened);
