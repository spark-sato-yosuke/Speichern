...
namespace UE::NeuralMorphModel
{
	...
	void SNeuralMorphCurveGroupsWidget::OnCreateCurveGroup()
	{
		...
		FScopedTransaction Transaction(TEXT("SNeuralMorphCurveGroupsWidget"), LOCTEXT("CreateCurveGroupText", "Create Curve Group"), NeuralMorphModel);
	...
	void SNeuralMorphCurveGroupsWidget::OnDeleteSelectedItems()
	{
		...
		FScopedTransaction Transaction(TEXT("SNeuralMorphCurveGroupsWidget"), LOCTEXT("RemoveCurveGroupItemsText", "Remove Curve Group Items"), NeuralMorphModel);
		NeuralMorphModel->Modify();
	...
	void SNeuralMorphCurveGroupsWidget::OnClearCurveGroups()
	{
		...
		FScopedTransaction Transaction(TEXT("SNeuralMorphCurveGroupsWidget"), LOCTEXT("ClearCurveGroupText", "Clear Curve Groups"), NeuralMorphModel);
		NeuralMorphModel->Modify();
	...
	void SNeuralMorphCurveGroupsWidget::OnAddCurveToGroup()
	{
		...
		if (!CurveNames.IsEmpty())
		{
			FScopedTransaction Transaction(TEXT("SNeuralMorphCurveGroupsWidget"), LOCTEXT("AddCurveToGroupText", "Add Curves To Group"), NeuralMorphModel);
			NeuralMorphModel->Modify();
