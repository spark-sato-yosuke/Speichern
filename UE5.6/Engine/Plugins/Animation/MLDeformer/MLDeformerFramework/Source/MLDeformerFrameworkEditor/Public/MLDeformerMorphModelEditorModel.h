...
namespace UE::MLDeformer
{
	...
	public:
		...
		virtual FString GetHeatMapDeformerGraphDualQuatPath() const override;
	...
	protected:
		...
		/**
		 * Tell the editor model that we should update the mask buffer on the next Tick call.
		 */
		void SetNeedsRebuildMaskBuffer() { bNeedsRebuildMaskInfo = true; }
	...
	protected:
		...
		/** Indicates whether we need to rebuild the mask buffer next Tick or not. */
		bool bNeedsRebuildMaskInfo = false;
	};
}	// namespace UE::MLDeformer
