...
namespace UE::MLDeformer
{
	...
	public:
		...
		SLATE_ARGUMENT(FReferenceSkeleton const*, RefSkeleton)		// The reference skeleton to grab the bone names and hierarchy from.
	...
	private:
		...
		void RefreshBoneTreeElements() const;
	...
	private:
		...
		FReferenceSkeleton const* RefSkeleton = nullptr;
