...
public:
	...
	{}
	SLATE_ARGUMENT(UTextureGraphBase*, InTextureGraph)
		SLATE_END_ARGS()
...
private:
	...
	TObjectPtr<UTextureGraphBase>		TextureGraphPtr;		/// Pointer to the Texture Graph being shown
...
public:
	...
	void									SetTextureGraph(const TObjectPtr<UTextureGraphBase>& InTextureGraph);
	...
	void									InitRenderModes(UTextureGraphBase* InTextureGraph);
