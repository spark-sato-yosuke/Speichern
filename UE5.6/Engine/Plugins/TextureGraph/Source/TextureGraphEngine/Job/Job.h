...
protected:
	...
	virtual AsyncJobArgResultPtr	BindArgs(JobRunInfo NewRunInfo, BlobTransformPtr TransformObj, int32 RowId, int32 ColId);
	virtual AsyncJobArgResultPtr	UnbindArgs(JobRunInfo NewRunInfo, BlobTransformPtr TransformObj, int32 RowId, int32 ColId);
	...
	virtual AsyncJobResultPtr		RunTile(JobRunInfo RunInfo, int32 RowId, int32 ColId);
	virtual AsyncJobResultPtr		RunSingle(JobRunInfo RunInfo);
	virtual AsyncJobResultPtr		FinaliseTiles(JobRunInfo RunInfo);
	void							SetTileResult(int32 RowId, int32 ColId, JobResultPtr TileResult);
	virtual AsyncPrepareResult		PrepareTargets(JobBatch* batch);

	AsyncTransformResultPtr			ExecTransform(JobRunInfo RunInfo, BlobTransformPtr TransformObj , int32 RowId, int32 ColId, CHashPtr jobHash);
...
public:
	...
	virtual CHashPtr				TileHash(int32 RowId, int32 ColId) const;
	virtual CHashPtr				CalcTileHash(int32 RowId, int32 ColId) const;
...
public:
	...
	bool							GetTileInvalidation(int32 RowId, int32 ColId) const;
