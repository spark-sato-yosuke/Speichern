...
public:
	RenderMaterial_BP_NoTile(FString InName, UMaterialInterface* InMaterial) : RenderMaterial_BP(InName, InMaterial) {}
...
public:
	RenderMaterial_BP_TileArgs(FString InName, UMaterialInterface* InMaterial) : RenderMaterial_BP(InName, InMaterial) {}
