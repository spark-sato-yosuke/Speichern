...
RenderMaterial_FXPtr GetIfThenElseMaterial(EIfThenElseOperator Operator, EIfThenElseType Type)
{
	...
	case EIfThenElseOperator::GTE:
		if (Type == EIfThenElseType::IndividualComponent)
			return TextureGraphEngine::GetMaterialManager()->CreateMaterial_FX<VSH_Simple, FSH_IfThenElse_GTE_Component>("FSH_IfThenElse_GTE_Component");
		else if (Type == EIfThenElseType::AllComponents)
			return TextureGraphEngine::GetMaterialManager()->CreateMaterial_FX<VSH_Simple, FSH_IfThenElse_GTE_All>("FSH_IfThenElse_GTE_All");
		else if (Type == EIfThenElseType::Grayscale)
			return TextureGraphEngine::GetMaterialManager()->CreateMaterial_FX<VSH_Simple, FSH_IfThenElse_GTE_Grayscale>("FSH_IfThenElse_GTE_Grayscale");
		break;
	...
	case EIfThenElseOperator::LTE:
		if (Type == EIfThenElseType::IndividualComponent)
			return TextureGraphEngine::GetMaterialManager()->CreateMaterial_FX<VSH_Simple, FSH_IfThenElse_LTE_Component>("FSH_IfThenElse_LTE_Component");
		else if (Type == EIfThenElseType::AllComponents)
			return TextureGraphEngine::GetMaterialManager()->CreateMaterial_FX<VSH_Simple, FSH_IfThenElse_LTE_All>("FSH_IfThenElse_LTE_All");
		else if (Type == EIfThenElseType::Grayscale)
			return TextureGraphEngine::GetMaterialManager()->CreateMaterial_FX<VSH_Simple, FSH_IfThenElse_LTE_Grayscale>("FSH_IfThenElse_LTE_Grayscale");
		break;
