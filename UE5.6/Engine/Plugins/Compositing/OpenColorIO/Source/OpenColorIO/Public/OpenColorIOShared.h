...
public:
	...
	/** Returns the shader parameter metadata for the generated shader (built-in FOpenColorIOPixelShaderParameters, followed by dynamic textures & samplers). */
	TSharedPtr<const FShaderParametersMetadata, ESPMode::ThreadSafe> GetShaderParamMetadata() const;
	...
	*/
	...
	UE_DEPRECATED(5.6, "This method is deprecated, please use the one with a shader parameter metadata instead.")
	void SetupResource(
	...
	// Note: Takes ownership of the shader parameter metadata.
	void SetupResource(
		ERHIFeatureLevel::Type InFeatureLevel,
		const FString& InShaderCodeHash,
		const FString& InShadercode,
...
private:
	...
	/**
	 * The shader parameter metadata for the generated shader (built-in FOpenColorIOPixelShaderParameters, followed by dynamic textures & samplers).
	 */
	TSharedPtr<const FShaderParametersMetadata, ESPMode::ThreadSafe> ShaderParametersMetadata;
