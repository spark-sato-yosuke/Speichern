...
void UCustomizableObjectNodeMaterial::AllocateDefaultPins(UCustomizableObjectNodeRemapPins* RemapPins)
{
	...
	{
		const FString PinFriendlyName = UEdGraphSchema_CustomizableObject::GetPinCategoryFriendlyName(Schema->PC_MaterialAsset).ToString();
		const FString PinName = PinFriendlyName + FString(TEXT("_Input_Pin"));
...
{
	const FString PinFriendlyName = UEdGraphSchema_CustomizableObject::GetPinCategoryFriendlyName(UEdGraphSchema_CustomizableObject::PC_MaterialAsset).ToString();
	const FString PinName = PinFriendlyName + FString(TEXT("_Input_Pin"));
