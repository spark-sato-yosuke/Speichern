...
public:
	...
	SLATE_BEGIN_ARGS(SMutableImageViewer) {}
		SLATE_ATTRIBUTE(FIntPoint, GridSize)
		SLATE_ARGUMENT(TSharedPtr<const mu::FImage>, Image)
	SLATE_END_ARGS()
	...
	/** Set the image to show in the widget. */
	void SetImage(const TSharedPtr<const mu::FImage>& Image, int32 VisibleLOD );
...
private:
	...
	/** */
	TSharedPtr<const mu::FImage> MutableImage;
