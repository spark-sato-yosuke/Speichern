...
mu::EProjectorType SMutableProjectorViewer::GetProjectorType() const
{
	const mu::EProjectorType ProjectorType = MutableProjector.type;
...
{
	const mu::EProjectorType ProjectorType =  GetProjectorType();
