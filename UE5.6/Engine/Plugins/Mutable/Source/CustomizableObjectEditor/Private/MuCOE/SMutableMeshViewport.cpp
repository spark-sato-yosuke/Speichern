...
void SMutableMeshViewport::SetMesh(const TSharedPtr<const mu::FMesh>& InMesh)
{
...
bool SMutableMeshViewport::GenerateUnrealMesh()
{
	...
	USkeletalMesh* GeneratedSkeletalMesh = MutableMeshPreviewUtils::GenerateSkeletalMeshFromMutableMesh(MutableMesh.Get());
