...
/** Row on the tree representing the bone structure of the mu::FMesh. It represents the UI side of the BoneDefinition */
...
void SMutableSkeletonViewer::SetSkeleton(TSharedPtr<const mu::FSkeleton> InSkeleton)
{
