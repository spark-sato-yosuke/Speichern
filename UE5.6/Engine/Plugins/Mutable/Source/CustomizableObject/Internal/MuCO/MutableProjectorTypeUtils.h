...
namespace ProjectorUtils
{
	...
	ECustomizableObjectProjectorType GetEquivalentProjectorType (mu::EProjectorType ProjectorType);
	 ...
	 */
	CUSTOMIZABLEOBJECT_API
	mu::EProjectorType GetEquivalentProjectorType (ECustomizableObjectProjectorType ProjectorType);
}
