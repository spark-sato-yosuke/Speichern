...
namespace mu
{
	...
	public:
		...
		*/
		void GenerateLayoutBlocks(const TSharedPtr<FMesh>&, int32 LayoutIndex );
		void GenerateLayoutBlocksFromUVIslands(const TSharedPtr<FMesh>&, int32 LayoutIndex, bool bMergeChildBlocks);
