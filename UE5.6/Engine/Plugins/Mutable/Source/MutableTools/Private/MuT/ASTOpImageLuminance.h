...
namespace mu
{
	...
	class ASTOpImageLuminance final : public ASTOp
	{
	public:
	...
	public:
		...
		ASTOpImageLuminance();
		ASTOpImageLuminance(const ASTOpImageLuminance&) = delete;
		~ASTOpImageLuminance();

		virtual EOpType GetOpType() const override { return EOpType::IM_LUMINANCE; }
