...
struct FAudioOscilloscopePanelStyle : public FSlateWidgetStyle
{
	...
	UE_API inline static FOnNewTimeRulerStyle        OnNewTimeRulerStyle;
	UE_API inline static FOnNewValueGridOverlayStyle OnNewValueGridOverlayStyle;
	UE_API inline static FOnNewWaveformViewerStyle   OnNewWaveformViewerStyle;
};
