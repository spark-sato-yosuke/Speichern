...
using FBindingsSelectionVariantType = TVariant<FMVVMBlueprintViewBinding*, UMVVMBlueprintViewCondition*, UMVVMBlueprintViewEvent*>;
...
public:
	...
	void OnBindingListSelectionChanged(TConstArrayView<FBindingsSelectionVariantType> Selection);
...
private:
	...
	void SetDetailsView(TUnion<UObject*, TSharedPtr<FStructOnScope>> ObjectOrStruct, const FText& ErrorMessage = FText::GetEmpty());
