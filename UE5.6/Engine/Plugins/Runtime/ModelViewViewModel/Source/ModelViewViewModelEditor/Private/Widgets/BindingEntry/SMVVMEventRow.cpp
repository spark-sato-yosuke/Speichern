		...
		[
			...
			[
				...
				[
					...
					.OnDragOver(this, &SEventRow::HandleFieldSelectorDragOver, true)
					.ShowContext(false)
					.CanCreateEvent(true)
				]
			]
			...
			[
				...
				[
					...
					.OnDragOver(this, &SEventRow::HandleFieldSelectorDragOver, false)
...
FReply SEventRow::HandleFieldSelectorDrop(const FGeometry& MyGeometry, const FDragDropEvent& DragDropEvent, bool bEvent)
{
	...
	TOptional<FMVVMBlueprintPropertyPath> PropertyPath = BindingEntry::FRowHelper::DropFieldSelector(GetBlueprint(), DragDropEvent, bEvent);
...
FReply SEventRow::HandleFieldSelectorDragOver(const FGeometry& MyGeometry, const FDragDropEvent& DragDropEvent, bool bEvent)
{
	return BindingEntry::FRowHelper::DragOverFieldSelector(GetBlueprint(), DragDropEvent, bEvent);
}
