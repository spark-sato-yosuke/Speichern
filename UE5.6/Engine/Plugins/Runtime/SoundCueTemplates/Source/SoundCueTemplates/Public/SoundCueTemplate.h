...
#if WITH_EDITOR
	SOUNDCUETEMPLATES_API virtual void PostEditChangeProperty(FPropertyChangedEvent& PropertyChangedEvent) override;

public:
	/** Rebuilds the graph when user-facing properties are changed */
	SOUNDCUETEMPLATES_API void RebuildGraph(USoundCue& SoundCue) const;
	...
	SOUNDCUETEMPLATES_API void AddSoundWavesToTemplate(const TArray<UObject*>& SelectedObjects);
...
protected:
	 ...
	 */
	SOUNDCUETEMPLATES_API virtual void OnRebuildGraph(USoundCue& SoundCue) const PURE_VIRTUAL(, );

	/**
	 * Node width offset between nodes in the SoundCueEditor.
	 */
	static SOUNDCUETEMPLATES_API float GetNodeWidthOffset();

	/**
	 * Initial width offset of first node in the SoundCueEditor.
	 */
	static SOUNDCUETEMPLATES_API float GetInitialWidthOffset();

	/**
	 * Node height offset between nodes in the SoundCueEditor.
	 */
	static SOUNDCUETEMPLATES_API float GetNodeHeightOffset();

	/**
	 * Initial height offset of first node in the SoundCueEditor.
	 */
	static SOUNDCUETEMPLATES_API float GetInitialHeightOffset();
