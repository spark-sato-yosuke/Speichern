...
void UAudioCaptureComponent::GetResourceSizeEx(FResourceSizeEx& CumulativeResourceSize)
{
	CumulativeResourceSize.AddDedicatedSystemMemoryBytes(CaptureAudioData.GetAllocatedSize());
}
