...
public:
	...
	// UFUNCTION(BlueprintCallable, Category = "Modeling Objects")
	virtual FCreateComponentResult CreateNewComponentOnActor(const FCreateComponentParams& CreateComponentParams) override;
	...
	virtual FCreateComponentResult CreateNewComponentOnActor(FCreateComponentParams&& CreateComponentParams) override;
