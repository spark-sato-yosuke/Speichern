 ...
 */
UCLASS(Transient)
class MODELINGCOMPONENTSEDITORONLY_API UStaticMeshComponentReadOnlyToolTarget : public UPrimitiveComponentToolTarget,
 ...
 */
UCLASS(Transient)
class MODELINGCOMPONENTSEDITORONLY_API UStaticMeshComponentToolTarget : 
...
private:
	static const UStaticMesh* SourceToStaticMesh(const UObject* SourceObject);
};