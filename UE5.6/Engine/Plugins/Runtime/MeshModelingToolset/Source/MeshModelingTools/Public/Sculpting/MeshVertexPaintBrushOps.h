...
public:
	...
	UPROPERTY(EditAnywhere, Category = PaintBrush, meta = (DisplayName = "Strength", UIMin = "0.0", UIMax = "1.0", ClampMin = "0.0", ClampMax = "1.0", ModelingQuickEdit))
	float Strength = 0.5;
...
class FMeshVertexColorBrushOp : public FMeshSculptBrushOp
{
public:
