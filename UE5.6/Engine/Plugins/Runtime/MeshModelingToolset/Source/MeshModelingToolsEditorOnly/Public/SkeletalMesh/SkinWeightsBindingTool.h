 ...
 */
UCLASS()
class MESHMODELINGTOOLSEDITORONLY_API USkinWeightsBindingToolBuilder : public UMultiSelectionMeshEditingToolBuilder
{
	GENERATED_BODY()
public:
...
UCLASS()
class MESHMODELINGTOOLSEDITORONLY_API USkinWeightsBindingToolProperties : 
 ...
 */
UCLASS()
class MESHMODELINGTOOLSEDITORONLY_API USkinWeightsBindingTool :
