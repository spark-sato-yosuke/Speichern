 ...
 */
class MESHMODELINGTOOLSEDITORONLY_API FRefSkeletonChange : public FToolCommandChange
{
public:
...
UCLASS()
class MESHMODELINGTOOLSEDITORONLY_API USkeletonEditingToolBuilder : public UInteractiveToolWithToolTargetsBuilder
{
	GENERATED_BODY()
...
UCLASS()
class MESHMODELINGTOOLSEDITORONLY_API USkeletonEditingTool :
...
UCLASS()
class MESHMODELINGTOOLSEDITORONLY_API USkeletonEditingProperties : public UInteractiveToolPropertySet
{
	GENERATED_BODY()
public:
...
UCLASS()
class MESHMODELINGTOOLSEDITORONLY_API UProjectionProperties: public UInteractiveToolPropertySet
{
	GENERATED_BODY()
...
UCLASS()
class MESHMODELINGTOOLSEDITORONLY_API UMirroringProperties: public UInteractiveToolPropertySet
{
	GENERATED_BODY()
...
UCLASS()
class MESHMODELINGTOOLSEDITORONLY_API UOrientingProperties: public UInteractiveToolPropertySet
{
	GENERATED_BODY()
