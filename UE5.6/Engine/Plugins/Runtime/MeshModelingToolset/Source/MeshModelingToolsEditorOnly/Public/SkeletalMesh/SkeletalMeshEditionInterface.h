...
UINTERFACE()
class MESHMODELINGTOOLSEDITORONLY_API USkeletalMeshEditingInterface : public UInterface
{
	GENERATED_BODY()
};
...
class MESHMODELINGTOOLSEDITORONLY_API ISkeletalMeshEditingInterface
{
	GENERATED_BODY()
...
public:
	...
	virtual TArray<FName> GetSelectedMorphTargets() const;
...
UCLASS(Abstract)
class MESHMODELINGTOOLSEDITORONLY_API USkeletalMeshGizmoContextObjectBase : public UObject
{
	GENERATED_BODY()
...
UCLASS(Abstract)
class MESHMODELINGTOOLSEDITORONLY_API USkeletalMeshGizmoWrapperBase : public UObject
{
	GENERATED_BODY()
...
UCLASS(Abstract)
class MESHMODELINGTOOLSEDITORONLY_API USkeletalMeshEditorContextObjectBase : public UObject
{
	GENERATED_BODY()
