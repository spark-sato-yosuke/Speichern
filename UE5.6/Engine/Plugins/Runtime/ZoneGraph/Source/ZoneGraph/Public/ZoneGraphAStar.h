...
struct FZoneGraphAStarWrapper
{
	...
	UE_API int32 GetNeighbourCountV2(const FZoneGraphAStarNode& Node) const;
	UE_API FNodeRef GetNeighbour(const FZoneGraphAStarNode& Node, const int32 NeighbourIndex) const;
	//////////////////////////////////////////////////////////////////////////
