...
struct FZoneHandle
{
	...
	static UE_API const FZoneHandle Invalid;
...
struct FZoneGraphTag
{
	...
	static UE_API const FZoneGraphTag None;
...
private:
	static UE_API const uint8 NoneValue;
...
struct FZoneGraphTagMask
{
	...
	static UE_API const FZoneGraphTagMask All;
	static UE_API const FZoneGraphTagMask None;
...
struct FZoneLaneDesc
{
	...
	UE_API bool operator==(const FZoneLaneDesc& Other) const;
};
...
struct FZoneLaneProfile
{
	...
	UE_API bool IsSymmetrical() const;
...
struct FZoneGraphDataHandle
{
	...
	static UE_API const uint16 InvalidGeneration;	// 0
...
struct FZoneShapePoint
{
	...
	static UE_API const uint8 InheritLaneProfile;
...
struct FZoneGraphBuildSettings
{
	...
	UE_API float GetLaneTessellationTolerance(const FZoneGraphTagMask LaneTags) const;

	/** @return Connection restrictions for specified lane based on PolygonRoutingRules */
	UE_API EZoneShapeLaneConnectionRestrictions GetConnectionRestrictions(const FZoneGraphTagMask ZoneTags,
