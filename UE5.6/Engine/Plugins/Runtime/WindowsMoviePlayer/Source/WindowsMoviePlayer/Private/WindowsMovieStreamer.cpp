...
void FMediaFoundationMovieStreamer::ConvertSample(FRHICommandListImmediate& RHICmdList)
{
...

	{
		...
		if (!InputTarget.IsValid() || (InputTarget->GetSizeXY() != SourceFormat.BufferDim) || (InputTarget->GetFormat() != InputPixelFormat) || ((InputTarget->GetFlags() & TexCreate_SRGB) != InputCreateFlags))
		{
