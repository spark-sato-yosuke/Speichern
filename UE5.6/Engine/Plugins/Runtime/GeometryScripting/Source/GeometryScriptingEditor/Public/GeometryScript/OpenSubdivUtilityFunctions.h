...
public:
	...
	UFUNCTION(BlueprintCallable, Category = "GeometryScript|OpenSubdiv", meta=(ScriptMethod, DisplayName = "Apply PolyGroup Catmull Clark SubD"))
	...
	UFUNCTION(BlueprintCallable, Category = "GeometryScript|OpenSubdiv", meta=(ScriptMethod, DisplayName = "Apply Triangle Loop SubD"))
	static UPARAM(DisplayName = "Target Mesh") UDynamicMesh* 
