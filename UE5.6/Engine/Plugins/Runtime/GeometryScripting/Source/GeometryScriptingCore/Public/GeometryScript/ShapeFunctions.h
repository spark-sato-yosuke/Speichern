...
public:
	...
	static UE_API UPARAM(DisplayName="Transform") FTransform
	 ...
	 */
	UFUNCTION(BlueprintPure, Category = "GeometryScript|Shapes|Transform")
	static UE_API UPARAM(DisplayName="Direction") FVector
	 ...
	 */
	UFUNCTION(BlueprintPure, Category = "GeometryScript|Shapes|Transform")
	static UE_API UPARAM(DisplayName="Ray") FRay
	 ...
	 */
	UFUNCTION(BlueprintPure, Category = "GeometryScript|Shapes|Transform")
	static UE_API UPARAM(DisplayName="Ray") FPlane
...
public:
	...
	static UE_API UPARAM(DisplayName="Transformed Ray") FRay 
	 ...
	 */
	UFUNCTION(BlueprintPure, Category = "GeometryScript|Shapes|Ray", meta=(ScriptMethod))
	static UE_API UPARAM(DisplayName="Point") FVector 
	 ...
	 */
	UFUNCTION(BlueprintPure, Category = "GeometryScript|Shapes|Ray", meta=(ScriptMethod))
	static UE_API UPARAM(DisplayName="Ray Paramater") double 
	 ...
	 */
	UFUNCTION(BlueprintPure, Category = "GeometryScript|Shapes|Ray", meta=(ScriptMethod))
	static UE_API UPARAM(DisplayName="Distance") double 
	 ...
	 */
	UFUNCTION(BlueprintPure, Category = "GeometryScript|Shapes|Ray", meta=(ScriptMethod))
	static UE_API UPARAM(DisplayName="Closest Point") FVector 
	 ...
	 */
	UFUNCTION(BlueprintPure, Category = "GeometryScript|Shapes|Ray", meta=(ScriptMethod))
	static UE_API UPARAM(DisplayName="Intersects") bool 
...
public:
	...
	static UE_API UPARAM(DisplayName="Box") FBox 
	...
	static UE_API void GetBoxCenterSize(FBox Box, FVector& Center, FVector& Dimensions);
	 ...
	 */
	UFUNCTION(BlueprintPure, Category = "GeometryScript|Shapes|Box", meta=(ScriptMethod))
	static UE_API UPARAM(DisplayName="Corner Point") FVector 
	 ...
	 */
	UFUNCTION(BlueprintPure, Category = "GeometryScript|Shapes|Box", meta=(ScriptMethod))
	static UE_API UPARAM(DisplayName="Center Point") FVector 
	 ...
	 */
	UFUNCTION(BlueprintPure, Category = "GeometryScript|Shapes|Box", meta=(ScriptMethod))
	static UE_API void GetBoxVolumeArea(FBox Box, double& Volume, double& SurfaceArea);
	 ...
	 */
	UFUNCTION(BlueprintPure, Category = "GeometryScript|Shapes|Box", meta=(ScriptMethod))
	static UE_API UPARAM(DisplayName="Expanded Box") FBox 
	 ...
	 */
	UFUNCTION(BlueprintPure, Category = "GeometryScript|Shapes|Box", meta=(ScriptMethod))
	static UE_API UPARAM(DisplayName="Transformed Box") FBox 
	 ...
	 */
	UFUNCTION(BlueprintPure, Category = "GeometryScript|Shapes|Box", meta=(ScriptMethod))
	static UE_API UPARAM(DisplayName="Intersection Box") FBox 
	 ...
	 */
	UFUNCTION(BlueprintPure, Category = "GeometryScript|Shapes|Box", meta=(ScriptMethod))
	static UE_API UPARAM(DisplayName="Is Inside") bool 
