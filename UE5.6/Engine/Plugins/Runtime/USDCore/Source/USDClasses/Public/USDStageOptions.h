...
namespace UsdUtils
{
	USDCLASSES_API void AddAnalyticsAttributes(const FUsdStageOptions& Options, TArray<FAnalyticsEventAttribute>& InOutAttributes);

	USDCLASSES_API void HashForExport(const FUsdStageOptions& Options, FSHA1& HashToUpdate);
}
