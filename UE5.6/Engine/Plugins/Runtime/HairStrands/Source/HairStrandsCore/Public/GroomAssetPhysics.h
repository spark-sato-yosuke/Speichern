...
struct FHairSolverSettings
{
	...
	UE_API FHairSolverSettings();
	
	/** Use deformer for simulation  */
	UPROPERTY(EditAnywhere, Category = "SolverSettings", meta = (ToolTip = "Use deformer for the groom solver", DisplayName = "Enable Deformer Simulation"))
	bool bEnableDeformation;

	/** Use niagara for simulation */
	UPROPERTY(EditAnywhere, Category = "SolverSettings", meta = (ToolTip = "Use niagara for the groom solver", DisplayName = "Enable Niagara Simulation"))
	...
	UE_API bool operator==(const FHairSolverSettings& A) const;
};
...
struct FHairExternalForces
{
	...
	UE_API bool operator==(const FHairExternalForces& A) const;
};
...
struct FHairBendConstraint
{
	...
	UE_API bool operator==(const FHairBendConstraint& A) const;
};
...
struct FHairStretchConstraint
{
	...
	UE_API bool operator==(const FHairStretchConstraint& A) const;
};
...
struct FHairCollisionConstraint
{
	...
	UE_API FHairCollisionConstraint();
	...
	UE_API bool operator==(const FHairCollisionConstraint& A) const;
};
...
struct FHairMaterialConstraints
{
	...
	UE_API FHairMaterialConstraints();
	...
	UE_API bool operator==(const FHairMaterialConstraints& A) const;
};
...
struct FHairStrandsParameters
{
	...
	UE_API bool operator==(const FHairStrandsParameters& A) const;
};
...
struct FHairGroupsPhysics
{
	...
	UE_API bool operator==(const FHairGroupsPhysics& A) const;
