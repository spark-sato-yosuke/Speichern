...
public:
	...
	UE_API virtual TCHAR const* GetClassName() const PURE_VIRTUAL(UComputeDataInterface::GetClassName, return nullptr;)
	...
	/** Whether PreSubmit should be called when this data is used as a kernel output. */
	virtual bool GetRequiresPreSubmitCall() const { return false; }
	/** Whether PostSubmit should be called when this data is used as a kernel output. */
	virtual bool GetRequiresPostSubmitCall() const { return false; }
	...
	virtual UComputeDataProvider* CreateDataProvider() const { return nullptr; }

	UE_DEPRECATED(5.6, "Use the no-argument version together with UComputeDataProvider::Initialize()")
