...
void FComputeGraphInstance::InitializeDataProviders(UComputeGraph* InComputeGraph, int32 InBindingIndex, TObjectPtr<UObject> InBindingObject)
{
	if (InComputeGraph != nullptr)
	{
		InComputeGraph->InitializeDataProviders(InBindingIndex, InBindingObject, DataProviders);
	}
}

void FComputeGraphInstance::ResetDataProviders()
{
