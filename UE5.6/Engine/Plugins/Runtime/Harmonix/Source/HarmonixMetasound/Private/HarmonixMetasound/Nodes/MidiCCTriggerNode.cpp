...
namespace HarmonixMetasound::Nodes::MidiCCTriggerNode
{
	...
	using FMidiCCTriggerNode_V1 = Metasound::TNodeFacade<FMidiCCTriggerOperator_V1>;
	...
	using FMidiCCTriggerNode_V0 = Metasound::TNodeFacade<FMidiCCTriggerOperator_V0>;
