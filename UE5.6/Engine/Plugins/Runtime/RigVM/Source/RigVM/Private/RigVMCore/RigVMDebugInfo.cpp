...
const FRigVMBreakpoint& FRigVMDebugInfo::FindBreakpoint(const int32 InInstructionIndex, const UObject* InSubject) const
{
...
TArray<FRigVMBreakpoint> FRigVMDebugInfo::FindBreakpointsAtInstruction(const int32 InInstructionIndex) const
{
...
const FRigVMBreakpoint& FRigVMDebugInfo::AddBreakpoint(const int32 InstructionIndex, TWeakObjectPtr<UObject> InNode, const uint16 InDepth,
