...
public:
	...
	RIGVM_API UClass* GetNativizedClass(const TArray<FRigVMExternalVariableDef>& InExternalVariables = TArray<FRigVMExternalVariableDef>());
...
private:
	RIGVM_API void InstructionOpEval(FRigVMExtendedExecuteContext& Context, int32 InstructionIndex, int32 InHandleBaseIndex, const TFunctionRef<void(FRigVMExtendedExecuteContext& Context, int32 InHandleIndex, const FRigVMBranchInfoKey& InBranchInfoKey, const FRigVMOperand& InArg)>& InOpFunc);
	RIGVM_API void PrepareMemoryForExecution(FRigVMExtendedExecuteContext& Context);
	RIGVM_API void CacheMemoryHandlesIfRequired(FRigVMExtendedExecuteContext& Context);
...
#if WITH_EDITOR
	RIGVM_API bool ShouldHaltAtInstruction(FRigVMExtendedExecuteContext& Context, const FName& InEventName, const int32 InstructionIndex);
#endif
...
private:
	...
	RIGVM_API void CacheSingleMemoryHandle(FRigVMExtendedExecuteContext& Context, int32 InHandleIndex, const FRigVMBranchInfoKey& InBranchInfoKey, const FRigVMOperand& InArg, bool bForExecute = false);
...
protected:
	...
	RIGVM_API void SetupInstructionTracking(FRigVMExtendedExecuteContext& Context, int32 InInstructionCount);
