 ...
 */
struct RIGVMDEVELOPER_API FRigVMSearchTags
{
	...
	/** Pin Binding tag */
	static const FText FiB_PinBinding;
...
public:
	...
	virtual bool RequestFunctionDropOnPanel(UEdGraph* InGraph, const FRigVMGraphFunctionIdentifier& InFunction, const FVector2D& InDropPosition, const FVector2D& InScreenPosition) const;
	virtual bool RequestVariableDropOnPanel(UEdGraph* InGraph, FProperty* InVariableToDrop, const FVector2f& InDropPosition, const FVector2f& InScreenPosition) const override;
	virtual bool RequestVariableDropOnPin(UEdGraph* InGraph, FProperty* InVariableToDrop, UEdGraphPin* InPin, const FVector2f& InDropPosition, const FVector2f& InScreenPosition) const override;
	using UEdGraphSchema::RequestVariableDropOnPin;
	virtual bool RequestVariableDropOnPin(UEdGraph* InGraph, const FRigVMExternalVariable& InVariableToDrop, UEdGraphPin* InPin, const FVector2D& InDropPosition, const FVector2D& InScreenPosition) const;
	...
	virtual FReply TrySetGraphCategory(const UEdGraph* InGraph, const FText& InCategory) const override;
	...
	bool CanPromotePinToVariable(const UEdGraphPin& Pin, bool bCond) const;
