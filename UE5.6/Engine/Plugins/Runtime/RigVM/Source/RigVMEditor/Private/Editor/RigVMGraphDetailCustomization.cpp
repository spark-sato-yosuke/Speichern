...
TSharedRef<IDetailCustomization> FRigVMGraphDetailCustomization::MakeInstance(TSharedPtr<IRigVMEditor> InEditor, const UClass* InExpectedBlueprintClass)
{
	...
	return MakeShareable(new FRigVMGraphDetailCustomization((TSharedPtr<IRigVMEditor>)nullptr, nullptr));
}
...
FRigVMGraphDetailCustomization::FRigVMGraphDetailCustomization(TSharedPtr<IBlueprintEditor> RigVMigEditor, URigVMBlueprint* RigVMBlueprint)
...
FRigVMGraphDetailCustomization::FRigVMGraphDetailCustomization(TSharedPtr<IRigVMEditor> RigVMigEditor, URigVMBlueprint* RigVMBlueprint)
