...
public:
	...
	*/
	void Init(TWeakPtr<IRigVMEditor> InRigVMEditor, const FRigVMEditorGraphMenuContext& InGraphMenuContext = FRigVMEditorGraphMenuContext());
	...
	IRigVMEditor* GetRigVMEditor() const;
