...
void UMotorPhysicsSimComponent::Update(FAudioMotorSimInputContext& Input, FAudioMotorSimRuntimeContext& RuntimeInfo)
{
	...
	UE_LOG(LogAudioMotorSim, Verbose, TEXT("[UMotorPhysicsSimComponent] NetForce: %f (CurrentEngineTorque: %f - BrakingForce: %f - WindResistance %f - FrictionResistance %f - EngineResistance %f"), NetForce, CurrentEngineTorque, BrakingForce, WindResistance, FrictionResistance, EngineResistance)
