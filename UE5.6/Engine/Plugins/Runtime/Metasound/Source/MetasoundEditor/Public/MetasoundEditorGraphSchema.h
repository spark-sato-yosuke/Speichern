...
namespace Metasound::Editor
{
	...
	class METASOUNDEDITOR_API ISchemaQueryResult
	{
	public:
...
protected:
	virtual const FMetasoundFrontendNode* CreateFrontendVariableNode(FMetaSoundFrontendDocumentBuilder& DocBuilder) const override;
