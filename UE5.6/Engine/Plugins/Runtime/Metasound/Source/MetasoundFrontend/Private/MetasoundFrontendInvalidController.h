...
namespace Metasound
{
	namespace Frontend
	{
		 ...
		 */
		class FInvalidOutputController : public IOutputController
		{
		public:
			...
			UE_API virtual FNodeHandle GetOwningNode() override;
			UE_API virtual FConstNodeHandle GetOwningNode() const override;
		 ...
		 *  All methods return defaults and return error flags or invalid values.
		 */
		class FInvalidInputController : public IInputController 
		{
		public:
		...
		class FInvalidVariableController : public IVariableController
		{
		public:
		 ...
		 *  All methods return defaults and return error flags or invalid values.
		 */
		class FInvalidNodeController : public INodeController 
		{
		...
		public:
			...
			virtual bool DiffAgainstRegistryInterface(FClassInterfaceUpdates& OutInterfaceUpdates, bool bInUseHighestMinorVersion, bool bInForceRegeneratedClassInterfaceOverride) const override { return false; }
			virtual bool CanAutoUpdate(FClassInterfaceUpdates& OutInterfaceUpdates) const override { OutInterfaceUpdates = { }; return false; }

			UE_API virtual TSharedRef<IGraphController> AsGraph() override;
			UE_API virtual TSharedRef<const IGraphController> AsGraph() const override;
			...
			UE_API virtual TSharedRef<IGraphController> GetOwningGraph() override;
			UE_API virtual TSharedRef<const IGraphController> GetOwningGraph() const override;
			...
			virtual const FVertexName& GetNodeName() const override { return Invalid::GetInvalidName(); }
	   		...
	   		virtual void SetNodeConfiguration(TInstancedStruct<FMetaSoundFrontendNodeConfiguration> InConfig) override {}
	   		virtual TConstStructView<FMetaSoundFrontendNodeConfiguration> GetNodeConfiguration() const override { return TConstStructView<FMetaSoundFrontendNodeConfiguration>{}; }
		 ...
		 *  All methods return defaults and return error flags or invalid values.
		 */
		class FInvalidGraphController : public IGraphController 
		{
			public:
			...
			virtual void SetGraphStyle(FMetasoundFrontendGraphStyle InStyle) override { }
			virtual const FMetasoundFrontendInterfaceStyle& GetInputStyle() const override { return Invalid::GetInvalidInterfaceStyle(); }
			virtual const FMetasoundFrontendInterfaceStyle& GetOutputStyle() const override { return Invalid::GetInvalidInterfaceStyle(); }
			virtual void SetInputStyle(FMetasoundFrontendInterfaceStyle InStyle) override { }
			virtual void SetOutputStyle(FMetasoundFrontendInterfaceStyle InStyle) override { }
#endif // WITH_EDITOR
			...
			UE_API virtual FDocumentHandle GetOwningDocument() override;
			UE_API virtual FConstDocumentHandle GetOwningDocument() const override;
		 ...
		 *  All methods return defaults and return error flags or invalid values.
		 */
		class FInvalidDocumentController : public IDocumentController 
		{
			public:
				...
				UE_API virtual TSharedRef<IGraphController> GetRootGraph() override;
				UE_API virtual TSharedRef<const IGraphController> GetRootGraph() const override;
				UE_API virtual FDocumentAccessPtr GetDocumentPtr() override;
				UE_API virtual const FDocumentAccessPtr GetDocumentPtr() const override;
