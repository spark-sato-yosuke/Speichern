...
class UMetasoundParameterPack : public UObject, public IAudioProxyDataFactory
{
	GENERATED_BODY()
...
public:
	...
	static UE_API Metasound::FSendAddress CreateSendAddressFromEnvironment(const Metasound::FMetasoundEnvironment& InEnvironment);
	static UE_API FMetasoundFrontendClassInput GetClassInput();

	UE_API FSharedMetasoundParameterStoragePtr GetParameterStorage() const;
	UE_API FSharedMetasoundParameterStoragePtr GetCopyOfParameterStorage() const;
