...
namespace Metasound
{
	...
	namespace MetasoundArrayNodesPrivate
	{
		...
		bool RegisterArrayGetNode()
		{
			...
			return Frontend::RegisterNode<FNodeType>();
		}
		...
		{
			return Frontend::RegisterNode<Metasound::TArrayNumNode<ArrayType>>();
		}
		...
		{
			return Frontend::RegisterNode<Metasound::TArrayLastIndexNode<ArrayType>>();
		}
