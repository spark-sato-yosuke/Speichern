...
public:
	...
	virtual UBlueprint* WriteActorBlueprint(const FString& InBlueprintPath) const override;
...
private:
	 ...
	 */
	void UnpackCommonDependencies(TArray<UObject*> InRootObjects, TNotNull<const class UMetaHumanCollection*> InCollection) const;
