...
BEGIN_DEFINE_SPEC(FMetaHumanCaptureEventSourceTest, "MetaHumanCaptureEventSource", EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter | EAutomationTestFlags::MediumPriority)
...
END_DEFINE_SPEC(FMetaHumanCaptureEventSourceTest)

void FMetaHumanCaptureEventSourceTest::Define()
{
