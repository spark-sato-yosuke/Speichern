...
FText SChaosClothAssetEditor3DViewportToolBar::GetLODMenuLabel() const
{
	...
	const int32 LODSelectionType = ViewportClient->GetCurrentLOD();
...
TSharedRef<SWidget> SChaosClothAssetEditor3DViewportToolBar::MakeLODMenu() const
{
	...
	const int32 NumLODs = ViewportClient->GetLODCount();
	...
	MenuBuilder.BeginSection("ClothAssetPreviewLODs", LOCTEXT("ShowLOD_PreviewLabel", "Preview LODs"));
	{
		...
		for (int32 LODIndex = 1; LODIndex < NumLODs; ++LODIndex)
		{
			...
			FUIAction Action(FExecuteAction::CreateSP(ViewportClient, &FChaosClothAssetEditor3DViewportClient::SetLODLevel, LODIndex),
				FCanExecuteAction(),
				FIsActionChecked::CreateSP(ViewportClient, &FChaosClothAssetEditor3DViewportClient::IsLODSelected, LODIndex));
