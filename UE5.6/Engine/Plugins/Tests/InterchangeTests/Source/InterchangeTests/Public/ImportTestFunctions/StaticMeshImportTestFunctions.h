...
public:
	...
	UFUNCTION(Exec)
	static FInterchangeTestFunctionResult CheckBoundingBoxSizeGreaterThan(UStaticMesh* Mesh, const FVector& GreaterThanSize);

	/** Check whether the bounding box size is less than given value */
	UFUNCTION(Exec)
	static FInterchangeTestFunctionResult CheckBoundingBoxSizeLessThan(UStaticMesh* Mesh, const FVector& LessThanSize);

	/** Check whether the bounding box size is equal to given value */
	UFUNCTION(Exec)
	static FInterchangeTestFunctionResult CheckBoundingBoxSize(UStaticMesh* Mesh, const FVector& ExpectedSize);
};
