...
FString UDMMaterialLayerObject::SerializeToString() const
{
	...
	FJsonObjectConverter::UStructToJsonObject(UDMMaterialLayerObject::StaticClass(), this, LayerJson.ToSharedRef(), 0, CPF_Deprecated | CPF_Transient | CPF_TextExportTransient);
