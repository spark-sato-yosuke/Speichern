...
#if WITH_EDITOR
	DECLARE_MULTICAST_DELEGATE_OneParam(FOnSequenceEditUndoEvent, UAvaSequence*);

	/** Called on Sequence Edit Undo */
	static FOnSequenceEditUndoEvent::RegistrationType& OnSequenceEditUndo()
	{
		return OnSequenceEditUndoDelegate;
	}
#endif
...
#if WITH_EDITOR
	/** Called on Sequence Edit Undo */
	static FOnSequenceEditUndoEvent OnSequenceEditUndoDelegate;
#endif
