...
public:
	...
	/** Access cached preset info for this instance. */
	const FAvaPlayableRemoteControlPresetInfo& GetRemoteControlPresetInfo() const
	{
		return RemoteControlPresetInfo && !RemoteControlPresetInfo->IsDirty() ?
			*RemoteControlPresetInfo : GetRemoteControlPresetInfoFromCache(GetRemoteControlPreset());
	}
...
protected:
	FAvaPlayableRemoteControlPresetInfo& GetRemoteControlPresetInfoFromCache(URemoteControlPreset* InRemoteControlPreset) const;
...
protected:
	...
	mutable TSharedPtr<FAvaPlayableRemoteControlPresetInfo> RemoteControlPresetInfo;
};