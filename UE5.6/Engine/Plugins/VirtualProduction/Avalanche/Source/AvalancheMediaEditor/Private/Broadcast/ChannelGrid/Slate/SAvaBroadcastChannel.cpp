...
TSharedRef<SWidget> SAvaBroadcastChannel::GetQualitySettingsDetails()
{
	// We need to recreate the details view to update presets from the config the user may have changed
	CreateQualitySettingsDetails();
