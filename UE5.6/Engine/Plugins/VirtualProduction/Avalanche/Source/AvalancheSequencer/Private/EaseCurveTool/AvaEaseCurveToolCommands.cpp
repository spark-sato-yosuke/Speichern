...
void FAvaEaseCurveToolCommands::RegisterCommands()
{
	...
	FUICommandInfo::MakeCommandInfo(SharedThis
		...
		, LOCTEXT("QuickEase_ToolTip", "Apply the quick ease preset. This will be disabled if there is no valid quick ease preset setup.")
		, FSlateIcon(FAppStyle::Get().GetStyleSetName(), TEXT("Icons.BulletPoint"))
		, EUserInterfaceActionType::Button
	...
	FUICommandInfo::MakeCommandInfo(SharedThis
		...
		, LOCTEXT("QuickEaseIn_ToolTip", "Apply the quick ease in preset. This will be disabled if there is no valid quick ease preset setup.")
		, FSlateIcon(FAppStyle::Get().GetStyleSetName(), TEXT("Icons.ChevronRight"))
		, EUserInterfaceActionType::Button
	...
	FUICommandInfo::MakeCommandInfo(SharedThis
		...
		, LOCTEXT("QuickEaseOut_ToolTip", "Apply the quick ease out preset. This will be disabled if there is no valid quick ease preset setup.")
		, FSlateIcon(FAppStyle::Get().GetStyleSetName(), TEXT("Icons.ChevronLeft"))
		, EUserInterfaceActionType::Button
