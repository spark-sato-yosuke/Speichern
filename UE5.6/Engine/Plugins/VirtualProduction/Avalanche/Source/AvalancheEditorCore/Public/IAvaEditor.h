...
public:
	...
	/** Whether the editor should auto-activate if available */
	virtual bool ShouldAutoActivate() const = 0;

	/** Sets whether the editor should auto-activate */
	virtual void SetAutoActivate(bool bInAutoActivate) = 0;
