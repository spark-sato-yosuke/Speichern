...
FViewportTypeDefinition FAvaLevelViewportExtension::MakeViewportTypeDefinition()
{
	return FViewportTypeDefinition(
		[](const FAssetEditorViewportConstructionArgs& InArgs, TSharedPtr<ILevelEditor> InLevelEditor)
		{
			return MakeShared<FAvaLevelViewportLayoutEntity>(InArgs, InLevelEditor);
		}
