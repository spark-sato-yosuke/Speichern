...
protected:
	...
	UPROPERTY(EditInstanceOnly, Setter, Getter, Category="Pattern", meta=(EditCondition="Layout == EAvaPatternModifierLayout::Line", EditConditionHides))
	...
	UPROPERTY(EditInstanceOnly, Setter, Getter, Category="Pattern", meta=(ClampMin="1", EditCondition="Layout == EAvaPatternModifierLayout::Line", EditConditionHides))
	int32 LineCount = 4;

	UPROPERTY(EditInstanceOnly, Setter, Getter, Category="Pattern", meta=(EditCondition="Layout == EAvaPatternModifierLayout::Line", EditConditionHides))
	float LineSpacing = 0.f;

	UPROPERTY(EditInstanceOnly, Setter="SetLineAccumulateTransform", Getter="GetLineAccumulateTransform", Category="Pattern", meta=(EditCondition="Layout == EAvaPatternModifierLayout::Line", EditConditionHides))
	bool bLineAccumulateTransform = false;

	UPROPERTY(EditInstanceOnly, Setter, Getter, Category="Pattern", meta=(EditCondition="Layout == EAvaPatternModifierLayout::Line", EditConditionHides))
	FRotator LineRotation = FRotator::ZeroRotator;

	UPROPERTY(EditInstanceOnly, Setter, Getter, Category="Pattern", meta=(EditCondition="Layout == EAvaPatternModifierLayout::Line", EditConditionHides, MotionDesignVectorWidget, AllowPreserveRatio="XYZ"))
