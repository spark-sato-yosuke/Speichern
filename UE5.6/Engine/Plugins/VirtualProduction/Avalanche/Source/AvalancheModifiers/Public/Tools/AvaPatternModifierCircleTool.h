...
protected:
	...
	UPROPERTY(EditInstanceOnly, Setter, Getter, Category="Pattern", meta=(EditCondition="Layout == EAvaPatternModifierLayout::Circle", EditConditionHides))
	...
	UPROPERTY(EditInstanceOnly, Setter, Getter, Category="Pattern", meta=(ClampMin="1", EditCondition="Layout == EAvaPatternModifierLayout::Circle", EditConditionHides))
	int32 CircleCount = 4;

	UPROPERTY(EditInstanceOnly, Setter="SetCircleAccumulateTransform", Getter="GetCircleAccumulateTransform", Category="Pattern", meta=(EditCondition="Layout == EAvaPatternModifierLayout::Circle", EditConditionHides))
	bool bCircleAccumulateTransform = false;

	UPROPERTY(EditInstanceOnly, Setter, Getter, Category="Pattern", meta=(EditCondition="Layout == EAvaPatternModifierLayout::Circle", EditConditionHides))
	FRotator CircleRotation = FRotator::ZeroRotator;

	UPROPERTY(EditInstanceOnly, Setter, Getter, Category="Pattern", meta=(EditCondition="Layout == EAvaPatternModifierLayout::Circle", EditConditionHides, MotionDesignVectorWidget, AllowPreserveRatio="XYZ"))
