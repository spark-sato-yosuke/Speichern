...
public:
	...
	explicit FAvaMaskParametricMaterialHandle(const FAvaMaskMaterialReference& InParametricMaterial);
...
protected:
	...
	void OnMaterialChanged(const FAvaShapeParametricMaterial& InMaterial);
...
private:
	...
	FDelegateHandle OnMaterialParameterChangedHandle;
};
