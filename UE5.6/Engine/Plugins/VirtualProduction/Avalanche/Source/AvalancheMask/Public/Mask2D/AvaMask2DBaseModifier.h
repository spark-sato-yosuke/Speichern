...
class AVALANCHEMASK_API UAvaMask2DBaseModifier
	: public UActorModifierArrangeBaseModifier
{
	GENERATED_BODY()
...
protected:
	...
	virtual void RestoreActorPreState(AActor* InActor, FAvaMask2DActorData& InActorData);
	...
	virtual void OnMaterialsChanged(UObject* InMaterialOwner, const TArray<TSharedPtr<IAvaMaskMaterialHandle>>& InMaterialHandles);
