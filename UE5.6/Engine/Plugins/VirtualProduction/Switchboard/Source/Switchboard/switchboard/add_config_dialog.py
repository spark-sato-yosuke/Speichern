...
class AddConfigDialog(QtWidgets.QDialog):
    ...
    class AddConfigDialogState(object):
        ...
        def load(self, addConfigDialog):
            ...
            self.p4ProjectWorkspace = addConfigDialog.p4_project_workspace_line_edit.text()
        ...
        def dump(self, addConfigDialog):
            ...
            lineEdits = [
                ...
                (self.p4ProjectWorkspace, addConfigDialog.p4_project_workspace_line_edit),
            ]
    ...
    def __init__(self, uproject_search_path, previous_engine_dir, parent):
        ...
        self.p4_project_workspace_line_edit = QtWidgets.QLineEdit(
            config.CONFIG.PROJECT_WORKSPACE.get_value())
        ...
        p4_layout.addRow("Workspace", self.p4_workspace_line_edit)
        p4_layout.addRow("Project Workspace Override", self.p4_project_workspace_line_edit)
    ...
    def p4_settings(self):
        ...
        settings['project_workspace'] = self.p4_project_workspace_line_edit.text() if self.p4_group.isChecked() else None
    ...
    def on_browse_config_path(self):
        ...
        try:
            config_path_str = str(
                config.CONFIG_MGR.get_relative_config_path(config_path_str))
        except Exception as e:
            config_path_str = str(config.CONFIG_MGR.get_absolute_config_path(config_path_str))
