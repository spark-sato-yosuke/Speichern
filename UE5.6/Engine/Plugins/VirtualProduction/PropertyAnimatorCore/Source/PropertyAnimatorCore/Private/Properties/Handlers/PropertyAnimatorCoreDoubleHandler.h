...
#include "PropertyAnimatorCoreDoubleHandler.generated.h"

/** Handles any double property values, get and set handler */
UCLASS(Transient)
class UPropertyAnimatorCoreDoubleHandler : public UPropertyAnimatorCoreHandlerBase
{
	GENERATED_BODY()
