...
#include "PropertyAnimatorCoreStringHandler.generated.h"

/** Handles any string property values, get and set handler */
UCLASS(Transient)
class UPropertyAnimatorCoreStringHandler : public UPropertyAnimatorCoreHandlerBase
{
	GENERATED_BODY()
