...
#include "PropertyAnimatorCoreTextHandler.generated.h"

/** Handles any text property values, get and set handler */
UCLASS(Transient)
class UPropertyAnimatorCoreTextHandler : public UPropertyAnimatorCoreHandlerBase
{
	GENERATED_BODY()
