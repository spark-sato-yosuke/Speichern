...
public:
	...
	UE_API virtual float GetFocus() const PURE_VIRTUAL(FBaseLensTable::GetFocus, return 0.f;);

	/** Returns number of zoom points */
	UE_API virtual int32 GetNumPoints() const PURE_VIRTUAL(FBaseLensTable::GetNumPoints, return 0;);

	/** Returns zoom value for a given index */
	UE_API virtual float GetZoom(int32 Index) const PURE_VIRTUAL(FBaseLensTable::GetZoom, return 0.f;);
};
...
protected:
	...
	UE_API virtual TMap<ELensDataCategory, FLinkPointMetadata> GetLinkedCategories() const PURE_VIRTUAL(FBaseLensTable::GetLinkedCategories, return TMap<ELensDataCategory, FLinkPointMetadata>() ;);
	 ...
	 */
	UE_API virtual bool DoesFocusPointExists(float InFocus, float InputTolerance = KINDA_SMALL_NUMBER) const PURE_VIRTUAL(FBaseLensTable::DoesFocusPointExists, return false; );
	 ...
	 */
	UE_API virtual bool DoesZoomPointExists(float InFocus, float InZoom, float InputTolerance = KINDA_SMALL_NUMBER) const PURE_VIRTUAL(FBaseLensTable::DoesZoomPointExists, return false; );
...
public:
	 ...
	 */
	UE_API virtual void ForEachPoint(FFocusPointCallback InCallback) const PURE_VIRTUAL(FBaseLensTable::ForEachPoint );

	/** Get number of Focus points for this data table */
	UE_API virtual int32 GetFocusPointNum() const PURE_VIRTUAL(FBaseLensTable::GetFocusPointNum, return INDEX_NONE; );

	/** Get total number of Zoom points for all Focus points of this data table */
	UE_API virtual int32 GetTotalPointNum() const PURE_VIRTUAL(FBaseLensTable::GetTotalPointNum, return INDEX_NONE; );

	/** Get the base focus point by given index */
	UE_API virtual const FBaseFocusPoint* GetBaseFocusPoint(int32 InIndex) const PURE_VIRTUAL(FBaseLensTable::GetBaseFocusPoint, return nullptr; );

	/** Get Struct class of this Data Table */
	UE_API virtual UScriptStruct* GetScriptStruct() const PURE_VIRTUAL(FBaseLensTable::GetFocusPointNum, return nullptr; );
	...
	*/
	UE_API virtual bool BuildParameterCurveAtFocus(float InFocus, int32 ParameterIndex, FRichCurve& OutCurve) const PURE_VIRTUAL(FBaseLensTable::BuildParameterCurve, return false; ); 
	 ...
	 */
	UE_API virtual bool BuildParameterCurveAtZoom(float InZoom, int32 ParameterIndex, FRichCurve& OutCurve) const PURE_VIRTUAL(FBaseLensTable::BuildFocusParameterCurve, return false; );
	 ...
	 */
	UE_API virtual void SetParameterCurveKeysAtFocus(float InFocus, int32 InParameterIndex, const FRichCurve& InSourceCurve, TArrayView<const FKeyHandle> InKeys) PURE_VIRTUAL(FBaseLensTable::SetZoomParameterCurveKeys);
	 ...
	 */
	UE_API virtual void SetParameterCurveKeysAtZoom(float InZoom, int32 InParameterIndex, const FRichCurve& InSourceCurve, TArrayView<const FKeyHandle> InKeys) PURE_VIRTUAL(FBaseLensTable::SetFocusParameterCurveKeys);
	 ...
	 */
	UE_API virtual bool CanEditCurveKeyPositions(int32 InParameterIndex) const PURE_VIRTUAL(FBaseLensTable::CanEditCurveKeyPositions, return false; );
	 ...
	 */
	UE_API virtual bool CanEditCurveKeyAttributes(int32 InParameterIndex) const PURE_VIRTUAL(FBaseLensTable::CanEditCurveKeyAttributes, return false; );
