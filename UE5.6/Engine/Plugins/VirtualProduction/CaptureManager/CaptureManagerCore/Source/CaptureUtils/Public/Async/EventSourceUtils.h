...
namespace Private
{
	class CAPTUREUTILS_API FCaptureEventSourceBase : public ICaptureEventSource
	{
	public:
...
class CAPTUREUTILS_API FCaptureEventSource : public Private::FCaptureEventSourceBase
{
protected:
...
class CAPTUREUTILS_API FCaptureEventSourceWithLimiter : public Private::FCaptureEventSourceBase
{
public:
