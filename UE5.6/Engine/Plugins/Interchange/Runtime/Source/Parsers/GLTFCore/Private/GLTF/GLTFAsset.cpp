...
namespace GLTF
{
	...
	// Prefixes
	FString GLTFNodePrefixStaticHelper::GetScenePrefix(const FString& AssetName)
	{
		return AssetName + TEXT("_scene_");
	}

	FString GLTFNodePrefixStaticHelper::GetNodePrefix(const FString& AssetName)
	{
		return AssetName + TEXT("_node_");
	}

	FString GLTFNodePrefixStaticHelper::GetJointPrefix(const FString& AssetName)
	{
		return AssetName + TEXT("_joint_");
	}

	FString GLTFNodePrefixStaticHelper::GetTexturePrefix(const FString& AssetName)
	{
		return AssetName + TEXT("_texture_");
	}

	FString GLTFNodePrefixStaticHelper::GetCameraPrefix(const FString& AssetName)
	{
		return AssetName + TEXT("_camera_");
	}

	FString GLTFNodePrefixStaticHelper::GetLightPrefix(const FString& AssetName)
	{
		return AssetName + TEXT("_light_");
	}

	FString GLTFNodePrefixStaticHelper::GetMaterialPrefix(const FString& AssetName)
	{
		return AssetName + TEXT("_material_");
	}

	FString GLTFNodePrefixStaticHelper::GetSkinPrefix(const FString& AssetName)
	{
		return AssetName + TEXT("_skin_");
	}

	FString GLTFNodePrefixStaticHelper::GetAnimationPrefix(const FString& AssetName)
	{
		return AssetName + TEXT("_animation_");
	}

	FString GLTFNodePrefixStaticHelper::GetImagePrefix(const FString& AssetName)
	{
		return AssetName + TEXT("_image_");
	}

	FString GLTFNodePrefixStaticHelper::GetMeshPrefix(const FString& AssetName)
	{
		return AssetName + TEXT("_mesh_");
	}

	FString GLTFNodePrefixStaticHelper::GetIESPrefix(const FString& AssetName)
	{
		return AssetName + TEXT("_IES_");
	}
	...
	{
		{
			const FString ScenePrefix = GLTFNodePrefixStaticHelper::GetScenePrefix(Name);
...

		{
			...
			const FString NodePrefix = GLTFNodePrefixStaticHelper::GetNodePrefix(Name);
			const FString JointPrefix = GLTFNodePrefixStaticHelper::GetJointPrefix(Name);
		...
		{
			const FString TexPrefix = GLTFNodePrefixStaticHelper::GetTexturePrefix(Name);
		...
		{
			const FString CameraPrefix = GLTFNodePrefixStaticHelper::GetCameraPrefix(Name);
		...
		{
			const FString LightPrefix = GLTFNodePrefixStaticHelper::GetLightPrefix(Name);
		...
		GLTF::GenerateNames(GLTFNodePrefixStaticHelper::GetMaterialPrefix(Name), Materials);
		GLTF::GenerateNames(GLTFNodePrefixStaticHelper::GetSkinPrefix(Name), Skins);
		GLTF::GenerateNames(GLTFNodePrefixStaticHelper::GetAnimationPrefix(Name), Animations);
		GLTF::GenerateNames(GLTFNodePrefixStaticHelper::GetImagePrefix(Name), Images);
		GLTF::GenerateNames(GLTFNodePrefixStaticHelper::GetMeshPrefix(Name), Meshes);
		GLTF::GenerateNames(GLTFNodePrefixStaticHelper::GetIESPrefix(Name), LightsIES);
		...
		GLTF::ValidateFNameCriteria(TEXT("TextureIES_"), LightsIES);
	...
	const TCHAR* ToString(EExtension Extension)
	{
		switch (Extension)
		{
			...
			case GLTF::EExtension::EXT_LightsIES:
				return TEXT("EXT_lights_ies");
