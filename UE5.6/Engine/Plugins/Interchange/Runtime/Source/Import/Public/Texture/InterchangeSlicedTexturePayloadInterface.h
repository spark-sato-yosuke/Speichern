 ...
 */
class IInterchangeSlicedTexturePayloadInterface
{
	GENERATED_BODY()
public:
	 ...
	 */
	UE_API virtual TOptional<UE::Interchange::FImportSlicedImage> GetSlicedTexturePayloadData(const FString& PayloadKey, TOptional<FString>& AlternateTexturePath) const PURE_VIRTUAL(IInterchangeSlicedTexturePayloadInterface::GetSlicedTexturePayloadData, return{};);
};
