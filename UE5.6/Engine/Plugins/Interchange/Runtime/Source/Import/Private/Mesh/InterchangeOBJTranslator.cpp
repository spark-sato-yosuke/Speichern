...
bool UInterchangeOBJTranslator::Translate(UInterchangeBaseNodeContainer& BaseNodeContainer) const
{
	...
	if (bSuccess)
	{
		...
		for (const TPair<FString, FObjData::FGroupData>& Group : ObjDataPtr->Groups)
		{
			...
			BaseNodeContainer.SetupNode(MeshNode, NodeUid, GroupName, EInterchangeNodeContainerType::TranslatedAsset);
		...
		for (const TPair<FString, FObjData::FMaterialData>& Material : ObjDataPtr->Materials)
		{
			...
			BaseNodeContainer.SetupNode(ShaderGraphNode, NodeUid, MaterialName, EInterchangeNodeContainerType::TranslatedAsset);
...
TOptional<UE::Interchange::FMeshPayloadData> UInterchangeOBJTranslator::GetMeshPayloadData(const FInterchangeMeshPayLoadKey& PayLoadKey, const UE::Interchange::FAttributeStorage& PayloadAttributes) const
{
	using namespace UE::Interchange;
