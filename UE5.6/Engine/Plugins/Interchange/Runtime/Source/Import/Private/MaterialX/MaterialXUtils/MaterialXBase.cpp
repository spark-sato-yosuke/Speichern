...
void FMaterialXBase::UpdateDocumentRecursively(MaterialX::GraphElementPtr Graph)
{
	...
	Graph->flattenSubgraphs(mx::EMPTY_STRING, [](mx::NodePtr Node){return FMaterialXManager::GetInstance().FilterNodeGraph(Node);} );
...
void FMaterialXBase::SetNodeDefinition(const char* NodeDef)
{
