...
public:
	...
	UPROPERTY()
	bool bAddCurveMetadataToSkeleton_DEPRECATED = true;
...
private:
	...
	UE_API void CreateLevelSequenceFactoryNode(UInterchangeAnimationTrackSetNode& Node);

	UE_API void CreateAnimSequenceFactoryNode(UInterchangeSkeletalAnimationTrackNode& Node);
