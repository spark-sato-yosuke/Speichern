...
void SPCGEditorNodeSource::Construct(const FArguments& InArgs)
{
...
void SPCGEditorNodeSource::SetTextProviderObject(UObject* InProviderObject)
{
	...
	ShaderFunctionsTextBox->SetTextProviderObject(InProviderObject);
	ShaderTextTextBox->SetTextProviderObject(InProviderObject);
