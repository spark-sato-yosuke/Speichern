...
void IPCGSpatialDataVisualization::ExecuteDebugDisplayHelper(
	const UPCGData* Data,
...
FPCGTableVisualizerInfo IPCGSpatialDataVisualization::GetTableVisualizerInfoWithDomain(const UPCGData* Data, const FPCGMetadataDomainID& DomainID) const
{
...
const UPCGBasePointData* IPCGSpatialDataVisualization::CollapseToDebugBasePointData(FPCGContext* Context, const UPCGData* Data) const
{	
	if (const UPCGSpatialData* SpatialData = Cast<UPCGSpatialData>(Data))
	{
...
FString IPCGSpatialDataVisualization::GetDomainDisplayNameForInspection(const UPCGData* Data, const FPCGMetadataDomainID& DomainID) const
{
...
TArray<FPCGMetadataDomainID> IPCGSpatialDataVisualization::GetAllSupportedDomainsForInspection(const UPCGData* Data) const
{
	return GetDefault<UPCGBasePointData>()->GetAllSupportedMetadataDomainIDs();
}

FPCGSetupSceneFunc IPCGSpatialDataVisualization::GetViewportSetupFunc(const UPCGData* Data) const
{
