...
public:
	...
	/** In the case of multiple properties being extracted, will be ignored. */
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = Settings, meta = (PCG_Overridable, EditCondition = "!bForceObjectAndStructExtraction", EditConditionHides, PCG_DiscardPropertySelection, PCG_DiscardExtraSelection))
