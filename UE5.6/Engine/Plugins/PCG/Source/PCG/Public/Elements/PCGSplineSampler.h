...
namespace PCGSplineSamplerConstants
{
	...
	const FName NextDirectionDeltaAttributeName = TEXT("NextDirectionDelta");
	const FName CurvatureAttributeName = TEXT("Curvature");
	const FName SegmentIndexAttributeName = TEXT("SegmentIndex");
	const FName SubsegmentIndexAttributeName = TEXT("SubsegmentIndex");
	const FName ArriveTangentAttributeName = TEXT("ArriveTangent");
	const FName LeaveTangentAttributeName = TEXT("LeaveTangent");
	const FName AlphaAttributeName = TEXT("Alpha");
	const FName DistanceAttributeName = TEXT("Distance");
	const FName InputKeyAttributeName = TEXT("InputKey");
}
...
struct FPCGSplineSamplerParams
{
	...
	FName NextDirectionDeltaAttribute = PCGSplineSamplerConstants::NextDirectionDeltaAttributeName;
	...
	FName CurvatureAttribute = PCGSplineSamplerConstants::CurvatureAttributeName;
	...
	FName SegmentIndexAttribute = PCGSplineSamplerConstants::SegmentIndexAttributeName;
	...
	FName SubsegmentIndexAttribute = PCGSplineSamplerConstants::SubsegmentIndexAttributeName;
	...
	FName ArriveTangentAttribute = PCGSplineSamplerConstants::ArriveTangentAttributeName;
	...
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = "Settings|Attributes", meta = (EditCondition = "bComputeTangents&&Dimension!=EPCGSplineSamplingDimension::OnInterior", EditConditionHides))
	FName LeaveTangentAttribute = PCGSplineSamplerConstants::LeaveTangentAttributeName;
	...
	FName AlphaAttribute = PCGSplineSamplerConstants::AlphaAttributeName;
	...
	FName DistanceAttribute = PCGSplineSamplerConstants::DistanceAttributeName;
	...
	FName InputKeyAttribute = PCGSplineSamplerConstants::InputKeyAttributeName;
...
namespace PCGSplineSamplerHelpers
{
	...
	void SampleLineData(FPCGContext* Context, const UPCGPolyLineData* LineData, const UPCGSpatialData* InBoundingShape, const UPCGSpatialData* InProjectionTarget, const FPCGProjectionParams& InProjectionParams, const FPCGSplineSamplerParams& Params, UPCGBasePointData* OutPointData);
