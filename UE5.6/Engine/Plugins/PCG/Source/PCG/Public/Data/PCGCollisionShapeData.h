...
class UPCGCollisionShapeData : public UPCGSpatialDataWithPointCache
{
	...
	friend class FPCGCollisionShapeDataVisualization;
...
private:
	virtual const UPCGBasePointData* CreateBasePointData(FPCGContext* Context, TSubclassOf<UPCGBasePointData> PointDataClass) const;
