...
struct FPCGPinPropertiesGPUStruct
{
	...
	// @todo_pcg: Show texture data type info, e.g. Dimension, Format, etc.
	...
	UPROPERTY(EditAnywhere, DisplayName = "Attributes to Create", Category = Settings, meta = (EditCondition = "!bShowTexturePinSettings", EditConditionHides, HideEditConditionToggle))
