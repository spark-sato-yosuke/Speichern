...
namespace PCGPin
{
	...
	bool ArePinTypesCompatible(const EPCGDataType UpstreamTypes, const EPCGDataType DownstreamTypes)
	{
...
bool UPCGPin::IsCompatible(const UPCGPin* OtherPin) const
{
	...
	return PCGPin::ArePinTypesCompatible(UpstreamTypes, DownstreamTypes);
}

bool UPCGPin::IsDownstreamPinTypeCompatible(const EPCGDataType UpstreamTypes) const
{
	const EPCGDataType AllowedTypes = Properties.AllowedTypes;
	return PCGPin::ArePinTypesCompatible(UpstreamTypes, AllowedTypes);
}
