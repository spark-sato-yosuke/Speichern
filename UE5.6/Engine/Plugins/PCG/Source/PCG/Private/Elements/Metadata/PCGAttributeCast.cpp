...
#include "Elements/Metadata/PCGAttributeCast.h"
...
{
	return FPCGPreConfiguredSettingsInfo::PopulateFromEnum<EPCGMetadataTypes>({ EPCGMetadataTypes::Count, EPCGMetadataTypes::Unknown }, FTextFormat(LOCTEXT("PreconfigureInfo", "Cast to {0}")));
}
#endif
