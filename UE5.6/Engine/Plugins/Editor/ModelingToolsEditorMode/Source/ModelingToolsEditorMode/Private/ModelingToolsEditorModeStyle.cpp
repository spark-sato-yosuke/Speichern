...
void FModelingToolsEditorModeStyle::Initialize()
{
	...
	// Tool Manager icons
	{
		...
		StyleSet->Set("ModelingToolsManagerCommands.BeginUVLayoutTool",                      new IMAGE_PLUGIN_BRUSH("Icons/UVLayout_40x",         Icon20x20));    
		StyleSet->Set("ModelingToolsManagerCommands.BeginUVLayoutTool.Small",                new IMAGE_PLUGIN_BRUSH("Icons/UVLayout_40x",         Icon20x20));  
		StyleSet->Set("ModelingToolsManagerCommands.BeginUVTransferTool",                    new IMAGE_BRUSH_SVG("Icons/UVTransfer", Icon20x20));
		StyleSet->Set("ModelingToolsManagerCommands.BeginUVTransferTool.Small",              new IMAGE_BRUSH_SVG("Icons/UVTransfer", Icon20x20));
		...
		StyleSet->Set("ModelingToolsManagerCommands.MeshElementSelection", new IMAGE_BRUSH_SVG("Icons/MeshSelect_16", Icon20x20));
		...
		StyleSet->Set("BrushTypeIcons.EraseSculptLayer", new FSlateImageBrush(StyleSet->RootToCoreContentDir(TEXT("../Editor/Slate/Icons/Landscape/Landscape_Erase_x40.png")), Icon20x20));
		// Height brushes (currently using same icons as corresponding landscape brushes)
		StyleSet->Set("BrushTypeIcons.HeightSculpt", new FSlateImageBrush(StyleSet->RootToCoreContentDir(TEXT("../Editor/Slate/Icons/Landscape/Landscape_Sculpt_x40.png")), Icon20x20));
		StyleSet->Set("BrushTypeIcons.HeightSmooth", new FSlateImageBrush(StyleSet->RootToCoreContentDir(TEXT("../Editor/Slate/Icons/Landscape/Landscape_Smooth_x40.png")), Icon20x20));
		StyleSet->Set("BrushTypeIcons.HeightFlatten", new FSlateImageBrush(StyleSet->RootToCoreContentDir(TEXT("../Editor/Slate/Icons/Landscape/Landscape_Flatten_x40.png")), Icon20x20));
		StyleSet->Set("BrushTypeIcons.HeightErase", new FSlateImageBrush(StyleSet->RootToCoreContentDir(TEXT("../Editor/Slate/Icons/Landscape/Landscape_Erase_x40.png")), Icon20x20));

		// Pressure Sensitivity toggle button
		StyleSet->Set("BrushIcons.PressureSensitivity", new IMAGE_BRUSH_SVG("Icons/PressureSensitivity", Icon16x16));
