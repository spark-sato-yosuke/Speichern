...
public:
	 ...
	 */
	virtual TArray<AActor*> FindAssociatedActors(AActor* InActor) const;
	 ...
	 */
	virtual bool IsActorAssociated(AActor* Actor, AActor* AssociatedActor) const;
	 ...
	 */
	virtual bool HasCustomDropHandling(const ISceneOutlinerTreeItem& DropTarget) const;

	/** Test whether the specified payload can be dropped onto a tree item */
	virtual FSceneOutlinerDragValidationInfo ValidateDrop(const ISceneOutlinerTreeItem& DropTarget, const FSceneOutlinerDragDropPayload& Payload) const;
