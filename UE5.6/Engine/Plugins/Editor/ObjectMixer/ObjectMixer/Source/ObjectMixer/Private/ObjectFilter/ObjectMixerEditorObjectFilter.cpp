...
TArray<AActor*> UObjectMixerObjectFilter::FindAssociatedActors(AActor* InActor) const
{
	return {};
}

bool UObjectMixerObjectFilter::IsActorAssociated(AActor* Actor, AActor* AssociatedActor) const
{
	return false;
}

bool UObjectMixerObjectFilter::HasCustomDropHandling(const ISceneOutlinerTreeItem& DropTarget) const
{
	return false;
}

FSceneOutlinerDragValidationInfo UObjectMixerObjectFilter::ValidateDrop(const ISceneOutlinerTreeItem& DropTarget, const FSceneOutlinerDragDropPayload& Payload) const
{
	return FSceneOutlinerDragValidationInfo::Invalid();
}

void UObjectMixerObjectFilter::OnDrop(ISceneOutlinerTreeItem& DropTarget, const FSceneOutlinerDragDropPayload& Payload, const FSceneOutlinerDragValidationInfo& ValidationInfo) const
{
}
