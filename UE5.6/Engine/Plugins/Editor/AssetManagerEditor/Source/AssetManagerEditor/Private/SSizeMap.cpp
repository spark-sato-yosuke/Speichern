...
void SSizeMap::Construct(const FArguments& InArgs)
{
	...
	Commands->MapAction(
		...
		FCanExecuteAction::CreateSP(this, &SSizeMap::CanMakeCollectionWithDependencies, ECollectionShareType::CST_Local));
	...
	Commands->MapAction(
		...
		FCanExecuteAction::CreateSP(this, &SSizeMap::CanMakeCollectionWithDependencies, ECollectionShareType::CST_Private));
	...
	Commands->MapAction(
		...
		FCanExecuteAction::CreateSP(this, &SSizeMap::CanMakeCollectionWithDependencies, ECollectionShareType::CST_Shared));
...
bool SSizeMap::CanMakeCollectionWithDependencies(ECollectionShareType::Type ShareType) const
{
	return CanMakeCollectionWithDependencies(FCollectionManagerModule::GetModule().Get().GetProjectCollectionContainer(), ShareType);
}

void SSizeMap::MakeCollectionWithDependencies(ECollectionShareType::Type ShareType)
{
	MakeCollectionWithDependencies(FCollectionManagerModule::GetModule().Get().GetProjectCollectionContainer(), ShareType);
}

bool SSizeMap::CanMakeCollectionWithDependencies(TSharedPtr<ICollectionContainer> CollectionContainer, ECollectionShareType::Type ShareType) const
{
	...
	return !CollectionContainer->IsReadOnly(ShareType) && GetCurrentTreeNode(false).IsValid();
}

void SSizeMap::MakeCollectionWithDependencies(TSharedPtr<ICollectionContainer> CollectionContainer, ECollectionShareType::Type ShareType)
{
	if (!ensure(CollectionContainer))
	{
		return;
...
void SSizeMap::OnTreeMapNodeRightClicked(FTreeMapNodeData& TreeMapNodeData, const FPointerEvent& MouseEvent)
{
	...
	MenuBuilder.BeginSection(TEXT("References"), LOCTEXT("ReferencesSectionLabel", "References"));
	{
		...
		{
			FNewMenuDelegate SubMenu;
			if (CollectionContainers.Num() == 1)
			{
				if (CollectionContainers[0] == CollectionManager.GetProjectCollectionContainer())
				{
					// Use the command version to show key bindings.
					SubMenu = FNewMenuDelegate::CreateSP(this, &SSizeMap::GetMakeCollectionWithDependenciesShareTypeSubMenu);
				}
				else
				{
					SubMenu = FNewMenuDelegate::CreateSP(this, &SSizeMap::GetMakeCollectionWithDependenciesShareTypeSubMenu, CollectionContainers[0]);
				}
			}
			else
			{
				// Create a sub menu to select the collection container.
				SubMenu = FNewMenuDelegate::CreateSP(this, &SSizeMap::GetMakeCollectionWithDependenciesCollectionContainersSubMenu, MoveTemp(CollectionContainers));
			}
...
void SSizeMap::GetMakeCollectionWithDependenciesCollectionContainersSubMenu(FMenuBuilder& MenuBuilder, TArray<TSharedPtr<ICollectionContainer>> CollectionContainers)
{
	...
	MenuBuilder.BeginSection(NAME_None, LOCTEXT("MakeCollectionWithCollectionContainersMenuHeading", "Collection Containers"));
	...
	for (const TSharedPtr<ICollectionContainer>& CollectionContainer : CollectionContainers)
	{
		...
		{
			SubMenu = FNewMenuDelegate::CreateSP(this, &SSizeMap::GetMakeCollectionWithDependenciesShareTypeSubMenu, CollectionContainer);
		}
		MenuBuilder.AddSubMenu(
...
void SSizeMap::GetMakeCollectionWithDependenciesShareTypeSubMenu(FMenuBuilder& MenuBuilder)
{
...
void SSizeMap::GetMakeCollectionWithDependenciesShareTypeSubMenu(class FMenuBuilder& MenuBuilder, TSharedPtr<ICollectionContainer> CollectionContainer)
{
	MenuBuilder.AddMenuEntry(
		...
		FSlateIcon(FAppStyle::GetAppStyleSetName(), ECollectionShareType::GetIconStyleName(ECollectionShareType::CST_Local)),
		FUIAction(
			FExecuteAction::CreateSP(this, &SSizeMap::MakeCollectionWithDependencies, CollectionContainer, ECollectionShareType::CST_Local),
			FCanExecuteAction::CreateSP(this, &SSizeMap::CanMakeCollectionWithDependencies, CollectionContainer, ECollectionShareType::CST_Local))
	);
	...
	MenuBuilder.AddMenuEntry(
		...
		FSlateIcon(FAppStyle::GetAppStyleSetName(), ECollectionShareType::GetIconStyleName(ECollectionShareType::CST_Private)),
		FUIAction(
			FExecuteAction::CreateSP(this, &SSizeMap::MakeCollectionWithDependencies, CollectionContainer, ECollectionShareType::CST_Private),
			FCanExecuteAction::CreateSP(this, &SSizeMap::CanMakeCollectionWithDependencies, CollectionContainer, ECollectionShareType::CST_Private))
	);
	...
	MenuBuilder.AddMenuEntry(
		...
		FSlateIcon(FAppStyle::GetAppStyleSetName(), ECollectionShareType::GetIconStyleName(ECollectionShareType::CST_Shared)),
		FUIAction(
			FExecuteAction::CreateSP(this, &SSizeMap::MakeCollectionWithDependencies, CollectionContainer, ECollectionShareType::CST_Shared),
			FCanExecuteAction::CreateSP(this, &SSizeMap::CanMakeCollectionWithDependencies, CollectionContainer, ECollectionShareType::CST_Shared))
	);
}
