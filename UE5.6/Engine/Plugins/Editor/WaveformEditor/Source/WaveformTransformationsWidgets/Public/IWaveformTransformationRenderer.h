...
struct FWaveformTransformationRenderInfo
{
	...
	int32 NumChannels = 0;
	int64 StartFrameOffset = 0;	//the first frame this transformation can act upon
	uint32 TotalNumSamples = 0;	//the number of total samples in the original waveform
	uint32 NumSamplesAvailable = 0;	//the number of samples available to the transformation
};
