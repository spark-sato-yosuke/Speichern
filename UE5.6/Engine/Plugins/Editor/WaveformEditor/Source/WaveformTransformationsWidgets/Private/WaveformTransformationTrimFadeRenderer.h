...
private:
	...
	void ShowSelectFadeModeMenuAtCursor(const FGeometry& MyGeometry, const FPointerEvent& MouseEvent, TSharedPtr<IPropertyHandle> PropertyHandle);

	TWeakPtr<SWindow> FadeModeMenuWindow;
	...
	TSharedPtr<IPropertyHandle> StartSCurveSharpnessHandle;
	TSharedPtr<IPropertyHandle> EndFadeTimeHandle;
	TSharedPtr<IPropertyHandle> EndFadeCurveHandle;
	TSharedPtr<IPropertyHandle> EndSCurveSharpnessHandle;
