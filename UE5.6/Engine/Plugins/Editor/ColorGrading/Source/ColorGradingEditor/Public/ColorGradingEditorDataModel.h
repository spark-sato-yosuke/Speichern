...
public:
	...
	struct FColorGradingElement
	{
		...
		/** Optional reset to default handler for the saturation property */
		TOptional<FResetToDefaultOverride> SaturationResetToDefaultOverride;
		
		/** Property handle of the color property used for contrast */
		TSharedPtr<IPropertyHandle> ContrastPropertyHandle;

		/** Optional reset to default handler for the contrast property */
		TOptional<FResetToDefaultOverride> ContrastResetToDefaultOverride;
		
		/** Property handle of the color property used for gamma */
		TSharedPtr<IPropertyHandle> GammaPropertyHandle;

		/** Optional reset to default handler for the gamma property */
		TOptional<FResetToDefaultOverride> GammaResetToDefaultOverride;
		
		/** Property handle of the color property used for gain */
		TSharedPtr<IPropertyHandle> GainPropertyHandle;

		/** Optional reset to default handler for the gain property */
		TOptional<FResetToDefaultOverride> GainResetToDefaultOverride;
		
		/** Property handle of the color property used for offset */
		TSharedPtr<IPropertyHandle> OffsetPropertyHandle;

		/** Optional reset to default handler for the offset property */
		TOptional<FResetToDefaultOverride> OffsetResetToDefaultOverride;
	};
