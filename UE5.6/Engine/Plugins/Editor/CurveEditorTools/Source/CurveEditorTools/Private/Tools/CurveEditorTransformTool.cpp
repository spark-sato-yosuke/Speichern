...
FText FCurveEditorTransformTool::GetLabel() const
{
	return FCurveEditorToolCommands::Get().ActivateTransformTool->GetLabel();
}

FText FCurveEditorTransformTool::GetDescription() const
{
	return FCurveEditorToolCommands::Get().ActivateTransformTool->GetDescription();
}

FSlateIcon FCurveEditorTransformTool::GetIcon() const
{
	return FCurveEditorToolCommands::Get().ActivateTransformTool->GetIcon();
}
