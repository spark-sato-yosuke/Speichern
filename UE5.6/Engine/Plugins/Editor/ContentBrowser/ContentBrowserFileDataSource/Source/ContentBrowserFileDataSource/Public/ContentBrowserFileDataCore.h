...
namespace ContentBrowserFileData
{
	...
	CONTENTBROWSERFILEDATASOURCE_API bool CanRenameItem(const UContentBrowserDataSource* InOwnerDataSource, const FContentBrowserItemData& InItem, const bool bCheckUniqueName, const FString* InNewName, FText* OutErrorMsg);
