...
#define SKINNING_LOD_SCREEN_SIZE_BITS 7u
...
struct FNaniteSkinningHeader
{
	...
	UINT_TYPE bHasLODScreenSize			: 1;
	UINT_TYPE AnimationMinScreenSize	: SKINNING_LOD_SCREEN_SIZE_BITS;
	UINT_TYPE Padding					: 28;
};
#endif
